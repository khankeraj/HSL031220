					...
					<div class="panel">
						...
						<div class="panel-body">
							<table id="demo-dt-basic"
								...
								<tbody>
									<%int i = 1;%>
									<c:forEach items="${rentalType}" var="update_rental">
										<tr>
											<td><%=i++%></td>
											<td><c:out value="${rentalType.rental_type}" /></td>
											<td><c:out value="${rentalType.description}" /></td>
											<td align="center"><a
												style="text-decoration: none; color: green;" title="Update"
												href="update_rental_master_details?update_rental=<c:out value="${rentalType.update_rental}" />">
											...
											<td align="center"><a
												style="text-decoration: none; color: red;" title="Delete">
													...
													onclick="deleteFun(<c:out value="${rentalType.update_rental}" />);">
											</a></td>
