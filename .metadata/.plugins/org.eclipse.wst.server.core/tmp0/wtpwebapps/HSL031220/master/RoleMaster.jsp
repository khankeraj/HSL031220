	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Role Master</h1>
				</div>
				<!--End page title-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_RoleMaster" id="submitForm" method="POST" >
									...
									<div class="row">
							            <div class="col-md-6">
							              <div class="form-group">
							                ...
							                <input type="text" class="form-control" onkeyup="this.value=this.value.toUpperCase()"  name="route"  placeholder="Role Name" required/>
							              </div>
							            </div>
