				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">HPC Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${hpcReports1}" var="hpcReports1">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${hpcReports1.quotation_name}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" href="UpdateHPCDetails?hpc_id=<c:out value="${hpcReports1.hpc_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" href="DeleteHPCDetails?hpc_id=<c:out value="${hpcReports1.hpc_id}" />">
