				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Investment And Expenses Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${investExpReports}" var="investExpReports">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${investExpReports.quotation_name}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" href="UpdateInvestmentAndExpId?investmentAndExpId=<c:out value="${investExpReports.investExp_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" href="DeleteInvestmentAndExpId?investmentAndExpId=<c:out value="${investExpReports.investExp_id}" />">
