				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Supplier Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <c:forEach items="${listofsupplier}"
												var="listofsupplier">
												<tr>
												<td><c:out value="${listofsupplier.company_id}" />
													</td>
													<td><c:out value="${listofsupplier.company_name}" />
													</td>
													<td><c:out value="${listofsupplier.address}" /></td>
													<td><c:out
															value="${listofsupplier.company_contact}" /></td>
													<td><c:out value="${listofsupplier.city}" /></td>
													<td><c:out value="${listofsupplier.email_id}" />
													<td><c:out value="${listofsupplier.vatno}" /></td>
													</td>

													<td><a style="text-decoration: none;"
														href="Company_Master_Edit_Delete_Action?company_name=<c:out value="${listofsupplier.company_name}"/>
														&address=<c:out value="${listofsupplier.address}"/>&ifsc_code=<c:out value="${listofsupplier.ifsc_code}"/>&company_id=<c:out value="${listofsupplier.company_id}"/>
														 &company_contact=<c:out value="${listofsupplier.company_contact}"/>&account_no=<c:out value="${listofsupplier.account_no}"/>
														&city=<c:out value="${listofsupplier.city}"/>&remark=<c:out value="${listofsupplier.remark}"/>&state=<c:out value="${listofsupplier.state}"/>
														 &email_id=<c:out value="${listofsupplier.email_id}"/>&status=<c:out value="${1}"/>&cstno=<c:out value="${listofsupplier.cstno}"/>&bank_name=<c:out value="${listofsupplier.bank_name}"/>&vatno=<c:out value="${listofsupplier.vatno}"/>">
													<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>&nbsp;</td>
													<td><a style="text-decoration: none;"
														href="Company_Master_Edit_Delete_Action?company_name=<c:out value="${listofsupplier.company_name}"/>&status=<c:out value="${2}" /> ">
													<img alt="Delete" height="25px;" src="configure/img/delete.svg"></a>&nbsp;</td>
												</tr>
											</c:forEach>
								</tbody>
							</table>
