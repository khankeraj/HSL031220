...
<script src="Css/jquery-1.10.2.js" type="text/javascript"></script>
 <!-- AutoSearch -->
  ...
  <!-- AutoSearch -->
	...
	<script>
	$(function() {
		 $("#driver").autocomplete("GoogleSearch/autosearchDriver.jsp");
		 $("#vehicle_type").autocomplete("GoogleSearch/autosearchVehicleType.jsp");
		 $("#size").autocomplete("GoogleSearch/autosearchVehicleSize.jsp");
	});
	</script>
			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="Add_New_Vehicle" method="POST" enctype="multipart/form-data">
								<div class="panel-body">
								      <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Vehicle No:</label>
													<input type="text" class="form-control" placeholder="" name="vehicle_no"   class="form-control" required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="vehicle_type"  id="vehicle_type"  class="form-control" required>
												</div>
											</div>
									  </div>
									  ...
									  <div class="col-sm-6">
											<div class="form-group">
												...
												<input type="text" placeholder=""  name="model" class="form-control" required>
											</div>
										</div>
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Size :</label>
													<input type="text" placeholder=""  name="size" id="size" style="line-height: 15px;"  class="form-control" required>
												</div>
											</div>
									  </div>
									 ...
									 <div class="row">
											...
											<div class="form-group">
												...
												<input type="text" placeholder=""  name="capacity" class="form-control" required>
											</div>
										  </div>
										   <div class="col-sm-6">
										    <div class="form-group">
												<label class="control-label">Driver :</label>
												<input type="text" placeholder=""  autocomplete="off" name="driver" id="driver"  class="form-control" required>
										    </div>
										  </div>
									</div>
														...
														<td  id="itemsTable$" class="table table-striped table-bordered" cellspacing="0" width="70%" colspan="5">
																...
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="70%">
																	...
																	<tr>
																		...
																		<th id="VLsparename"><label>Expiration Date</label>
																		</th>
																	...
																	<tr class="item-row">
																		...
																		<td>Road Tax</td>
																		<td><input type="date" name="road_tax_date" id="road_tax_date"/></td>
																	...
																	<td>Fitness Tax</td>
																		<td><input type="date" name="fitness_tax_date" id="fitness_tax_date"/></td>
																		<td><input type="file" name="photo" multiple accept='image/*' class="form-control" required/></td>
									  								</tr>
																	...
																	<td>Permit tax</td>
																		<td><input type="date" name="permit_tax_date" id="permit_tax_date"/></td>
																	...
																	<td>PUC</td>
																		<td><input type="date" name="puc_date" id="puc_date"/></td>
																		<td><input type="file" name="photo" multiple accept='image/*' class="form-control" required/>
																		</td>
									  								</tr>
																	...
																	<td>Servicing</td>
																		<td><input type="date" name="servicing_date" id="servicing_date"/></td>
																		<td><input type="file" name="photo" multiple accept='image/*' class="form-control" required/>
																		</td>
									  								</tr>
																	...
																	<td>Insurance</td>
																		<td><input type="date" name="insurance_date" id="insurance_date"/></td>
																		<td><input type="file" name="photo" multiple accept='image/*' class="form-control" required/>
																		</td>
									  								</tr>
