				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Bank Master Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<%int i=1; %>
									<c:forEach items="${fetchBankMaster}" var="fetchBankMaster">
									<tr>
									<td><%=i++ %></td>
									<td><c:out value="${fetchBankMaster.bank_name}" /></td>
									<td><c:out value="${fetchBankMaster.branch_name}" /></td>
									
									<td align="center"><a  title="Update" style="text-decoration: none;color: green;" href="#?lead_no=<c:out value="${fetchBankMaster.bank_id}" />">
										<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>
								   </td>
								   
									<td align="center"><a title="Delete" style="text-decoration: none;color: red;" href="#?lead_no=<c:out value="${fetchBankMaster.bank_id}" />">
