			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="panel-heading">
							<h3 class="panel-title">Sales Agreement Report</h3>
						</div>
						...
						<div class="panel-body">
							<table id="demo-dt-selection" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								<s:iterator value="agreement_reports">
									<tr>
										<td><%=i++ %></td>
										<td>${agreement_subject}</td>
										<td>${name}</td>
										<td>${firm_name}</td>
										<td>${quotation_no}</td>
										<td>${date_of_quotation}</td>
									    <td><a title="PI" href="assignBill?agreement_id=${sales_agg_id}&lead_no=${lead_no}"><img alt="PI" height="30px;" src="configure/img/invoice.svg""></a></td>
										<td><a title="View Agreement" href="ViewAgreement?agreement_id=${sales_agg_id}&lead_no=${lead_no}"><img alt="Agreement" height="30px;" src="configure/img/contract (1).svg""></a></td>
									</tr>
								</s:iterator>
								</tbody>
							</table>
