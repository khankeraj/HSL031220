...
<head>
	...
	<script>
		function deleteFun(driver_id){
			/* alert(driver_id); */
			var link = "DeleteDriverMaster?driver_id="+driver_id;
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					<div class="panel">
					<br>
					<a href="DriverMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
					
					
					
						<div class="panel-heading">
							<h3 class="panel-title">Driver Master Report</h3>
						</div>
						<div class="panel-body" style="overflow-x:auto;">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${driverMasterDetails}" var="driverMasterDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${driverMasterDetails.driver_id}" /></td>
										<td><c:out value="${driverMasterDetails.driver_name}" /></td>
										<td><c:out value="${driverMasterDetails.addr_permanent}" /></td>
										<td><c:out value="${driverMasterDetails.addr_curr}" /></td>
										<td><c:out value="${driverMasterDetails.contact_number}" /></td>
										<%-- <td><c:out value="${driverMasterDetails.date_of_birth}" /></td> --%>
										<td><c:out value="${driverMasterDetails.age}" /></td>
										<%-- <td><c:out value="${driverMasterDetails.salary_type}" /></td> --%>
										<td><c:out value="${driverMasterDetails.basic_salary}" /></td>
										<td><c:out value="${driverMasterDetails.bank_name}" /></td>
										
										<c:set var = "string2" value = "${fn:substring(driverMasterDetails.driver_id, 4, 9 )}" /> 
										
										
										
										   
										<td><img alt="" width="50px" height="70px" src="<c:out value="images/DRV/${string2}Driver-Photo(1).png" />"></td>
										<td><img alt="" width="50px" height="70px" src="<c:out value="images/DRV/${string2}Aadhar-Photo(1).png" />"></td>
										<td><img alt="" width="50px" height="70px" src="<c:out value="images/DRV/${string2}License-Photo(1).png" />"></td>
										<%-- <td><c:out value="images/DRV/${string2}Driver-Photo(1).png" /></td> --%>
										<%-- <td><c:out value="${driverMasterDetails.aadhar_photo}" /></td>
										<td><c:out value="${driverMasterDetails.license_photo}" /></td --%>
										
										<td>
											<a href="ID_print?driver_id=<c:out value="${driverMasterDetails.driver_id}" />&driver_name=<c:out value="${driverMasterDetails.driver_name}" />&contact_number=<c:out value="${driverMasterDetails.contact_number}" />&emergency_contact_number=<c:out value="${driverMasterDetails.emer_contact}" />"><button>print</button></a> 
										</td>
										
										
										
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdatedriverMaster?driver_id=<c:out value="${driverMasterDetails.driver_id}" />">
											<img alt="Update" src="configure/img/pencil.png"></a>
									   </td>
										<%-- <td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteDriverMaster?driver_id=<c:out value="${driverMasterDetails.driver_id}" />">
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun('<c:out value="${driverMasterDetails.driver_id}" />');"></a>
									   </td>
