...
<link href="configure/plugins/font-awesome/css/font-awesome.min.css"
	rel="stylesheet">
<link href="configure/plugins/switchery/switchery.min.css"
	rel="stylesheet">
<link href="configure/plugins/bootstrap-select/bootstrap-select.min.css"
	rel="stylesheet">
<link
	href="configure/plugins/datatables/media/css/dataTables.bootstrap.css"
	rel="stylesheet">
<link
	href="configure/plugins/datatables/extensions/Responsive/css/dataTables.responsive.css"
	rel="stylesheet">
...
<script>
		function deleteFun(city_id){
			//alert(city_id);
			var link = "DeleteCityMaster?city_id="+city_id;
...
<body>
						...
						<div class="panel-body">
							<table id="demo-dt-basic"
								...
								<tbody>
									...
									int i = 1;
									%>
									<c:forEach items="${cityMasterDetails}" var="cityMasterDetails">
										<tr>
											<td><%=i++%></td>
											<td><c:out value="${cityMasterDetails.city_name}" /></td>
											<td><c:out value="${cityMasterDetails.state_name}" /></td>
											<td align="center"><a
												style="text-decoration: none; color: green;" title="Update"
												href="UpdatecityMaster?city_id=<c:out value="${cityMasterDetails.city_id}" />">
													<img alt="Update" src="configure/img/pencil.png">
											</a></td>
											<%-- <td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteCityMaster?city_id=<c:out value="${cityMasterDetails.city_id}" />">
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg"></a>
									   </td> --%>

											<td align="center"><a
												style="text-decoration: none; color: red;" title="Delete">
													<img alt="" height="20px;"
													src="configure/img/recycle-bin.svg"
													onclick="deleteFun(<c:out value="${cityMasterDetails.city_id}" />);">
											</a></td>
	...
	<script
		src="configure/plugins/bootstrap-select/bootstrap-select.min.js"></script>
	<script
		src="configure/plugins/datatables/media/js/jquery.dataTables.js"></script>
	<script
		src="configure/plugins/datatables/media/js/dataTables.bootstrap.js"></script>
	<script
		src="configure/plugins/datatables/extensions/Responsive/js/dataTables.responsive.min.js"></script>
