				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Quotation Index Reports</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <c:forEach items="${indexReports}" var="indexReports">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${indexReports.quotation_name}"/></td>
										<td><a title="Update" href="UpdateQuotationIndexDetails?quotation_index_id=${indexReports.index_id}"><i style="color: green;" class="fa  fa-check-square-o"></i></a></td>
										<td><a title="Delete" href="DeleteQuotationIndexDetails?quotation_index_id=${indexReports.index_id}"><i  style="color: red;" class="fa fa-remove"></i></a></td>
									</tr>
								 </c:forEach>
