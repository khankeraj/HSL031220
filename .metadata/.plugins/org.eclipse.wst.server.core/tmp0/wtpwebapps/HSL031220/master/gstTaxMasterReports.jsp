	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					<input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='formgsttaxmaster'"/>
				</div>
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Tax Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${fetchGstTaxRepo}" var="fetchGstTaxRepo">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${fetchGstTaxRepo.hsn_code}" /></td>
										<td><c:out value="${fetchGstTaxRepo.tax_percentage}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdateGstTax?gst_tax_id=<c:out value="${fetchGstTaxRepo.id}" />">
											<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="GstTax_Delete?gst_tax_id=<c:out value="${fetchGstTaxRepo.id}" />">
