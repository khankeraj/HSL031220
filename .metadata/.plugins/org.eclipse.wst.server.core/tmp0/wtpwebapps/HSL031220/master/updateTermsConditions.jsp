											...
											function addRows(e) {
												try {
													...
													var $rowTemp = [
															...
															'<td><input  type="text" class="form-control" name="specififcations"/></td>',
											...
											function addRows(e) {
												try {
													...
													var $rowTemp = [
															...
															'<td><a id="deleteRow"><img src="configure/img/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>',
															'<td><input  type="text" class="form-control" name="specififcations1"/></td>',
															'</tr>' ].join('');
													var $row = $($rowTemp);
													$.currentRow = $row;
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Terms & Conditions </h1>
				</div>
				<!--End page title-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="UpdateTermsAndConditionsMaster" method="POST">
									<div class="panel-body">
									<s:iterator value="terms_conditions3">
										<div class="row">
										...
										<div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="terms_condition_id" value="${terms_condition_id}">
                                                    <input type="text" class="form-control" value="${name_of_index}" name="name_of_index" onkeyup="this.value=this.value.toUpperCase()"  required> </div>
                                            </div>
                                  		  </div>
                                    </s:iterator>
													...
													<tr>
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<s:iterator value="terms_conditions4">
																	<tr class="item-row">
																		<td><a id="deleteRow"><img src="configure/img/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
																		<td><input type="text" name="specififcations" value="${specifi}" class="form-control">
																		</td>	
																		<td><input name="quantity" class="form-control" value="${qty}" class="form-control">
																		</td>
																	</tr>
																	</s:iterator>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="${sub_name_of_index}" name="sub_name_of_index" onkeyup="this.value=this.value.toUpperCase()"  required> </div>
                                            </div>
                                  		  </div>
                                  		  </s:iterator>
													...
													<tr>
														<td colspan="5">
																<table id="itemsTable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<s:iterator value="terms_conditions5">
																	<tr class="item-row">
																		<td><a id="deleteRow"><img src="configure/img/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
																		<td><input type="text" name="specififcations1" value="${specifi1}" class="form-control">
																		</td>	
																	</tr>
																	</s:iterator>
