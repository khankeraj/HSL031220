				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_ResourceTypeMaster" id="submitForm" method="POST" onsubmit="location.href='quot_Index'">
									...
									<div class="row">
							            ...
							            <div class="col-md-6">
							              <div class="form-group">
							                ...
							                <input type="text" class="form-control"  name="model"  placeholder="Resource Type" required/>
							              </div>
							            </div></div>
