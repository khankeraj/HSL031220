				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="InsertTaxMaster" id="submitForm" method="POST" onsubmit="location.href='quot_Index'">
								      ...
								      <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="tax_per" class="form-control" required>
												</div>
											</div>
									  </div>
