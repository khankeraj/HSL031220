	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Reason Type Master</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">Reason Type Master</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_ReasonTypeMaster" id="submitForm" method="POST" onsubmit="location.href='quot_Index'">
									...
									<div class="row">
							            ...
							            <div class="col-md-6">
							              <div class="form-group">
							                ...
							                <input type="text" class="form-control"  name="model"  placeholder="Reason Type" required/>
							              </div>
							            </div></div>
