				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="InsertFinalizedQuotation" method="POST">
													...
													<tr>
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<tr class="item-row">
																		<td><input type="checkbox" ${checkbox}  name="quotationIndex.mycheckbox" value="${subindex}" id="mycheckbox<%=i %>" value="${index_id}"  onclick="showthis('<%=i %>')" ></td>
																		
																		<td><input type="text" value="${subindex}" name="quotationIndex.sub_name_of_index" class="form-control">
																		</td>
																		
																		<td>
																		 <select  id="quotation_name<%=i %>"  name="quotationIndex.selectQuotationName" onchange="getQuotationName(this.value)" style="width:100%;">
																			<option  selected >Select Reports</option>
																			<s:iterator value="(mysize).{# this}" status="stat">
																			<option <s:property value="select_quot[top]" />><s:property value="myarrays[top]" /></option>
																			</s:iterator>
																		  </select>
																		</td>	
																	</tr>
                                      ...
                                      <div class="row">
												<div class="col-sm-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="" name="finalized_amount"  class="form-control" required>
													</div>
												</div>
	                                           ...
	                                           <div class="col-sm-6">
													<div class="form-group">
														...
														<input type="text" class="form-control" placeholder="" name="token_amount" class="form-control" required>
												    </div>
											  </div>
                                      </div>
										...
										<div class="row">
											...
											<input type="hidden" name="quotation_edit_id" value="<%=quotation_id%>">
