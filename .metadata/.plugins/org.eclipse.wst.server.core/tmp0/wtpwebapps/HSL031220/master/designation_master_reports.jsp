...
<head>
	...
	<script>
		function deleteFun(designation_id){
			//alert(designation_id);
			var link = "DeleteDesignationMaster?designation_id="+designation_id;
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					<div class="panel">
					<br>
					<a href="DesignationMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
						<div class="panel-heading">
							<h3 class="panel-title">Designation Master Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${designationMasterDetails}" var="designationMasterDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${designationMasterDetails.designation_name}" /></td>
										<td><c:out value="${designationMasterDetails.remark}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdatedesignationMaster?designation_id=<c:out value="${designationMasterDetails.designation_id}" />">
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${designationMasterDetails.designation_id}" />);"></a>
									   </td>
