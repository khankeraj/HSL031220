			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="Add_New_City" method="POST">
								<div class="panel-body">
								      <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Cityjjjjjjjjjjjjjj Name:</label>
													<input type="text" class="form-control" placeholder="" name="city_name"    class="form-control" required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="state_name"    class="form-control" required>
												</div>
											</div>
									  </div>
