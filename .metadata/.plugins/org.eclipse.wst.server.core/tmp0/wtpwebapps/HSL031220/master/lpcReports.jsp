				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">LPC Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${lpcReports}" var="lpcReports">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${lpcReports.quotation_name}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" href="updateLPC?lpc_id=<c:out value="${lpcReports.lpc_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" href="DeleteLPC?lpc_id=<c:out value="${lpcReports.lpc_id}" />">
