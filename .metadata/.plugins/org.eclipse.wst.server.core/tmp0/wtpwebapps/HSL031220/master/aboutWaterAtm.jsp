				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="AboutWaterATMMaster" method="POST">
														...
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	<tr>
																		...
																		<th id="VLsparename"><label>Label Name </label></th>
																		<th id="VLsparename"><label>Details</label></th>
																	</tr>
																	<tr class="item-row">

																		<td></td>
																		<td><input type="text" name="labelname" class="form-control">
																		</td>	
																		<td><input name="details" class="form-control">
																		</td>
																	</tr>
																</table>
														...
														<td colspan="5">
																<table id="itemsTable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<tr class="item-row">
																		...
																		<td></td>
																		<td><input name="features" class="form-control">
																		</td>
																	</tr>
																</table>
																	<table id="demo-dt-addrow" class="table table-striped table-bordered" cellspacing="0" width="100%">
