...
<head>
	...
	<script>
		function deleteFun(city_id){
			//alert(city_id);
			var link = "DeleteRateMaster?rateid="+city_id;
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					<div class="panel">
					<br>
					<a href="RateMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
					
						<div class="panel-heading">
							<h3 class="panel-title">Rate Master Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${rate_modalDetails}" var="cityMasterDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${cityMasterDetails.customer}" /></td>
										
											
										 <td align="center"><a style="text-decoration: none;color: green;" title="Update" href="EditRateMaster?rateid=<c:out value="${cityMasterDetails.rateid}" />">
											<img alt="Update" src="configure/img/pencil.png"></a>
									   </td>
										
									   
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${cityMasterDetails.rateid}" />);"></a>
									   </td> 
