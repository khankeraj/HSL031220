...
<script>
	...
	var currentURL = "Delete_RoleMaster?id="+id+"";
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					 ...
					 <input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='RoleMaster'"/>
				
				</div>
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Role Master Report</h3>
						</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <c:forEach items="${ProductReport}" var="ProductReport">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${ProductReport.route}" /></td>
										
										
											<%-- <td align="center"><a style="text-decoration: none;color: green;" title="Update" href="Edit_RoleMaster?id=<c:out value="${ProductReport.id}" />">
