				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">RO Report</h3>
						</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <c:forEach items="${roList}" var="roList">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${roList.ro_name}"/></td>
										<td><a title="Update" href="UpdateQuotationDetails?quotation_id=${roList.id}"><i style="color: green;" class="fa  fa-check-square-o"></i></a></td>
										<td><a title="Delete" href="DeleteQuotationDetails?quotation_id=${roList.id}"><i  style="color: red;" class="fa fa-remove"></i></a></td>
									</tr>
								 </c:forEach>
