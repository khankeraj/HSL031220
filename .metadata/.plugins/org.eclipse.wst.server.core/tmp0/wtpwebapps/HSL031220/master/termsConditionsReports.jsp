				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Terms Conditions Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${termsConditionsReports}" var="termsConditionsReports">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${termsConditionsReports.quotation_name}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdateTermsConditions?termsConditionsId=<c:out value="${termsConditionsReports.terms_conditions_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteTermsConditions?termsConditionsId=<c:out value="${termsConditionsReports.terms_conditions_id}" />">
