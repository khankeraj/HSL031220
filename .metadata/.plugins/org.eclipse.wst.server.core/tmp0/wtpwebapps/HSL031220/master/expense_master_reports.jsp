...
<head>
	...
	<script>
		function deleteFun(expense_id){
			//alert(expense_id);
			var link = "DeleteExpenseMaster?expense_id="+expense_id;
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					<div class="panel">
					<br>
					<a href="ExpenseMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
					
						<div class="panel-heading">
							<h3 class="panel-title">Expense Master Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${expenseMasterDetails}" var="expenseMasterDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${expenseMasterDetails.exp_parti}" /></td>
										<td><c:out value="${expenseMasterDetails.remark}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdateexpenseMaster?expense_id=<c:out value="${expenseMasterDetails.expense_id}" />">
											<img alt="Update" src="configure/img/pencil.png"></a>
									   </td>
										<%-- <td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteExpenseMaster?expense_id=<c:out value="${expenseMasterDetails.expense_id}" />">
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${expenseMasterDetails.expense_id}" />);"></a>
									   </td>
