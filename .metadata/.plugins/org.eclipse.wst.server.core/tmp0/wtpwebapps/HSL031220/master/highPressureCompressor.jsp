				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="HighPressureCompMaster" method="POST">
                                    	 ...
                                    	 <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="quotation_name" class="form-control"> </div>
                                            </div>
                                         </div>
                                     
                                  <s:iterator value="hpc">
									<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Name Of Index :
                                                    </label>
                                                    <input type="text" value="${name_of_index}" name="name_of_index" class="form-control"> </div>
                                            </div>
                                          <s:iterator value="hpc">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" name="image"  id="sethighpreComp"  class="form-control"> </div>
                                            </div>
                                            </s:iterator>
                                     </div>
                                      </s:iterator>
                                     ...
                                     <div class="row">
                                   		<div class="col-md-6">
                                              <div class="form-group">
												...
												<input type="text" class="form-control"  name="machine_details" value="${machine}">
											 </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                              <div class="form-group">
												...
												<input type="text" class="form-control"  name="subname1" value="${name1}" >
											 </div>
                                        </div>
                                    ...
                                    <div class="row">
                                     <div class="col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" name="subname2" value="${name2}" class="form-control" required> 
                                             </div>
                                        </div>
                                        <s:iterator value="hpc">
                                   		<div class="col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="techname" value="${techname}" class="form-control" required> 
                                             </div>
                                        </div>
                                        </s:iterator>
                                     </div>
                                      ...
                                      <s:iterator value="hpc">
                                       <div class="row">
	                                   		<div class="col-md-6">
	                                             ...
	                                             <input type="text" class="form-control" name="techDetails" value="${techDetails}" class="form-control" required> </div>
	                                        </div>
                                    	 </div>
                                      </s:iterator>
                                        ...
                                        <div class="row">
	                                   		<div class="col-md-6">
	                                             ...
	                                             <input type="text" class="form-control"  name="heading1" value="${head}" class="form-control" required> </div>
	                                        </div>
                                    	 </div>
