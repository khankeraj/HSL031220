...
String getQuotation_name=request.getParameter("getQuotation_name"); 
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="InvestmentAndExpensesMaster" method="POST">
									<div class="panel-body">
										...
										<s:iterator value="investmentExp">
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Name  :
                                                    </label>
                                                    <input type="text" class="form-control" value="${name}" name="name" class="form-control" required> </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="${subname}" name="subname" class="form-control" required> </div>
                                            </div>
                                  		  </div>
													...
													<tr>
														<td colspan="5">
																...
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<s:iterator value="investmentExp1">
																		<tr class="item-row">
																			<td><a id="deleteRow"><img src="configure/img/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
                                        ...
                                        <s:iterator value="investmentExp">
	                                        <div class="row">
	                                            <div class="col-md-6">
	                                                <div class="form-group">
	                                                    <input type="text" class="form-control" value="${heading3}" name="heading3" class="form-control" required> </div>
	                                            </div>
	                                            
	                                            <div class="col-md-6">
	                                                <div class="form-group">
	                                                    <input type="text" class="form-control" value="${heading4}" name="heading4" class="form-control" required> </div>
	                                            </div>
	                                  	     </div>
                                  	   </s:iterator>
										...
										<div class="row">
											...
											<input type="text" name="getQuotation_name" value="<%=getQuotation_name%>"/>
											<input type="text" name="quotation_id" value="<%=quotation_id%>">
