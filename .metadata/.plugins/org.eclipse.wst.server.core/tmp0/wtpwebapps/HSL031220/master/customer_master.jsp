...
<script>
	...
	function phoneNumberCheck(v) {
		...
		if (v.value == "" || isNaN(v.value) || v.value.length != 10) {
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="customer_master_insert" id="submitForm"
									method="POST">
									<div class="panel-body">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Contact Person </label> <input type="text"
														class="form-control" name="company_name" id="cust_subname"
														required> <input type="hidden" name="Cust_id"
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Customer Address </label> <input type="text"
														class="form-control" name="customer_address" required>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Contact Number</label> <input type="text"
														class="form-control" name="customer_mobile" id="Mob_no"
														pattern="[0-9]*" maxlength="10"
														onblur="phoneNumberCheck(this);" required>
												</div>
											</div>
										</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>Phone No </label> <input type="text"
														class="form-control" name="phone_no" id="Ph_no"
														onblur="ValidateMoNo()" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
											...
											<div class="col-md-6">
												<div class="form-group">
													<label>State </label> <input type="text"
														class="form-control" name="state" id="brand"
														onblur="checkInp1()" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>Pincode No </label> <input type="text"
														class="form-control" name="pincode_no" id="pincode"
														onblur="checkInp1()" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Pan No </label> <input type="text"
														class="form-control" name="pan_no" id="panno"
														onblur="checkInp1()" required>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label>Customer GST NO </label> <input type="text"
														class="form-control" name="customer_gst_no"
														id="Cust_vat_tin" onblur="checkInp3()" required>
												</div>
											</div>

											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Customer Type:</label> <select
														class="form-control show-tick " name="type" id="type">
