...
<head>
	...
	<script>
		function deleteFun(v_id){
			//alert(v_id);
			var link = "DeleteVehicleMaster?vehicle_id="+v_id;
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					<div class="panel">
					<br>
					<a href="VehicleMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
					
					
					
						<div class="panel-heading">
							<h3 class="panel-title">Vehicle Master Report</h3>
						</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>
										...
										<th>Capacity</th>
										<th>Driver</th>
										<th>Road Tax Photo</th>
										<!-- <th>Salary Type</th> -->
										<th>Fitness Tax Photo</th>
										<th>Permit Tax Photo</th>
										<th>PUC photo</th>
										<th>Servicing photo</th>
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${vehicleMasterDetails}" var="vehicleMasterDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${vehicleMasterDetails.vehicle_no}" /></td>
										<td><c:out value="${vehicleMasterDetails.vehicle_type}" /></td>
										<td><c:out value="${vehicleMasterDetails.model}" /></td>
										<td><c:out value="${vehicleMasterDetails.size}" /></td>
										<td><c:out value="${vehicleMasterDetails.capacity}" /></td>
										<td><c:out value="${vehicleMasterDetails.driver}" /></td>
										<td>Road Tax Photo</td>
										<%-- <td><c:out value="${driverMasterDetails.salary_type}" /></td> --%>
										<td>Fitness Tax Photo</td>
										<td>Permit photo</td>
										<td>puc photo</td>
										<td>servicing photo</td>
										<td>insurance photo</td>
										
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdatevehicleMaster?vehicle_id=<c:out value="${vehicleMasterDetails.v_id}" />">
											<img alt="Update" src="configure/img/pencil.png"></a>
									   </td>
										<%-- <td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteVehicleMaster?vehicle_id=<c:out value="${vehicleMasterDetails.v_id}" />">
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${vehicleMasterDetails.v_id}" />);"></a>
									   </td>
									</tr>
								 </c:forEach>
								</tbody>
