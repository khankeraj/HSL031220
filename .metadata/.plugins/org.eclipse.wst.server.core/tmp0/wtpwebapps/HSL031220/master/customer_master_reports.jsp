...
<head>
	...
	<script>
		function deleteFun(customer_id){
			//alert(customer_id);
			var link = "DeleteCustomerMaster?customer_id="+customer_id;
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					<div class="panel">
					<br>
					<a href="customer_master"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
					<!-- <button class="btn btn-success btn-labeled fa fa-check fa-lg" style="margin-left: 10px" type="submit" >Submit</button> -->
						<div class="panel-heading">
							
							<h3 class="panel-title">Customer Master Report</h3>
						</div>
						<div class="panel-body" style="overflow-x:auto;">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${customerMasterDetails}" var="customerMasterDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${customerMasterDetails.customer_name}" /></td>
										<td><c:out value="${customerMasterDetails.company_name}" /></td>
										<td><c:out value="${customerMasterDetails.customer_address}" /></td>
										<td><c:out value="${customerMasterDetails.customer_mobile}" /></td>
										<td><c:out value="${customerMasterDetails.phone_no}" /></td>
										<td><c:out value="${customerMasterDetails.state}" /></td>
										<td><c:out value="${customerMasterDetails.city}" /></td>
										<td><c:out value="${customerMasterDetails.pincode_no}" /></td>
										<td><c:out value="${customerMasterDetails.pan_no}" /></td>
										<td><c:out value="${customerMasterDetails.customer_gst_no}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdatecustomerMaster?customer_id=<c:out value="${customerMasterDetails.customer_id}" />">
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${customerMasterDetails.customer_id}" />);"></a>
									   </td>
									</tr>
								 </c:forEach>
								</tbody>
