				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_New_Transporter" id="submitForm" method="POST">
									...
									<div class="row">
							            ...
							            <div class="col-md-6">
							              <div class="form-group">
							                ...
							                <input type="text" class="form-control" name="company_name" id="transporter_subname"   required>
							          ...
							          <div class="row">
							            <div class="col-md-6">
							              <div class="form-group">
							                ...
							                <input type="text" class="form-control" name="transporter_address"  required>
							              </div>
							            </div>
							            ...
							            <div class="col-md-6">
							              <div class="form-group">
							                ...
							                <input type="text" class="form-control" name="transporter_mobile" id="Mob_no" pattern="[0-9]*" maxlength="10" onblur="phoneNumberCheck(this);"  required>
							              </div>
							            </div>
							          </div>
											  ...
											  <div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Bank Name </label>
														<input type="text"  autocomplete="off" name="bank_name" id="bank_name" class="form-control" required>
												</div>
											</div>
											<div class="col-sm-6">
											<div class="form-group">
												<label class="control-label">Account No </label>
												<input type="text"   autocomplete="off" name="account_no"  class="form-control" required>
											</div>
										 </div>
										 </div>
										...
										<div class="row">
										 <div class="col-sm-6">	 
											<div class="form-group">
												...
												<input type="text"  name="gstn"  id="gstn" class="form-control" required>
											</div>
									     </div>
