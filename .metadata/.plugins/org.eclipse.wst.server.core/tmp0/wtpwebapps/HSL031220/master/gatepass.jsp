 ...
 <!-- AutoSearch -->
  ...
  <!-- AutoSearch -->
	...
	$(function(){
		 ...
		 $("#itemName").autocomplete("GoogleSearch/spareautosearch.jsp");
	});
	</script>
											...
											function addRows(e) {
												try {
													...
													var $rowTemp = [
															...
															'<td><input  type="text" class="form-control" id="itemName" name="specfication"/></td>',
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Gate Pass</h1>
				</div>
				<!--End page title-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_New_GatePass" method="POST">
										...
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="reqDate"  class="form-control" required> </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Gate Pass No :
                                                    </label>
                                                    <input type="text" class="form-control"  name="gpno"  required> </div>
                                            </div>
                                  		 </div>
                                  		 ...
                                  		 <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="customer_name"  class="form-control" required> </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Issue Emp:
                                                    </label>
                                                    <input type="text" class="form-control" id="employee"  name="issue"  required> </div>
                                            </div>
                                  		 </div>
													...
													<tr>
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<tr class="item-row">
																		<td><a id="deleteRow"><img src="configure/img/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
																		<td><input type="text" name="specfication" id="itemName" class="form-control"></td>	
