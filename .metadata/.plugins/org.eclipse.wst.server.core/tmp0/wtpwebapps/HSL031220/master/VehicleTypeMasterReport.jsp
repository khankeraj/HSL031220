...
<script>
	...
	var currentURL = "Delete_VehicleTypeMaster?id="+id+"";
	
		var okdelete = confirm("Are You Sure Want to Delete!");
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					 ...
					 <input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='VehicleTypeMaster'"/>
				
				</div>
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Vehicle Type Master Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${ProductReport}" var="ProductReport">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${ProductReport.model}" /></td>
										<td><c:out value="${ProductReport.size}" /></td>
										<td><c:out value="${ProductReport.halt_charge}" /></td>
										<%-- <td><c:out value="${ProductReport.no_of_bag}" /></td>
										<td><c:out value="${ProductReport.no_of_box}" /></td> --%>
										
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="Edit_VehicleTypeMaster?id=<c:out value="${ProductReport.id}" />">
											<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>
									   </td>
									   
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" onclick="delet('<c:out value="${ProductReport.id}" />')">
											<img alt="Edit" height="25px;" src="configure/img/delete.svg"></a>
									   </td>
									</tr>
								 </c:forEach>
								</tbody>
