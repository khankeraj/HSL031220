											...
											function addRows(e) {
												try {
													...
													var $rowTemp = [
															...
															'<td><input  type="text" class="form-control" name="specfication"/></td>',
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Autocase Packer</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">Autocase Packer</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="UpdateAutoCasePackerMaster" method="POST">
									<div class="panel-body">
									
									<s:iterator value="ap2">
									<div class="row">
									  <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Name Of Quotation :
                                                    </label>
                                                    <input type="text" value="${quotation_name}" name="quotation_name" class="form-control" required> </div>
                                          </div>
                                         </div>
									</s:iterator>
										...
										<s:iterator value="ap2">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="auto_case_id" value="${autocase_packer_id}"/>
                                                    <input type="text" value="${name_of_index}" name="name_of_index" class="form-control" required> </div>
                                            </div>
                                            </s:iterator>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Heading Of Specifications :
                                                    </label>
                                                    <input type="text" class="form-control" value="${subanme}" name="subanme"  required> </div>
                                            </div>
                                  		 </div>
													...
													<tr>
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<s:iterator value="autocasepacker3">
																	<tr class="item-row">
																		<td><a id="deleteRow"><img src="configure/img/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
																		<td><input type="text" name="specfication" value="${specifi}" class="form-control">
																		</td>	
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2">Note :
                                                    </label>
                                                    <input type="text" class="form-control" value="${note}" name="note" class="form-control" required> </div>
                                            </div>
                                       </div>
                                       </s:iterator>
