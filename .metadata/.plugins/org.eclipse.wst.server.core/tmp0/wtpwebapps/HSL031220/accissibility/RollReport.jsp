...
<head>
 ...
 <!-- <script>
	function edit(role_name) {

	var currentURL = "RoleEdit?role_name="+role_name+"";
	
		var okdelete = confirm("Are You Sure Want to Edit!");
  ...
  <script>
	function delet(role_name) {

	var currentURL = "RoleDelete?role_name="+role_name+"";
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					 ...
					 <input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='CreateRole'"/> 
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Roll Report</h3>
						</div>
						<div class="panel-body">
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${role_master_bean}" var="role_master_bean">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${role_master_bean.role_name}" /></td>
											
										   
									   <%--  <td align="center"><a style="text-decoration: none;color: green;" title="Edit" onclick="edit('<c:out value="${role_master_bean.role_name}" />')">
											<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>
									   </td> --%>
										
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" onclick="delet('<c:out value="${role_master_bean.role_name}" />')">
