				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_invoice_Igst" class="form-control" method="POST">
                       ...
                       <div id="product" class="tab-pane table-responsive active">
															...
															<!-- AddRowDataTable -->
																...
																<tr class="item-row">
																	...
																	<td>	<input type="text" name="ib.partdate"
																		...
																		<td><input type="text" name="ib.batch1" style="width: 80px;" value="<s:property value="batcht[top]"/>" id="batch1"  /></td>
												...
												<% } %>
																		...
																		<input type="hidden" name="ib.vat1" id="vat1" value="<s:property value="vat[top]"/>"
                                       ...
                                       <div class="row">
                                               ...
                                               <input name="ib.transport" id="transcharge" class="form-control" value="<s:property value="transport"/>" onblur="totalnetamt();" >
                                                </div>
                                       		 </div>
