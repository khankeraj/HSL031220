...
<td width="30%">
<font face="caibri" size="1px">${pono }  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ${podate }</font>
</td>
</tr>
<tr>
<td width="20%">
...
<td width="30%">
<font face="caibri" size="1px">${dcnox } <br>  ${dcdatex }</font>
</td>
</tr>
...
<tr >
					<td align="center" valign="middle" style="border:1px solid #787f7a;" ><font face="caibri" size="1px">SR</font></td>
						...
						<% if(extracolumn.equals("1")) {%>
						<td align="center" valign="middle" style="border:1px solid #787f7a;width:20%;" ><font face="caibri" size="1px"><%=col1 %></font></td>
						<%} %>
						<% if(extracolumn.equals("2")) {%>
						<td align="center" valign="middle" style="border:1px solid #787f7a;width:5%" ><font face="caibri" size="1px"><%=col1 %></font></td>
							<td align="center" valign="middle" style="border:1px solid #787f7a;width:5%" ><font face="caibri" size="1px"><%=col2 %></font></td>
						<%} %>
						<% if(extracolumn.equals("3")) {%>
						<td align="center" valign="middle" style="border:1px solid #787f7a;width:5%" ><font face="caibri" size="1px"><%=col1 %></font></td>
							<td align="center" valign="middle" style="border:1px solid #787f7a;width:5%" ><font face="caibri" size="1px"><%=col2 %></font></td>
							<td align="center" valign="middle" style="border:1px solid #787f7a;width:5%" ><font face="caibri" size="1px"><%=col3 %></font></td>
						<%} %>
				...
				<td align="center" valign="middle" style="width:10%;border:1px solid #787f7a;" ><font face="caibri" size="1px">Batch</font></td>
...
<% if(perunit.equals("yes")) {%>
					<td align="center" valign="middle" style="border:1px solid #787f7a;" ><font face="caibri" size="1px">Sq ft</font></td>
					<% } %>
					...
					<td align="center" valign="middle" style="border:1px solid #787f7a;" ><font face="caibri" size="1px">Disc(%)</font></td>
					<% } %>
					<td align="center" valign="middle" style="border:1px solid #787f7a;" ><font face="caibri" size="1px">Taxable Value</font></td>

					<td align="center" colspan ="2" valign="middle" style="border:1px solid #787f7a;" ><font face="caibri" size="1px">CGST</font></td>
	...
	<s:iterator value="invoicebean_1" var="myobj">
				<s:if test="#myobj.type_1  ==  'parts'">
						...
						<% if(extracolumn.equals("1")) {%>
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"><s:property value="partnoo" /></font></td>
						<%} %>
						<% if(extracolumn.equals("2")) {%>
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"><s:property value="partnoo" /></font></td>
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"><s:property value="partdatee" /></font></td>
						<%} %>
						<% if(extracolumn.equals("3")) {%>
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"><s:property value="partnoo" /></font></td>
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"><s:property value="partdatee" /></font></td>
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"><s:property value="partnoox" /></font></td>
						<%} %>
							...
							<% if(perunit.equals("yes")) {%>
					<td align="right" 	style="border-right: 1px solid #787f7a;padding-right:5px;"><font face="caibri" size="1px"><s:property value="punt" /></font></td>
					<% } %>
							<td align="right" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="1px"><s:property value="myrate1" /></font></td>
							<% if(discount.equals("yes") && !discount.equals("") && !discount.equals("0")) {%>
					<td align="right" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="1px"><s:property value="disc1" /></font></td>
					<% } %>
			...
			<%-- <s:iterator value="invoicebean_2" var="myobj">
				
						<tr>
							<td align="center" 	style="border-right: 1px solid #787f7a;padding-right:5px;"><font size="2" >&nbsp;&nbsp;</font></td>
								
						<% if(extracolumn.equals("1")) {%>
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"></font></td>
						<%} %>
						<% if(extracolumn.equals("2")) {%>
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"></font></td>
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"></font></td>
						...
						<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"></font></td>
						<%} %>
							<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"><s:property value="schemep" /></font></td>
							<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"><s:property value="schemeb" /></font></td>
							<td align="left" 	style="border-right: 1px solid #787f7a;padding-left:5px;"><font face="caibri" size="1px"><s:property value="schemeh" /></font></td>
							<td align="right" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="1px"><s:property value="schemeq" />&nbsp;&nbsp;<s:property value="schemeu" /></font></td>
							<% if(perunit.equals("yes")) {%>
					<td align="right" 	style="border-right: 1px solid #787f7a;padding-right:5px;"><font face="caibri" size="1px"></font></td>
					<% } %>
							<td align="right" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="1px"></font></td>
							<% if(discount.equals("yes") && !discount.equals("") && !discount.equals("0")) {%>
					<td align="right" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="1px"></font></td>
					<% } %>
...
<td align="center" style="border-right: 1px solid #787f7a;padding-right:5px;"><font size="1" >&nbsp;&nbsp;</font></td>							
				...
				<s:if test="#myobj.type_1  ==  'labour'">
						...
						<%} %>
							...
							<td align="right" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="1px"><s:property value="quantity" />&nbsp;&nbsp;<s:property value="unit" /></font></td>
							<% if(perunit.equals("yes")) {%>
							<td align="right" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="1px"><s:property value="punt" /></font></td>
					<% } %>
							<td align="right" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="1px"><s:property value="myrate1" /></font></td>
							<% if(discount.equals("yes") && !discount.equals("") && !discount.equals("0")) {%>
							<td align="right" 	style="border-right: 1px solid #787f7a;padding-right:5px;"><font face="caibri" size="1px"><s:property value="disc1" /></font></td>
					<% } %>
							<td align="right" 	style="border-right: 1px solid #787f7a;padding-right:5px;"><font face="caibri" size="1px"><s:property value="amount" /></font></td>
					...
					<% } %>
						...
						<th align="center" valign="middle"		style="border-left: 1px solid grey;border-right: 1px solid #787f7a;border-top: 1px solid #787f7a;"><font face="caibri" size="1px">&nbsp;</font></th>
							<% if(extracolumn.equals("1")) {%>
						<th align="center" valign="middle"	style="border-right: 1px solid #787f7a;border-top: 1px solid #787f7a;"><font face="caibri" size="1px">&nbsp;</font></th>
						<%} %>
						<% if(extracolumn.equals("2")) {%>
						<th align="center" valign="middle"	style="border-right: 1px solid #787f7a;border-top: 1px solid #787f7a;"><font face="caibri" size="1px">&nbsp;</font></th>
						<th align="center" valign="middle"	style="border-right: 1px solid #787f7a;border-top: 1px solid #787f7a;"><font face="caibri" size="1px">&nbsp;</font></th>
					...
					<% } %>
						...
						<td align="center" valign="middle"	style="border-right: 1px solid #787f7a;border-top: 1px solid #787f7a;;"><font face="caibri" size="1px">&nbsp;</font></td>
						<td align="center" valign="middle"	style="border-right: 1px solid #787f7a;border-top: 1px solid #787f7a;"><font face="caibri" size="1px"><s:property value="cgst" /></font></font></td>
						<td align="center" valign="middle"	style="border-right: 1px solid #787f7a;border-top: 1px solid #787f7a;"><font face="caibri" size="1px">&nbsp;</font></td>
					...
					<% } %>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:100px;border-top: 1px solid #787f7a;"><font face="caibri" size="1px">Total Amount Before Tax</font></td>
					...
					<% } %>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:100px;"><font face="caibri" size="1px">CGST</font></td>
					...
					<tr>
									<td align="left" colspan="3"
										style="border-top: 1px solid grey;border-left: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:50px;"><font face="caibri" size="1px">Bank Name: <%=bank %></font></td>
									<% if(extracolumn.equals("1")) {%>
						<td align="left"
										style="border-top: 1px solid grey;border-right: 1px solid grey; padding-left: 5px;width:550px;border-top: 1px solid #787f7a;">&nbsp;</td>
						<%} %>
					...
					<% } %>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:100px;"><font face="caibri" size="1px">SGST</font></td>
				...
				<tr>
									<td align="left" colspan="3"
										style="border-left: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:50px;"><font face="caibri" size="1px">AC/ No: <%=acno %></font></td>
									<% if(extracolumn.equals("1")) {%>
						<td align="left"
										style="border-top: 1px solid grey;border-right: 1px solid grey; padding-left: 5px;width:550px;border-top: 1px solid #787f7a;">&nbsp;</td>
						<%} %>
					...
					<% } %>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:100px;"><font face="caibri" size="1px">Total Tax Amount</font></td>
								...
								<tr>
									<td align="left" colspan="3"
										style="border-left: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:50px;"><font face="caibri" size="1px">IFSC Code: <%=ifsc %></font></td>
...
<% if(discount.equals("yes") && !discount.equals("") && !discount.equals("0")) {%>
					...
					<% } %>
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:100px;"><font face="caibri" size="1px">Total Amount after Tax</font></td>
							...
							<s:if test="freight!='0.00'">	
								<tr>
									<td align="left" colspan="3"
										style="border-left: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:50px;"><font face="caibri" size="1px"></font></td>
					...
					<% } %>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:100px;"><font face="caibri" size="1px">Freight</font></td>
						...
						<td align="center"
							...
							<%} %>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey; padding-right: 5px;width:100px;"><font face="caibri" size="1px">Transport</font></td>
