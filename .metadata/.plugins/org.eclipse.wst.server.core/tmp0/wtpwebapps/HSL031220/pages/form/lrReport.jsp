...
<head>
 ...
 <script>
	function cancel(lr_number) {

		
	var currentURL = "Cancel_lr?lr_number="+lr_number+"";
	
	
	  
	if (confirm('Do You Want Delete lr_number:- '+lr_number)) {
...
<script>
	function status(lr_number) {

		
	var currentURL = "LrStatus?lr_number="+lr_number+"";
...
<script>
	function chitchat(lr_number) {

		
	var currentURL = "LrChitChat?lr_number="+lr_number+"";
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <c:forEach items="${tripDetails}" var="tripDetails">
									<tr>
										<td><%=i++ %></td>
										<%-- <td><c:out value="${tripDetails.trip_id}" /></td>
										<td><c:out value="${tripDetails.updown_id}" /></td> --%>
										<td><c:out value="${tripDetails.lr_number}" /></td>
										<td><c:out value="${tripDetails.customer_name}" /></td>
										<td><c:out value="${tripDetails.date}" /></td>
										<td><c:out value="${tripDetails.mobile}" /></td>
										<td><c:out value="${tripDetails.source}" /></td>
										<td><c:out value="${tripDetails.destination}" /></td>
										<td><c:out value="${tripDetails.vehicle_no}" /></td>
										<td><c:out value="${tripDetails.driver_name}" /></td>
										
										<td><c:out value="${tripDetails.exp_amount}" /></td>
										
										<td><c:out value="${tripDetails.total_amount}" /></td>
										
										
										
										
										<td> <a href="LR_View?lr_number=<c:out value="${tripDetails.lr_number}" />">
										
											<img alt="View" height="35px;" src="configure/img/view.svg"></a>
										
										</td>
										
										<td> <a href="LR_Edit?lr_number=<c:out value="${tripDetails.lr_number}" />"> 
										
											<img alt="View" height="35px;" src="configure/img/editmeeting.svg"></a>
										
										</td>
										
										
										<td> <a href="LR_print?lr_number=<c:out value="${tripDetails.lr_number}" />">
										
											<img alt="Print" height="35px;" src="configure/img/print.jpg"></a>
										...
										<td>
											<a href="trip_issue_form?trip_id=<c:out value="${tripDetails.trip_id}" />&source=<c:out value="${tripDetails.source}" />&destination=<c:out value="${tripDetails.destination}" />&vehicle_no=<c:out value="${tripDetails.vehicle_no}" />&driver_name=<c:out value="${tripDetails.driver_name}" />&updown_id=<c:out value="${tripDetails.updown_id}" />&updown=<c:out value="${tripDetails.updown}" />&customer_name=<c:out value="${tripDetails.customer_name}" />&lr_number=<c:out value="${tripDetails.lr_number}" />"><img alt="" height="20px" width="30px" src="configure/img/budget.png"></a> 
										</td>
										
										
										
									<%-- 	<td>
											<a href="lr_advanceform?trip_id=<c:out value="${tripDetails.trip_id}" />&source=<c:out value="${tripDetails.source}" />&destination=<c:out value="${tripDetails.destination}" />&vehicle_no=<c:out value="${tripDetails.vehicle_no}" />&driver_name=<c:out value="${tripDetails.driver_name}" />&updown_id=<c:out value="${tripDetails.updown_id}" />&updown=<c:out value="${tripDetails.updown}" />&customer_name=<c:out value="${tripDetails.customer_name}" />&lr_number=<c:out value="${tripDetails.lr_number}" />"><img alt="" height="20px" width="30px" src="configure/img/budget.png"></a> 
										</td>
										 --%>
										
										<td>
											<a href="delivery_done_form?lr_number=<c:out value="${tripDetails.lr_number}" />&todate=<c:out value="${tripDetails.date}" />">
										
											<img alt="Print" height="35px;" src="configure/img/delivery-van.svg"></a>
										
										</td>
										
										
										<td>
											<a href="pi_done_form?lr_number=<c:out value="${tripDetails.lr_number}" />&todate=<c:out value="${tripDetails.date}" />">
										...
										<%-- <td>
											<a href="Cancel_lr?lr_number=<c:out value="${tripDetails.lr_number}" />"><button>Cancel</button></a> 
										</td> --%>
										
										
									   <td align="center"><a style="text-decoration: none;color: green;" title="Status" onclick="status('<c:out value="${tripDetails.lr_number}" />')" >
											<img alt="Status" height="35px;" src="configure/img/status.jpg"></a>
									   </td>
									   
									   <td align="center"><a style="text-decoration: none;color: green;" title="Chit Chat" onclick="chitchat('<c:out value="${tripDetails.lr_number}" />')" >
											<img alt="Chit Chat" height="35px;" src="configure/img/chit.png"></a>
									   </td>
									   
									   
										<td> <a href="VendorBill?lr_number=<c:out value="${tripDetails.lr_number}" />">
										
											<img alt="View" height="35px;" src="configure/img/bill.svg"></a>
										
										</td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Cancel" onclick="cancel('<c:out value="${tripDetails.lr_number}" />')" >
											<img alt="Cancel" height="25px;" src="configure/img/cancel.svg"></a>
									   </td>
