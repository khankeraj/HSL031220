...
<head>
  ...
  <!-- AutoSearch -->
	...
	$(function() {
		...
		$("#trip_id").autocomplete("GoogleSearch/autosearchtrip.jsp");
		$("#updown_id").autocomplete("GoogleSearch/autosearchupdown.jsp");
		$("#lr_number").autocomplete("GoogleSearch/autosearchlr.jsp");
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">LR Profit Report</h3>
						</div>
						
						<div class="panel-body">
						
						<form action="lr_profit_Reports">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="trip_id"  id="trip_id" value="" class="form-control" >
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="updown_id"  id="updown_id" value="" class="form-control" >
												</div>
											</div>
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="lr_number"  id="lr_number" value="" class="form-control" >
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="customer_name"  id="customer_name" value="" class="form-control" >
												</div>
											</div>
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="source"  id="source" value="" class="form-control" >
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="destination"  id="destination" value="" class="form-control" >
												</div>
											</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <c:forEach items="${deliveryDetails}" var="deliveryDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${deliveryDetails.trip_id}" /></td>
										<td><c:out value="${deliveryDetails.updown_id}" /></td>
										<td><c:out value="${deliveryDetails.lr_number}" /></td>
										<td><c:out value="${deliveryDetails.date}" /></td>
										...
										<td><c:out value="${deliveryDetails.total_expense}" /></td>
										<td><c:out value="${deliveryDetails.commision}" /></td>
										<td><c:out value="${deliveryDetails.profit}" /></td>
								...
								<%-- <c:forEach items="${deliveryDetails}" var="item" varStatus="status">
