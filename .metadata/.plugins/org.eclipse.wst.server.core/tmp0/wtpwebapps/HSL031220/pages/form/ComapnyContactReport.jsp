...
<head>
  ...
  <script>
	...
	var currentURL = "CompanyContactEdit?id="+id+"";
...
<script>
	...
	var currentURL = "CompanyContactDelete?id="+id+"";
	
		var okdelete = confirm("Are You Sure You Want To Delete..!");
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					...
					<a href="CompanyContactForm"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
								...
								<tbody>
								 ...
								 <c:forEach items="${inquiryReport}" var="inquiryReport">
									<tr>
									   ...
									   <td align="center"><a style="text-decoration: none;color: green;" title="Delete" onclick="delet('<c:out value="${inquiryReport.id}"/>')">
