...
<head>
  ...
  <script>
	function invoiceview(invoiceno,type) {

	var currentURL = "BillView?invoice="+invoiceno+"&type="+type+"";
...
<script>
	function invoiceedit(invoiceno,type) {

	var currentURL = "BillEdit?invoice="+invoiceno+"&type="+type+"";
...
<script>
	function invoicePrint(invoiceno,type) {

	var currentURL = "Billprintnew?invoice="+invoiceno+"&type="+type+"";
 ...
 <script>
	function invoicePrintwithout(invoiceno,type) {

	var currentURL = "Billprintnewwiout?invoice="+invoiceno+"&type="+type+"";
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					 ...
					 <!-- <input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='CityMaster'"/> -->
					...
					<div class="panel">
						...
						<div class="panel-body">
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${report12}" var="report12">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${report12.invoiceno}" /></td>
										<td><c:out value="${report12.date}" /></td>
										<td><c:out value="${report12.name}" /></td>
										<td><c:out value="${report12.total}" /></td>
										<td><c:out value="${report12.type}" /></td>
											
										 <td align="center"><a style="text-decoration: none;color: green;" title="Bill View" onclick="invoiceview('<c:out value="${report12.invoiceno}"/>','<c:out value="${report12.type}"/>')">
											<img alt="Bill View" height="35px;" src="configure/img/view.svg"></a>
									   </td> 
									   
									   <td align="center"><a style="text-decoration: none;color: green;" title="Bill Edit" onclick="invoiceedit('<c:out value="${report12.invoiceno}"/>','<c:out value="${report12.type}"/>')">
											<img alt="Bill Edit" height="35px;" src="configure/img/editmeeting.svg"></a>
									   </td>  
									   
									   
									     <td align="center"><a style="text-decoration: none;color: green;" title="Print Without Heading" onclick="invoicePrintwithout('<c:out value="${report12.invoiceno}"/>','<c:out value="${report12.type}"/>')">
											<img alt="Bill Edit" height="35px;" src="configure/img/print.jpg"></a>
									   </td>  
									    
									   
									     <td align="center"><a style="text-decoration: none;color: green;" title="Bill Edit" onclick="invoicePrint('<c:out value="${report12.invoiceno}"/>','<c:out value="${report12.type}"/>')">
											<img alt="Bill Edit" height="35px;" src="configure/img/print.jpg"></a>
									   </td>  
									     <td align="center">
									     
									     <a href="trip_issue_form1?inv=<c:out value="${report12.invoiceno}" />"><img alt="" height="20px" width="30px" src="configure/img/budget.png"></a> 
