			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="Insert_Driver_Salary" method="POST">
								      ...
								      <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="date" class="form-control" placeholder="" style="line-height: 15px;" name="date"   onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>
									  </div>
											  ...
											  <div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Total Days Present :</label>
														<input type="text" placeholder="" autocomplete="off" name="days_present" id="bank_name" onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>
											<div class="col-sm-6">
											<div class="form-group">
												<label class="control-label">Tax :</label>
												<input type="text" placeholder=""  autocomplete="off" name="tax"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
											</div>
										 </div>
										 </div>
									   ...
									   <div class="row">
										 <div class="col-sm-6">	 
											<div class="form-group">
												...
												<input type="text" placeholder="" name="bonus"  class="form-control" required>
											</div>
									     </div>
										...
										<div class="col-sm-6">	 
											<div class="form-group">
												...
												<input type="text" placeholder="" name="other"  class="form-control" required>
											</div>
									     </div>
										</div>
										...
										<div class="row">
									     ...
									     <div class="col-sm-6">
											<div class="form-group">
												...
												<input type="text" placeholder="" name="fine"  class="form-control" pattern="[0-9]*" maxlength="10" onblur="phoneNumberCheck(this);"required>
											</div>
										</div>
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<input type="text" placeholder="" name="overtime"  class="form-control" required>
											</div>
										</div>
