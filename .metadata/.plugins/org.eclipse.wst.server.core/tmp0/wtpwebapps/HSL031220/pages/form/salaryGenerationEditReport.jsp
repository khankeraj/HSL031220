				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Salary Generation Edit Report</h3>
						</div>
								...
								<tbody>
								 ...
								 <c:forEach items="${drivermodeldetails}" var="drivermodeldetails">
									<tr>
										...
										<td align="center"><a  title="Update" style="text-decoration: none;color: green;" href="EditSalaryGenerate?mnth=<c:out value="${drivermodeldetails.month}" />&yr=<c:out value="${drivermodeldetails.year}" />">
