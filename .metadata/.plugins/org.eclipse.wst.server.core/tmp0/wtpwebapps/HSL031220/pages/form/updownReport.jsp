				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Up/Down Report</h3>
						</div>
								...
								<tbody>
								 ...
								 <c:forEach items="${tripDetails}" var="tripDetails">
									<tr>
										...
										<td>
											<%-- <a href="LR_form1?trip_id=<c:out value="${tripDetails.trip_id}" />&source=<c:out value="${tripDetails.source}" />&destination=<c:out value="${tripDetails.destination}" />&vehicle_no=<c:out value="${tripDetails.vehicle_no}" />&driver_name=<c:out value="${tripDetails.driver_name}" />&updown_id=<c:out value="${tripDetails.updown_id}" />&updown=<c:out value="${tripDetails.updown}" />"><button>LR form</button></a> --%> 
											<a href="LR_form1?trip_id=<c:out value="${tripDetails.trip_id}" />&source=<c:out value="${tripDetails.source}" />&destination=<c:out value="${tripDetails.destination}" />&vehicle_no=<c:out value="${tripDetails.vehicle_no}" />&driver_name=<c:out value="${tripDetails.driver_name}" />&updown_id=<c:out value="${tripDetails.updown_id}" />&updown=<c:out value="${tripDetails.updown}" />"><img alt="" height="20px" width="30px" src="configure/img/truck.png"></a>
										</td>
										
										<%-- <td><c:out value="${tripDetails.trip_exp_amount}" /></td> --%>
										
										<td>
											<%-- <a href="trip_issue_form2?trip_id=<c:out value="${tripDetails.trip_id}" />&source=<c:out value="${tripDetails.source}" />&destination=<c:out value="${tripDetails.destination}" />&vehicle_no=<c:out value="${tripDetails.vehicle_no}" />&driver_name=<c:out value="${tripDetails.driver_name}" />&updown_id=<c:out value="${tripDetails.updown_id}" />&updown=<c:out value="${tripDetails.updown}" />"><button>up/down issue</button></a> --%> 
											<a href="trip_issue_form2?trip_id=<c:out value="${tripDetails.trip_id}" />&source=<c:out value="${tripDetails.source}" />&destination=<c:out value="${tripDetails.destination}" />&vehicle_no=<c:out value="${tripDetails.vehicle_no}" />&driver_name=<c:out value="${tripDetails.driver_name}" />&updown_id=<c:out value="${tripDetails.updown_id}" />&updown=<c:out value="${tripDetails.updown}" />"><img alt="" height="20px" width="30px" src="configure/img/budget.png"></a>
										</td>
