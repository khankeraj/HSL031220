								...
								<form action="InvoiceSubmit" class="form-control"  method="POST"  onsubmit="myFunction();">
									...
									<div class="row">
							          ...
							          <div class="form-group">
							                ...
							                <input type="text" class="form-control" value="<s:property value="name"/>" id="name" name="name" required >
							              
							               <input type="hidden" class="form-control" value="<s:property value="customer_no"/>" id="customer_no" name="customer_no"  >
							              <input type="hidden" class="form-control" value="<s:property value="inquiry_id"/>" id="inquiry_id" name="inquiry_id"  >
							          ...
							          <div class="form-group">
							                ...
							                <input type="text" class="form-control" value="<s:property value="invoiceno"/>" name="invoiceno" id="invoiceno"  readonly  required>
							              </div>
							          ...
							          <div class="form-group">
							                <label>Date</label>
							                <input type="text" class="form-control"  name="date" id="date" value="<s:property value="date"/>"   required>
							              </div>
							          ...
							          <div class="form-group">
							                ...
							                <input type="text" class="form-control" value="<s:property value="mobile"/>" id="mobile" name="mobile" required >
							              </div>
							          ...
							          <div class="form-group">
							                <label>GSTN No</label>
							                <input type="text" class="form-control" value="<s:property value="gstn"/>" name="gstn" id="gstn"   required>
							              </div>
							          ...
							          <div class="form-group">
							                <label>Bill To</label>
							                <input type="text" class="form-control" id="destination" value="<s:property value="bill_to"/>" name="destination" required >
							              </div>
							          ...
							          <div class="form-group">
							                ...
							                <input type="text" class="form-control" id="lr_amount" name="lr_amount" onblur="totalQty(this)" required  >
							              </div>
									 ...
									 <div class="row">
							          ...
							          <div class="form-group">
							                ...
							                <input type="text" class="form-control" id="buyer_contact_person" name="buyer_contact_person" required >
							              </div>
							          ...
							          <div class="form-group">
							                ...
							                <input type="text" class="form-control" id="buyer_contact_no" name="buyer_contact_no" onblur="totalQty(this)" required  >
							              </div>
							          ...
							          <div class="form-group">
							                ...
							                <input type="text" class="form-control" id="payterm" name="payterm" required >
							              </div>
...
&nbsp;							              </div>
								...
								<table id="itemsTable$" class="table table-striped table-bordered" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<th id="VLsparename" ><label>Manual NO</label></th>
										<th id="VLsparename" ><label>DATE</label></th>
										
										<th id="VLsparename" ><label>CONSIGNOR</label></th>
								...
								<s:iterator value="(gridsize).{# this}" status="stat">
									...
									id="aa" value="<s:property value="dcnot[top]"/>" readonly/></td>
									
									
										<td><input class="form-control" style="width:120px;"  type="text" name="hh"  
									id="hh" value="<s:property value="dcnot[top]"/>" /></td>
									
									<td><input class="form-control" style="width:120px;"  type="text" name="bb"  
									id="bb" value="<s:property value="descriptiont[top]"/>" readonly/></td>
									
									<td><input class="form-control" style="width:120px;"  type="text" name="cc"  
									id="cc" value="<s:property value="quantityt[top]"/>" readonly/></td>
									
									<td><input class="form-control" style="width:120px;"  type="text" name="dd"  
									id="dd" value="<s:property value="myrate[top]"/>" readonly/></td>
									...
									id="ff" value="<s:property value="rate[top]"/>" readonly/></td>									
									
									
									<td><input class="form-control" style="width:80px;"  type="text" name="gg"  
									id="gg" value="<s:property value="bank22[top]"/>" required/></td>
									
									<!-- <td><input class="form-control" style="width:80px;"  type="text" name="hh"  
									id="hh" onblur="getAmount(this);totalQty(this);" required/></td>
									 -->
									 
									 <s:if test="#session.USER_PROFILE.type=='Admin'"> 
									 
									<td><input class="form-control" style="width:80px;"  type="text" name="ii"  
									id="ii" value="<s:property value="totalamt[top]" />" onblur="totalQty(this)" required  /></td>
									</s:if>
									
									<s:else>
									
										<td><input class="form-control" style="width:80px;"  type="text" name="ii"  
									id="ii" value="<s:property value="totalamt[top]"/>" required  readonly/></td>
