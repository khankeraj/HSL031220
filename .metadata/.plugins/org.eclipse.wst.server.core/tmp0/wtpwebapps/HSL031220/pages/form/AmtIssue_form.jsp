	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Amount Issue Form</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">Amount Issue Form</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="insert_amt" id="frmFileUpload" class="form-control " method="post" enctype="multipart/form-data">
					    <br>
					<div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group floating-label">
                                    <input type="text"  name="date1y" id="date1y" class="form-control floating-input" onblur="FixShortDate(this);return ValidateForm(this);"   placeholder=" "  required>
                           ...
                           <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group floating-label">
                                    <input type="text"  name="given_by" id="given_by" class="form-control floating-input"   placeholder=" " onblur="getname();"  required>
                           ...
                           <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group floating-label">
                                    <input type="text"  name="name" id="emp_name" class="form-control floating-input"   placeholder=" " onblur="getdetails(this);"  required>
                          ...
                          <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group floating-label">
                                    <input type="text"  name="particular" id="exp_parti" class="form-control floating-input"   placeholder=" "   required>
                           ...
                           <div class="row clearfix">
                            <div class="col-sm-6">
                                <div class="form-group floating-label">
                                    <input type="text"  name="amount1" id="amount1" class="form-control floating-input"   placeholder=" "  required>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group floating-label">
                                    <input type="text"  name="remark" id="remark" class="form-control floating-input"   placeholder=" "  required>
                                    <input type="hidden"  name="emp_id" id="emp_id" class="form-control floating-input"  placeholder=" "   required>
                                    <label>Remark</label>
                                                                       
                                </div> 
                            </div>
                           </div>
                             <input type="hidden"  name="given_id" id="given_id" class="form-control floating-input"   placeholder=" " >
