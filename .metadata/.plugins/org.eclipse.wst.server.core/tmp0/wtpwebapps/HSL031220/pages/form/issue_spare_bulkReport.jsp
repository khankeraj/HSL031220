				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Issue Spare Bulk Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${issue_sparebulkReport}" var="issue_sparebulkReport">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${issue_sparebulkReport.customer_name}" /></td>
										<td><c:out value="${issue_sparebulkReport.customer_code}" /></td>
										<td><c:out value="${issue_sparebulkReport.description}" /></td>
										<td><c:out value="${issue_sparebulkReport.quantity}" /></td>
										<td><c:out value="${issue_sparebulkReport.emp_code}" /></td>
