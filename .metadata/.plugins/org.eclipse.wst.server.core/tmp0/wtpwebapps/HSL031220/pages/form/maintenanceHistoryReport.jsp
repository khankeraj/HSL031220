			...
			<div id="content-container">
				...
				<div id="page-content">
					<div class="panel">
						...
						<form action="maintenance_Reports">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">Vehicle No:</label>
														...
														<input type="text" class="form-control" placeholder="" name="vehicle_no"  id="vehicle_no" value=""  class="form-control" required>
												</div>
											</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${maintenanceDetails}" var="maintenanceDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${maintenanceDetails.date}" /></td>
										<td><c:out value="${maintenanceDetails.vehicle_no}" /></td>
										<td><c:out value="${maintenanceDetails.servicing_company}" /></td>
										<td width="25%">
											<table width="50%">
											<c:forEach items="${maintenanceDetails.description}" var="question">
											    <tr>
													<td>${question}</td>
												</tr>
											</c:forEach>
										...
										<td width="25%">
											<table width="50%">
												<c:forEach items="${maintenanceDetails.amount}" var="question">
											    <tr>
													<td>${question}</td>
												</tr>
											</c:forEach>
												<tr>
													<td><b>Total:<c:out value="${maintenanceDetails.total_amount}" /></b></td>
												</tr>
											</table>
