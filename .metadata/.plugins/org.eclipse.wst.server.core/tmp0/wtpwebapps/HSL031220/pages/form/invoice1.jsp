  ...
  <!-- AutoSearch -->
	...
	function getValues(v)
	  ...
	  function checkTotals()
	 {
		...
		/* else
		{ */
			document.getElementById("form1").action = "Add_invoice1";
		//}
	 } 
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">Customer Code:</label>
														...
														<input type="text" class="form-control" placeholder="" name="customer_no" id="customer_no" value="${customer_no }"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required readonly>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">Customer Name:</label>
														...
														<input type="text" class="form-control" placeholder="" name="customer_name" id="customer_name" value="<%=request.getParameter("customer_name") %>"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required readonly>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">Pan No:</label>
														...
														<input type="text" class="form-control" placeholder="" name="pan_no" id="pan_no" value="<s:property value = "pan_no" />"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required readonly>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">State:</label>
														...
														<input type="text" class="form-control" placeholder="" name="state" id="state" value="<s:property value = "state" />"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required readonly>
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="trip_id" id="trip_id" value="<%=request.getParameter("trip_id") %>"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required readonly>
												</div>
											</div>
																...
																<c:forEach items="${deliveryDetails}" var="deliveryDetails">
																	...
																	<td><input type="text" name="description" class="form-control"
																		...
																		<td><input type="text" name="weight" class="form-control"
																			style="width: 100px;" id="weight" value="${deliveryDetails.received_weight1}" 
																		...
																		<td><input type="text" name="gst_rate2" class="form-control"
																			id="gst_rate2" value="${deliveryDetails.gstrate2}"
																			tabindex="12"
																			style="width: 100px;" />
																		</td>
																		
																		<td><input type="text" name="gst_rate2amt" class="form-control"
													...
													<tr>
														<td>
																<table>
																	...
																	<tr><td>CGST: </td><td><input class="form-control"  type="text" name="cgst" id="cgst"></td></tr>
														...
														function addRows(e) {
															try {
																...
																var $rowTemp = [
																		...
																		'<td><input style="width:100px;" type="text" class="form-control" name="gst_rate2"   id="gst_rate2" value=""  /></td>',
																		'<td><input style="width:100px;" type="text" class="form-control" name="gst_rate2amt"   id="gst_rate2amt" value=""  /></td>',
