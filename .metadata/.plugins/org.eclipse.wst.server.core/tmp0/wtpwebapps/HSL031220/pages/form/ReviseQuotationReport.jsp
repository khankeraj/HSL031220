  ...
  <!-- AutoSearch -->
	...
	$(function() {
		...
		// $("#driver_name").autocomplete("GoogleSearch/autosearchDriver.jsp");
		 ...
		 $("#dealer_id").autocomplete("GoogleSearch/autosearchCustomerForQuot.jsp");
...
<script>
	function print(quotation_no,rno) {

	var currentURL = "RevisedQuotationPrint?quotation_no="+quotation_no+"&rno="+rno+"";
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Revised Quotation Report</h3>
						</div>
						<div class="panel-body">
						
						
						<form action="ReviseQuotationReport1">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="dealer_id"  id="dealer_id"  required>
												</div>
								...
								<tbody>
								 ...
								 <s:iterator value="inquiryReport">
									<tr>
										...
										<td  align="center"><a style="text-decoration: none;color: green;" title="Print" onclick="print('<s:property value="quotation_no"/>','<s:property value="rno"/>')" >
