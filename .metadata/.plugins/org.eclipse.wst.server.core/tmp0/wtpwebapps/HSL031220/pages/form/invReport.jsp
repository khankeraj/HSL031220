								...
								<tbody>
								 ...
								 <c:forEach items="${deliveryDetails}" var="deliveryDetails">
									<tr>
										...
										<td><c:out value="${deliveryDetails.customer_no}" /></td>
										...
										<td><c:out value="${deliveryDetails.invtype}" /></td>
										
										
										<td><a href="InvoicePrint?invoiceno=<c:out value="${deliveryDetails.invoiceno}" />&type=<c:out value="${deliveryDetails.invtype}" />"><button>print</button></a></td>
										
										
										
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdateInvoice?invoiceno=<c:out value="${deliveryDetails.invoiceno}" />&customer_no=<c:out value="${deliveryDetails.customer_no}" />&type=<c:out value="${deliveryDetails.invtype}" />">
