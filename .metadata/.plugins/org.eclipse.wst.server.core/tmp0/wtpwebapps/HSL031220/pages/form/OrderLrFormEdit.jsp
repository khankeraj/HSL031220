	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">LR Form Edit</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">LR Form Edit</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="update_lr_action" method="POST">
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${date}" style="line-height: 15px;" placeholder="" name="date" id="date" class="form-control" required>
												</div>
											</div>
								      ...
								      <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${source}" name="source" id="source"   class="form-control" required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${destination}" name="destination" id="destination"   class="form-control" required>
												</div>
											</div>
									  </div>
									  ...
									  <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${transporter_name}-${transporter_code}" name="transporter_name" id="transporter_name"   class="form-control" required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${customer_name}" onblur="getAddress(this)" name="customer_name" id="customer_name"   class="form-control" required>
												</div>
											</div>
									  </div>
							...
							<input type="hidden" class="form-control" value="${transporter_addr}" name="transporter_addr" id="transporter_addr"   class="form-control" >
												
							<input type="hidden" class="form-control" value="${customer_addr}" name="customer_addr" id="customer_addr"   class="form-control" >
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="driver_name"  id="driver_name" value="${driver_name}-${driver_code}"   class="form-control" required>
												</div>
											</div>
									  </div>
										...
										<input type="hidden" class="form-control" value="${order_id}" name="order_id" id="order_id"  readonly>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${volume}" name="volume" id="volume"  >
												</div>
											</div>
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<select class="form-control show-tick " name="insurance" id="insurance" >
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<select class="form-control show-tick " name="booking" id="booking" >
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${val_rupees}"  name="val_rupees" id="val_rupees"  >
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<select class="form-control show-tick " name="freight" id="freight" >
									  ...
									  <div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${bill_to}" name="bill_to" id="bill_to"  required>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Invoice No</label>
													<input type="text" class="form-control" value="${invoice_No}" name="invoice_No" id="invoice_No"  required>
												</div>
											</div>
									</div>
									<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"   value="${invoice_value}" name="invoice_value" id="invoice_value"  required>
												</div>
											</div>
                                         ...
                                         <div class="col-md-6">
                                                <div class="form-group">
														...
														<!-- <div  id="myd11">
															...
															<input type="checkbox" name="myd2"  id="myd2" onclick="showmyd1(this)" value="myd2"  >&nbsp;&nbsp;&nbsp;<b> Consignee</b>
									 ...
									 <div class="row"  id="444">
									  		<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  value="${shipname}" onblur="getAddress123(this)" name="shipname" id="shipname">
												</div>
											</div>
									   ...
									   <div class="row" id="666">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${dest_contact_person}" name="dest_contact_person" id="dest_contact_person"   >
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${dest_contact_no}"  name="dest_contact_no" id="dest_contact_no"   onblur="checkMobileLength2(this);" >
												</div>
											</div>
									  </div>
                                         ...
                                         <div class="row"  id="777">
									  		<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${buyername}" onblur="getAddress124(this)" name="buyername" id="buyername">
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${buyeradd}"  name="buyeradd" id="buyeradd"  >
												</div>
											</div>
									   ...
									   <div class="row"  id="888">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  value="${buyerstatus}"  name="buyerstatus" id="buyerstatus"  >
												</div>
											</div>
									  ...
									  <div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${buyergstn}"  name="buyergstn" id="buyergstn"  >
												</div>
											</div>
									   ...
									   <div class="row"  id="999">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Contact Person</label>
													<input type="text" class="form-control"  value="${buyer_contact_person}"  name="buyer_contact_person" id="buyer_contact_person"  >
												</div>
											</div>
									  ...
									  <div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Contact Number:</label>
													<input type="text" class="form-control" value="${buyer_contact_no}"  name="buyer_contact_no" id="buyer_contact_no"  >
												</div>
											</div>
									  ...
									  <div id="product" style="width:100%">
																...
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="70%">
																	...
																	<td><input type="text"  value="<s:property value="cc1"/>" name="cc" class="form-control" style="width: 250px;" id="cc"  required/></td>
																		
																	<td><input type="text" value="<s:property value="aa1"/>" name="aa" class="form-control" style="width: 80px;"  id="aa" required/></td>
																	
																		<td><input type="text"  value="<s:property value="bb1"/>" name="bb" class="form-control" style="width: 80px;"  id="bb" required/></td>
																		...
																		<td><input type="text" value="<s:property value="ff1"/>" name="ff" class="form-control" id="ff"  style="width: 100px;"  required/> </td>
																		 --%>
																		<td><input type="text" value="<s:property value="gg1"/>" name="gg" onblur="getTotal(this);" class="form-control" id="gg"  style="width: 80px;"  required/> </td>
																		
																		<%-- <td><input type="text" value="<s:property value="hh1"/>" name="hh" onblur="getAmount(this);getTotal1(this);" class="form-control" id="hh"  style="width: 80px;"  required/> </td>
																		 --%>
																		<td><input type="text" value="<s:property value="ii1"/>" name="ii"  class="form-control" id="ii"  style="width: 80px;"  onblur="getTotal1(this);"  required/> </td>
														...
														function addRows(e) {
															try {
																...
																var $rowTemp = [
																		...
																		/* '<td><input type="text" name="dd" class="form-control" id="dd"  style="width: 80px;" required/> </td>',
																		
																		'<td><input type="text"  name="ee" class="form-control" id="ee"   style="width: 100px;"  required/> </td>',
																		
																		'<td><input type="text" name="ff" class="form-control" id="ff"  style="width: 100px;"  required/> </td>',
																		 */
																		'<td><input type="text" name="gg" onblur="getTotal(this);" class="form-control" id="gg"  style="width: 80px;"  required/> </td>',
																		
																		/* '<td><input type="text" name="hh" onblur="getAmount(this);getTotal1(this);" class="form-control" id="hh"  style="width: 80px;"  required/> </td>',
																		 */
																		'<td><input type="text" name="ii"  class="form-control" id="ii"  style="width: 80px;"  onblur="getTotal1(this);" required/> </td>',
																		'</tr>' ]
																		.join('');
