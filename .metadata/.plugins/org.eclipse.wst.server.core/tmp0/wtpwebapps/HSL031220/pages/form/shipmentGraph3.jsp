...
<script src="Css/jquery-1.10.2.js" type="text/javascript"></script>
 <!-- AutoSearch -->
  ...
  <!-- AutoSearch -->
	...
	var main1=[];
	var qqq1=['EXIM Resource Business Graph','Amount'];
	var tot_a="";
	var tot_b="";
	...
	main1.push(qqq1);
      ...
      function drawStuff() {
		...
		var options1 = {title: 'EXIM Resource Business Graph',};
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">EXIM Resource Graph </h1>
				</div>
				<!--End page title-->
				...
				<input type="hidden" value="${graph7}" id="graph7"> 
