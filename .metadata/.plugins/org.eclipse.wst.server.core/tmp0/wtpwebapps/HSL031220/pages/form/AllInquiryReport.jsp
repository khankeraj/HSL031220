				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Inquiry Report</h3>
						</div>
						
						<div class="panel-body">
					
					<form name="collection_summary" action="AllEnquiryReport" id="collection_summary">

						
						<td align="left"><b>From_date</b></td>

						<td><input type="text" name="im.from_date" id="from_date"
						...
						<td><input type="text" width="20px" name="im.to_date1" value="${dt}"
