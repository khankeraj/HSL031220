	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Up/Down Issue Form</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">Up/Down Issue Form</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="insert_tripissue_action2" method="POST">
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="updown_id" id="updown_id" value="${updown_id}"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" readonly required>
													<input type="hidden" class="form-control" placeholder="" name="trip_id" id="trip_id" value="${trip_id}"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
													<input type="hidden" class="form-control" placeholder="" name="updown" id="updown" value="${updown}"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>
