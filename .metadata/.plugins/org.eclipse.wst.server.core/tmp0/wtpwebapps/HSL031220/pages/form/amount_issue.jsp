			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="insert_amountissue_action" method="POST">
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="date" class="form-control" style="line-height: 15px;" placeholder="" name="date" id="date" class="form-control" required>
												</div>
											</div>
									  </div>
								      ...
								      <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="given_to" id="given_to"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>
									  </div>
									  ...
									  <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="amount1" id="amount1"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>
