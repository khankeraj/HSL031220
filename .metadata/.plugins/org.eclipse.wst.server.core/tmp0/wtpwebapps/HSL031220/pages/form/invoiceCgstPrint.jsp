...
<td align="center" style="border-right: 1px solid #787f7a;padding-right:5px;"><font size="1" >&nbsp;&nbsp;</font></td>							
				...
				<s:if test="#myobj.type_1  ==  'labour'">
					...
					<tr>
              		...
              		<td align="center" style="border-top: 1px solid grey;">&nbsp;</td>
					<td align="left" style="border-top: 1px solid grey;">&nbsp;</td>
							<% if(extracolumn.equals("1")) {%>
						<td align="left"
										style="border-top: 1px solid grey;">&nbsp;</td>
						<%} %>
						<% if(extracolumn.equals("2")) {%>
						<td align="left" style="border-top: 1px solid grey;">&nbsp;</td>
						<td align="left" style="border-top: 1px solid grey;">&nbsp;</td>
						...
						<% if(discount.equals("yes") && !discount.equals("") && !discount.equals("0")) {%>
												<td align="left"
										style="border-top: 1px solid grey; padding-left: 5px;width:550px;border-top: 1px solid #787f7a;">&nbsp;</td>
					...
					<% } %>
										...
										style="border-top: 1px solid grey; padding-left: 5px;width:550px;border-top: 1px solid #787f7a;">&nbsp;</td>
									<td align="center"
										style="border-top: 1px solid grey; padding-right: 5px;width:150px;border-top: 1px solid #787f7a;"><font
									size="2px">&nbsp;</font></td>
									<td align="center"
										style="border-top: 1px solid grey; padding-right: 5px;width:150px;border-top: 1px solid #787f7a;"><font
									size="2px">&nbsp;</font></td>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey;border-left: 1px solid grey; padding-right: 5px;width:100px;border-top: 1px solid #787f7a;"><font face="caibri" size="1px">Total Amount Before Tax</font></td>
					...
					<% } %>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey; border-left: 1px solid grey;  padding-right: 5px;width:100px;"><font face="caibri" size="1px">CGST</font></td>
					...
					<% } %>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey;border-left: 1px solid grey; padding-right: 5px;width:100px;"><font face="caibri" size="1px">SGST</font></td>
...
<% if(discount.equals("yes") && !discount.equals("") && !discount.equals("0")) {%>
					...
					<% } %>
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right: 1px solid grey;border-left: 1px solid grey; padding-right: 5px;width:100px;"><font face="caibri" size="1px">Total Amount after Tax</font></td>
					...
					<% } %>
									...
									<td align="left" colspan="4"
										style="border-top: 1px solid grey;border-right:1px solid grey;1px solid grey;border-left: 1px solid grey; padding-right: 5px;width:100px;"><font face="caibri" size="1px">Freight</font></td>
