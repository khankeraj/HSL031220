...
<script>
	...
	var currentURL = "QuotationView?quotation_no="+quotation_no+"";
...
<script>
	function edit(quotation_no) {

	var currentURL = "QuotationEdit?quotation_no="+quotation_no+"";
...
<script>
	function print(quotation_no) {

	var currentURL = "QuotationPrint?quotation_no="+quotation_no+"";
 ...
 <script>
	...
	var currentURL = "QuotationCancel?quotation_no="+quotation_no+"";
...
<script>
	function process(quotation_no,total,pricing_id,inquiry_id,date) {

	var currentURL = "QuotationFinal?quotation_no="+quotation_no+"&total="+total+"&pricing_id="+pricing_id+"&inquiry_id="+inquiry_id+"&datee="+date+"";
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Quotation Report</h3>
						</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <s:iterator value="inquiryReport">
									<tr>
										<td><%=i++ %></td>
										<td><s:property value="quotation_no"/></td>
										...
										<td  align="center"><a style="text-decoration: none;color: green;" title="Final" onclick="process('<s:property value="quotation_no"/>','<s:property value="total"/>','<s:property value="pricing_id"/>','<s:property value="inquiry_id"/>','<s:property value="date"/>')" >
											<img alt="Final" height="35px;" src="configure/img/order.png"></a>
									   </td>
										
											
										<td  align="center"><a style="text-decoration: none;color: green;" title="View" onclick="view('<s:property value="quotation_no"/>')" >
											<img alt="View" height="35px;" src="configure/img/view.svg"></a>
									   </td>
									   
									   <td  align="center"><a style="text-decoration: none;color: green;" title="Edit" onclick="edit('<s:property value="quotation_no"/>')" >
											<img alt="Edit" height="35px;" src="configure/img/editmeeting.svg"></a>
									   </td>
									
										<td  align="center"><a style="text-decoration: none;color: green;" title="Print" onclick="print('<s:property value="quotation_no"/>')" >
											<img alt="Print" height="35px;" src="configure/img/print.jpg"></a>
									   </td>
									
									
										<td  align="center"><a style="text-decoration: none;color: green;" title="Cancel" onclick="cancel('<s:property value="quotation_no"/>')" >
