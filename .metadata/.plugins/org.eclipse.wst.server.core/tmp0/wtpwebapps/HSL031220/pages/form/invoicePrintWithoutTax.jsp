...
<td width="30%">
<font face="caibri" size="1px"><s:property value="buyer_contact_person" /></font>
</td>
</tr>
<tr>
<td width="20%">
...
<td width="30%">
<font face="caibri" size="1px"><s:property value="buyer_contact_no" /></font>
</td>
</tr>
<tr>
<td width="20%">
	  ...
	  --%>
								...
								<tr>
									...
									<td align="left" colspan="<%=mycolspan %>"
										...
										<font face="caibri" size="2px"># We reserve the right to charge intrest @ 24% if the bill is not paid in 15 days/committed time.<br>
