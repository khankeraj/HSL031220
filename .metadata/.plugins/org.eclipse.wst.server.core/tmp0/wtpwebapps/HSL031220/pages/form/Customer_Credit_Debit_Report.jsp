  ...
  <!-- AutoSearch -->
	...
	$(function() {
		...
		// $("#driver_name").autocomplete("GoogleSearch/autosearchDriver.jsp");
		 ...
		 $("#dealer_id").autocomplete("GoogleSearch/autosearchCustomer.jsp");
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Customer CREDIT DEBIT REPORT</h3>
						</div>
						<div class="panel-body">
						<form action="Customer_Credit_Advance_Report_Submitv">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="dealer_id"  id="dealer_id" value="" class="form-control" >
												</div>
											</div>
								...
								<div class="row">
									...
									<div class="row">
											<h3>
												<%-- Manager Name:<b> ${dealerid1}</b> --%>Customer Name:<b> <s:property value="dealer_id" /></b><br> From Date: <b>${fromdate}</b><br>
												To Date: <b>${todate}</b>
										    </h3>
										    <s:iterator value="tripDetails" status="userStatus">
										    <s:if test="#userStatus.index==tripDetails.size()-1">
										    <h3>
												Initial Balance/Balance C/F: <b><s:property value="initialbalance" /></b>
											</h3>
											</s:if>
											</s:iterator>
									</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<td>&nbsp;</td>
									...
									<td><b>Total:</b></td>
									<td colspan="4"><b>${initialbalance}</b></td>
								...
								<s:iterator value="tripDetails">
									<tr>
										...
										<td><s:property value="dealer_id" /></td>
										<td><s:property value="dc_date" /></td>
										...
										<td><s:property value="total_amt" />
										</td>
										<%-- <td><s:property value="initialbalance" />
										</td> --%>
								 ...
								 <tr>
									...
									<td>&nbsp;</td>
										<td><b>Total:</b></td>
									<td><b>${finalbalancecredit}</b></td>
									<td><b>${finalbalancedebit}</b></td>
