...
<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
									...
									<tbody>
										<tr>
											...
											<th id="VLsparename" ><label>Invoice No</label></th>
...
<tr class="item-row">
								...
								<td><input  type="checkbox" value="<s:property value="inv1[top]"/>" name="<s:property value="inv1[top]"/>" id="mycec" onclick="CalculateTotal12(this);"/></td>
												
							
									
									
									
									<td><input style="width:150px;"  type="text" name="dpb.d11"   class="form-control"
									id="dd" value="<s:property value="d11[top]"/>" /></td>
									
									<td><input style="width:150px;"  type="text" name="dpb.inv1"   class="form-control"
									value="<s:property value="inv1[top]"/>" id="material" /></td>
																	
									
																	
									<td><input style="width:150px;"  type="text" name="dpb.totamt1"   class="form-control"
									id="tot" value="<s:property value="totamt1[top]"/>" /></td>	
																	
									<td><input style="width:150px;"  type="text" name="dpb.reamt1"  class="form-control"
									id="reamt" value="<s:property value="reamt1[top]"/>"  onblur="CalculateTotal12();" /></td>													
<td><input style="width:150px;"  type="hidden" name="dpb.invcheck"  
									id="invcheck" value="" /></td>
