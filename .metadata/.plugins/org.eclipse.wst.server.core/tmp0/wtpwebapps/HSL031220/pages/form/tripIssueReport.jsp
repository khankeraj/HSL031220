				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Trip Issue Report</h3>
						</div>
						
						<div class="panel-body">
						<form action="trip_issue_Reports">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="given_by"  id="given_by" value="" class="form-control" >
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="driver_name"  id="driver_name" value="" class="form-control" >
												</div>
											</div>
								...
								<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="vehicle_no"  id="vehicle_no" value="" class="form-control" >
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="exp_parti"  id="exp_parti" value="" class="form-control" >
												</div>
											</div>
										   ...
										   <div class="col-sm-6">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="date" class="form-control" placeholder="" name="to_date" style="line-height: 15px;" id="to_date" value="" class="form-control" required>
												</div>
											</div>
								...
								<tbody>
								 ...
								 <c:forEach items="${tripDetails}" var="tripDetails">
									<tr>
										...
										<td><c:out value="${tripDetails.exp_parti}" /></td>
										...
										<td><c:out value="${tripDetails.given_by}" /></td>
										<%-- <td><c:out value="${tripDetails.customer_name}" /></td> --%>
										<td><c:out value="${tripDetails.source}" /></td>
										<td><c:out value="${tripDetails.destination}" /></td>
										
										<%-- <td>
											<a href="#?trip_id=<c:out value="${tripDetails.trip_id}" />&source=<c:out value="${tripDetails.source}" />&destination=<c:out value="${tripDetails.destination}" />&vehicle_no=<c:out value="${tripDetails.vehicle_no}" />&driver_name=<c:out value="${tripDetails.driver_name}" />&updown_id=<c:out value="${tripDetails.updown_id}" />&updown=<c:out value="${tripDetails.updown}" />&customer_name=<c:out value="${tripDetails.customer_name}" />"><button>print</button></a> 
										</td>
										
										<td>
											<a href="trip_issue_form?trip_id=<c:out value="${tripDetails.trip_id}" />&source=<c:out value="${tripDetails.source}" />&destination=<c:out value="${tripDetails.destination}" />&vehicle_no=<c:out value="${tripDetails.vehicle_no}" />&driver_name=<c:out value="${tripDetails.driver_name}" />&updown_id=<c:out value="${tripDetails.updown_id}" />&updown=<c:out value="${tripDetails.updown}" />&customer_name=<c:out value="${tripDetails.customer_name}" />&lr_number=<c:out value="${tripDetails.lr_number}" />"><button>trip issue</button></a> 
										</td>
										
										<td>
											<a href="#?trip_id=<c:out value="${tripDetails.trip_id}" />&source=<c:out value="${tripDetails.source}" />&destination=<c:out value="${tripDetails.destination}" />&vehicle_no=<c:out value="${tripDetails.vehicle_no}" />&driver_name=<c:out value="${tripDetails.driver_name}" />&updown_id=<c:out value="${tripDetails.updown_id}" />&updown=<c:out value="${tripDetails.updown}" />&customer_name=<c:out value="${tripDetails.customer_name}" />"><button>delivery done</button></a> 
										</td> --%>
										
										
										<%-- <td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdaterouteMaster?route_id=<c:out value="${routeMasterDetails.route_id}" />">
											<img alt="Update" src="configure/img/pencil.png"></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteRouteMaster?route_id=<c:out value="${routeMasterDetails.route_id}" />">
