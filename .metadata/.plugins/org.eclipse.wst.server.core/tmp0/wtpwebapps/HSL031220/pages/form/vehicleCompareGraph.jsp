	...
	function drawChart05() {
	 ...
	 <script type="text/javascript">
      ...
      function drawChart() {
		...
		var r = [];
		var main1 = [];
		var qqq1 = [ 'Vehicle No', 'Amount', 'Expense' ];
		var tot_a = "";
		var tot_b = "";
		var tot_c = "";
		main1.push(qqq1);
 ...
 */
		...
		document.getElementById("barchart_material").value = main1;
		//alert(main1+" mm");
        ...
        /* var data = google.visualization.arrayToDataTable([
          ['Vehicle No', 'Sales', 'Expenses'],
          [p[0], q[0], r[0]],
          [p[0], q[0], r[0]],
          [p[0], q[0], r[0]],
          [myArray[0], myArray1[0], myArray2[0], 0]
        ]); */
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Vehicle Comparison Graph</h1>
				</div>
				<!--End page title-->
				...
				<!--Page content-->
				<div id="page-content">
				<input type="hidden" value="${graph}" id="graph05">
						<%-- <div class="row">
						<div class="col-lg-12">
							<div class="panel">
								<div class="panel-heading">
									...
									<input type="hidden" value="${graph}" id="graph05">
									<input type="hidden" id="u_c_dX" style="width: 700px;">
									<input type="hidden" id="u_c_d1X" style="width: 700px;">
								</div>
					...
					<!-- <div class="row">
						<div class="col-lg-12">
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"></h3>
									<div id="chart_div02" class="chart"></div>
								</div>
