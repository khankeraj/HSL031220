				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Monthly Booking Report</h3>
						</div>
						
						<div class="panel-body">
					
					<form name="collection_summary" action="monthlybookingdetails" id="collection_summary">
									...
									<%int z=1; %>
										<c:forEach items="${report}" var="purchase_bean">
											<tr>
												...
												<td><c:out value="${purchase_bean.totallr}" /></td>
												<td><c:out value="${purchase_bean.vehicletype}" /></td>
												<td><c:out value="${purchase_bean.vehiclebrkup}" /></td>
												<td><c:out value="${purchase_bean.buyrate}" /></td>
												<td><c:out value="${purchase_bean.sellrate}" /></td>
												<td><c:out value="${purchase_bean.profit}" /></td>
												<td><c:out value="${purchase_bean.tot}" /></td>
