			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="panel-heading">
							<h3 class="panel-title">Supplier Credit Debit Note Report</h3>
						</div>
						
					
						<div class="panel-body">
							 <div class="panel-body">
							 <s:form name="Credit_Advance_Report_Submitv"
			action="SupplierCreditDebitNote" id="patient_search">

			<div style="width: 240px; text-align: center; margin: -3px 0 0 0;">
				<table cellpadding="2" cellspacing="3" class="display">
					   <div class="row"> 
	                           
	                             <div class="col-sm-3">
	                                <div class="form-group floating-label">
	                                    <input type="text" class="form-control floating-input"  name="from_date" id="from_date" onblur="FixShortDate(this);return ValidateForm(this);"  placeholder=" "  >
	                            ...
	                            <div class="col-sm-3">
	                                <div class="form-group floating-label">
	                                    <input type="text" class="form-control floating-input"  name="to_date"
							id="to_date1" onblur="FixShortDate(this);return ValidateForm(this);"  placeholder=" "  >
	                              		 <label>To Date</label>
	                                </div>
	                         ...
	                         <div class="col-sm-3">
	                                <div class="form-group floating-label">
	                                    <input type="text" class="form-control floating-input" id="customer_code" name="bankname"  placeholder=" "  >
	                               <label>Supplier Name</label>
	                                </div>
	                            </div> 
	                          <div class="col-sm-3">
	                          <button type="submit" class="btn btn-primary btn-round" width="20em" height="20em">Search</button>
							</div>
							</div>
							...
							<table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<s:iterator value="tripDetails">
									<tr>
										<td><%=sr_No1 %></td>
										<td><s:property value="cust_name" />
										</td>
										<td><s:property value="cust_id" />
										</td>
										
										<td><s:property value="documentsno" />
										</td>

										
										<td><s:property value="sale_date" />
										</td>
										...
										<td><s:property value="amount1" />
										</td>
										<td><s:property value="refno" />
										</td>
									<%sr_No1++; %>
									</tr>
                                   ...
                                   <%--  <tr>
									...
									<td><b>Total</b></td>
									<td colspan="4"><b>${finalbalance}</b></td>
