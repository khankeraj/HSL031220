						...
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
							 ...
							 <%int i=1; %>
								...
								<s:iterator value="LeadForm" status="LeadForm">
								<tr>
								<td><%=i++ %></td>
								...
								<td>
									...
									<div class="tab">
										<s:property value="indexName[top]"/>
									</div>
									</s:iterator>
								...
								<% int j=1; %>
								  <s:iterator value="(mysize).{# this}" status="stat">
								    <s:if test='mystatus[top]=="YES"'>
								    <div class="step" style="background-color: green;"><%=j%></div>
								    <div class="connector" style="background-color: green;"></div>
									</s:if>
									
									<s:else>
									 <div class="step"><%=j%></div>
								     <div class="connector" id="remove"></div>
								    </s:else> 
								  <%  j++; %>
								  </s:iterator>
								</div> 
								...
								<div class="tab" style="margin-left: -5px;">
									<s:property value="dates[top]" />
								</div>&nbsp;&nbsp;
								</s:iterator>
								</div>
								<%-- <script type="text/javascript">
								 	$(".connector").last().remove();
