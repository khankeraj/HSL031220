				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="AlertUpdate1" method="POST">
									 ...
									 <div class="row">
										...
										<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="<s:property value="date"/>"  id="date" name="date" onblur="FixShortDate(this);return ValidateForm(this);" required>
									...
									<div class="col-sm-6">
									  ...
									  <div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="<s:property value="contactp"/>" id="contactp" name="contactp"   required>
												</div>
									  </div>
									  ...
									  <div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="<s:property value="contact_no"/>" id="contact_no" name="contact_no"   maxlength="10" onblur="checkMobileLength();" required>
												</div>
									  </div>
									  </div>
									  ...
									  <div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="<s:property value="exp_date"/>" name="exp_date" id="exp_date" onblur="FixShortDate(this);return ValidateForm(this);" required>
												</div>
											</div>
									...
									<div class="row">
									  ...
									  <div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="<s:property value="remark"/>" name="remark" id="remark"  required>
												</div>
											</div>
