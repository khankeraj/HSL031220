				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Issue Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${issueReport}" var="issueReport">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${issueReport.customer_no}" /></td>
										<td><c:out value="${issueReport.customer_name}" /></td>
										<td><c:out value="${issueReport.lead_id}" /></td>
										<td><c:out value="${issueReport.mobile_no}" /></td>
										<td><c:out value="${issueReport.pono}" /></td>
									   ...
									   <td align="center"><a style="text-decoration: none;color: green;" title="Issue form" href="IssueForm?customer_no=<c:out value="${issueReport.customer_no}"/>&customer_name=<c:out value="${issueReport.customer_name}"/>&lead_id=<c:out value="${issueReport.lead_id}" />&mobile_no=<c:out value="${issueReport.mobile_no}"/>&pono=<c:out value="${issueReport.pono}"/>">
