...
<head>
  ...
  <script>
	...
	var currentURL = "PI_BillView?invoice="+invoiceno+"&type="+type+"";
...
<script>
	...
	var currentURL = "pi_BillEdit?invoice="+invoiceno+"&type="+type+"";
...
<script>
	...
	var currentURL = "pi_Billprintnew?invoice="+invoiceno+"&type="+type+"";
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title"> PI Invoice  Report</h3>
						</div>
