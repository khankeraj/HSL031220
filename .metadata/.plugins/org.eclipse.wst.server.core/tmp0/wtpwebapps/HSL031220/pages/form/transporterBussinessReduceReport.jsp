				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Transporter Business Reduce Alert Report</h3>
						</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <c:forEach items="${deliveryDetails}" var="deliveryDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${deliveryDetails.transporter_code}" /></td>
										<td><c:out value="${deliveryDetails.transporter_name}" /></td>
										<td><c:out value="${deliveryDetails.this_month}" /></td>
										<td><c:out value="${deliveryDetails.previous_month}" /></td>
