...
<script>
	function process(inquiry_id,type,source,destination,date) {

	var currentURL = "EnquiryDone?inquiry_id="+inquiry_id+"&type="+type+"&source="+source+"&dest="+destination+"&datee="+date+"";
...
<script>
	function cancel(inquiry_id) {

	var currentURL = "EnquiryCancel?inquiry_id="+inquiry_id+"";
...
<script>
	function priceCheck(source,destination) {

	var currentURL = "PriceCheck?source="+source+"&dest="+destination+"";
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Enquiry Report</h3>
						</div>
								...
								<tbody>
								 ...
								 <s:iterator value="inquiryReport">
									<tr>
										...
										<td  align="center"><a style="text-decoration: none;color: green;" title="Price Check" onclick="priceCheck('<s:property value="source"/>','<s:property value="destination"/>')" >
											<img alt="Price Check" height="25px;" src="configure/img/process.png"></a>
									   </td>
										
											
										<td  align="center"><a style="text-decoration: none;color: green;" title="Pricing" onclick="process('<s:property value="inquiry_id"/>','<s:property value="type"/>','<s:property value="source"/>','<s:property value="destination"/>','<s:property value="date"/>')" >
											<img alt="Pricing" height="25px;" src="configure/img/icons8-rupee-50.png"></a>
									   </td>
									
									<td  align="center"><a style="text-decoration: none;color: green;" title="Cancel" onclick="cancel('<s:property value="inquiry_id"/>')" >
