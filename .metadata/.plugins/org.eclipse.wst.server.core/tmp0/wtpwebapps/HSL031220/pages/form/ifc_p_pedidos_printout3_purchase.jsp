...
<tr><td align="left" colspan="<%=mycolspan %>" style="border-right:1px solid #000000" ><table width="100%"><tr><td><img src="images/GST SOFTWARE-Logo(1).png" width="150px" ></td><td align="center">
...
<font size="4px;"> <b>PURCHASE ORDER</b></font>
</td></tr>
...
<tr>
<td width="20%">
<font face="caibri" size="2px">PO NO:</font>
</td>
...
<td width="30%">
<font face="caibri" size="2px"><%=gstn %> <%-- <s:property value="KM" /> --%></font>
</td>
</tr>

<tr>
<td width="20%">
<font face="caibri" size="2px">PO DATE:</font>
</td>
<td width="30%">
...
<div >Duplicate</div><table id="pagelayout"   style="border: 1px solid #787f7a;width:99%;border-collapse:collapse;page-break-after: always"" >
