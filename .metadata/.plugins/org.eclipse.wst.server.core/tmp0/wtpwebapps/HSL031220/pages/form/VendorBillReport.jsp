							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <c:forEach items="${deliveryDetails}" var="deliveryDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${deliveryDetails.bill_no}" /></td>
										<td><c:out value="${deliveryDetails.delivery_done_id}" /></td>
										...
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="VendorPaymentform?bill_no=<c:out value="${deliveryDetails.bill_no}" />&delivery_done_id=<c:out value="${deliveryDetails.delivery_done_id}" />&transporter_name=<c:out value="${deliveryDetails.transporter_name}" />&transporter_code=<c:out value="${deliveryDetails.transporter_code}" />&date=<c:out value="${deliveryDetails.date}" />&total_amount=<c:out value="${deliveryDetails.total_amount}" />">
