...
<td width="20%" style="border-left:1px solid #787f7a;">
<font face="caibri" size="1px">PAYAYMENT TERM:</font>
</td>
<td width="30%">
${termcond }
</td>
...
<td width="30%" style="border-right:1px solid #787f7a;">
<font face="caibri" size="1px"><s:property value="Job_Card_no" /></font>
</td>
 <td width="20%" style="border-left:1px solid #787f7a;">
...
<td width="30%" style="border-right:1px solid #787f7a;">
<font face="caibri" size="1px"><s:property value="Model" /></font>
</td>
 <td width="20%" style="border-left:1px solid #787f7a;">
...
<font face="caibri" size="1px">${vehino }</font>
	...
	<tr >
					...
					<td align="center" valign="middle" style="border:1px solid #787f7a;width:35%;" ><font face="caibri" size="1px">Particulars</font></td>
					...
					<td align="center" valign="middle" style="border:1px solid #787f7a;" ><font face="caibri" size="1px">Chargeable Wt</font></td>
