...
<tr><td align="left" colspan="<%=mycolspan %>" style="border-right:1px solid #000000" ><table width="100%"><tr><td><img src="configure/img/ullogo.png" width="150px" ></td><td align="center">
