	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">PROFORMA INVOICE</h1>
				</div>
				<!--End page title-->
						...
						<div class="col-lg-12">
							<div class="panel">
								<div class="panel-heading">
									...
									<form action="Add_invoice" id="formID2" name="formID2"
										method="POST">
								<div class="panel-body">
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Invoice No  :
                                                    </label>
                                                    <input type="text" class="form-control"  value="<%=request.getAttribute("invoice_no") %>" name="name" onkeyup="this.value=this.value.toUpperCase()" class="form-control" required> </div>
                                            </div>
                                         </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pono"
																	id="pono"  size="30"  class="form-control"
																	value="" tabindex="6" 
																	maxlength="96" />
                                            </div>
                                            </div>
