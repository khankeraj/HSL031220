											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">From Date:</label>
														...
														<input type="date" style="line-height: 15px;" class="form-control" placeholder="" name="from_date"  id="from_date" value=""  class="form-control" required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">To Date:</label>
														...
														<input type="date" style="line-height: 15px;" class="form-control" placeholder="" name="to_date"  id="to_date" value=""  class="form-control" required>
												</div>
											</div>
								...
								<tbody>
								 ...
								 <c:forEach items="${deliveryDetails}" var="deliveryDetails">
									<tr>
										...
										<td><c:out value="${deliveryDetails.invoiceno}" /></td>
										<td><c:out value="${deliveryDetails.customer_name}" /></td>
										<td><c:out value="${deliveryDetails.gstin_no}" /></td>
										<td><c:out value="${deliveryDetails.total_amount}" /></td>
										<td><c:out value="${deliveryDetails.cgst25}" /></td>
										<td><c:out value="${deliveryDetails.cgst6}" /></td>
										<td><c:out value="${deliveryDetails.cgst9}" /></td>
										<td><c:out value="${deliveryDetails.cgst14}" /></td>
										<td><c:out value="${deliveryDetails.sgst25}" /></td>
										<td><c:out value="${deliveryDetails.sgst6}" /></td>
										<td><c:out value="${deliveryDetails.sgst9}" /></td>
										<td><c:out value="${deliveryDetails.sgst14}" /></td>
