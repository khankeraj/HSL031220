...
<script src="Css/jquery-1.10.2.js" type="text/javascript"></script>
 <!-- AutoSearch -->
  ...
  <!-- AutoSearch -->
	...
	var main1=[];
	var qqq1=['Resource Enquiry Business Graph','Amount','Amount'];
	var tot_a="";
	var tot_b="";
	var tot_c="";
	...
	main1.push(qqq1);
      ...
      function drawStuff() {
		...
		//alert(main);    	 		 	 	
 		...
 		var ucd13= [ ['Year', 'Total','Total'], ["abc", 1000,1000], ["b", 1000,1000],['c', 1170,1000],['d', 660,1000],['e', 1030,1000],['f', 1030,1000],['g', 1030,1000] ] ;
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Resource Enquiry Business Graph </h1>
				</div>
				<!--End page title-->
