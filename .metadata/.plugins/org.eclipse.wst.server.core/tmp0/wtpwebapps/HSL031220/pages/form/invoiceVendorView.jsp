									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	<div class="form-group">
                                                    ...
                                                    <input type="text" size="30"  value="${invoice}" class="form-control"  name="invoiceno" readonly/> 
                                   ...
                                   <div class="row">
                                      ...
                                      <div class="row">
                                               ...
                                               <div class="col-md-4">
                                                ...
                                                <input type="text" name="Date" class="form-control" id="to_date"   readonly/>
                                                </div>
                                       		 </div>
									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	...
                                            	<div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" value="<s:property value="pono"/>" name="pono" id="pono"   readonly/>
                                                </div>
                                       		 </div>
                                               ...
                                               <input type="text" class="form-control" name="podate" id="podate"  readonly value="<s:property value="podate"/>" />
                                                </div>
                                       		 </div>
									...
									<table id="textfocus" width="900px;" cellspacing="1" cellpadding="1">
														...
														<td align="left"><b>Po No:</b><br><input type="text" name="pono"
															...
															<td align="left"><b>Pay Term:</b><br><input type="text" name="termcond"
																	id="termcond"  size="30"  value="<s:property value="termcond"/>" tabindex="6" 
                       ...
                       <div id="product" class="tab-pane table-responsive active">
																...
																<tr class="item-row">
																	...
																	<td>	<input type="text" name="ib.partdate"
																		...
																		<td><input type="text" name="ib.quantity1" value="<s:property value="quantity[top]"/>"
																			style="width: 60px;" id="quantity1" readonly
																			...
																			tabindex="11"   readonly/></td>
																		
																		<td><input type="text" name="ib.amount1" value="<s:property value="myamt[top]"/>" readonly
                                       ...
                                       <div class="row">
                                               ...
                                               <div class="col-md-3">
                                                ...
                                                <input name="ib.freight" class="form-control" value="<s:property value="freight"/>" readonly id="freight"   onblur="totalnetamt();" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
                                                </div>
                                       		 </div>
