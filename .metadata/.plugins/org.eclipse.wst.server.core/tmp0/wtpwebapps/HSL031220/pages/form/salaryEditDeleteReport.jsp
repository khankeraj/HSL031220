...
<head>
  ...
  <!-- AutoSearch -->
	...
	<script>
		function deleteFun(sal_id){
			//alert(employee_id);
			//alert('here');
			var link = "DeleteSalary?sal_id="+sal_id;
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Salary Edit/Delete Report</h3>
						</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <c:forEach items="${drivermodeldetails}" var="drivermodeldetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${drivermodeldetails.driver_id}" /></td>
										<td><c:out value="${drivermodeldetails.driver_name}" /></td>
										<td><c:out value="${drivermodeldetails.date}" /></td>
										<td><c:out value="${drivermodeldetails.month}" /></td>
										<td><c:out value="${drivermodeldetails.year}" /></td>
										<td><c:out value="${drivermodeldetails.days_present}" /></td>
										<td><c:out value="${drivermodeldetails.bonus}" /></td>
										<td><c:out value="${drivermodeldetails.overtime}" /></td>
										
										
										<td align="center"><a  title="Update" style="text-decoration: none;color: green;" href="Updatesalary?sal_id=<c:out value="${drivermodeldetails.sal_id}" />">
											<img alt="Edit"  src="configure/img/pencil.png"></a>
								   		</td>
										
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun('<c:out value="${drivermodeldetails.sal_id}" />');"></a>
								   		</td>
