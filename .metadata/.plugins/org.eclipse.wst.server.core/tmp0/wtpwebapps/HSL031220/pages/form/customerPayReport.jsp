				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Customer Payment Report</h3>
						</div>
						
						<div class="panel-body">
						<form action="customer_payment_report1">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">Customer Name:</label>
														...
														<input type="text" class="form-control" placeholder="" name="customer_name"  id="customer_name" value=""  class="form-control" required>
												</div>
											</div>
