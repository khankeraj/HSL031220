				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">LR Profitability Report</h3>
						</div>
						<div class="panel-body">
						<form action="Customer_Credit_Advance_Report_Submitv123" method="POST">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="vehicle_Type"  id="vehicle_type" value="" class="form-control" >
												</div>
											</div>
										   ...
										   <div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">From Date:</label>
														...
														<input type="text" class="form-control" placeholder="" name="from_date"  onblur="FixShortDate(this);return ValidateForm(this);"  id="from_date" value=""  class="form-control" required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" onblur="FixShortDate(this);return ValidateForm(this);" name="to_date" id="to_date" value="" class="form-control" required>
												</div>
											</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<s:iterator value="tripDetails">
									<tr>
										...
										<td><s:property value="lr_number" /></td>
										
										<td><s:property value="dealer_id" /></td>
										
										<td><s:property value="pump_receipt" /></td>
