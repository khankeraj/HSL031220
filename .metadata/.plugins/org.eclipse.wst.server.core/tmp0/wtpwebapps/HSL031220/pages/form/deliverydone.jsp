 ...
 <!-- AutoSearch -->
  ...
  <!-- AutoSearch -->
	...
	$(function() {
	 ...
	 function getShortWeight(v)
	 {
		 var $traverse_row = $(v).parents('.item-row');
		 $hoardinglocationx1 = $($traverse_row).find('#received_weight');
		 $hoardinglocationx = $($traverse_row).find('#weight');
		 $hoardinglocationx2 = $($traverse_row).find('#rate');
		 
		 $('.item-row').each(function(i,row){
			 
			 var weight =  $($hoardinglocationx).val();
			 var received_weight = $($hoardinglocationx1).val();
			 var rate = $($hoardinglocationx2).val();
			 
			 if(weight!="" && received_weight!="" ){
					short_weight = weight-received_weight;
					$hoardinglocation = $($traverse_row).find('#short_weight');
					//alert(amt);
					$($hoardinglocation).val(short_weight);
					
				}
			 
			 if(received_weight!="" && rate!="" ){
					amt= rate * received_weight;
					$hoardinglocation = $($traverse_row).find('#amount');
					//alert(amt);
					$($hoardinglocation).val(amt);
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Delivery Done Form</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">Delivery Done Form</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="insert_delivery_done_action" method="POST">
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"   placeholder="" name="date" id="date" class="form-control" required>
												</div>
											</div>
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  style="line-height: 15px;" placeholder="" name="lr_number" id="lr_number"  value="${lr_number}" class="form-control" required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="source" id="source" value="${source}" onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>
								      ...
								      <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="destination" id="destination" value="${destination}"  onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="customer_name" id="customer_name"  value="${customer_name}" onkeyup="this.value=this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>
									  </div>
									  ...
									  <div id="product" style="width:100%">
																...
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="70%">
																	...
																	<tr>
																	 ...
																	 <th id="VLsparename"><label>Received Weight</label> </th>
																		
																		<th id="VLsparename"><label>Short Weight</label> </th> 
																	...
																	<td><input type="text" name="description" class="form-control"
																		...
																		<td><input type="text" name="received_weight" class="form-control"
																			style="width: 100px;" id="received_weight" value="${deliveryDetails.weight1}" 
																			tabindex="11"   /></td>	
																			
																		
																		<td><input type="text" name="short_weight" class="form-control"
																			style="width: 100px;" id="short_weight" /></td>	
																		
																		
																		<td><input type="text" name="rate" class="form-control"
																			id="rate" value="${deliveryDetails.rate1}"
																			tabindex="12"
																			style="width: 100px;"  onblur="getRNA(this);"/>
																		</td>
																		
																		<td><input type="text" name="amount" class="form-control"
																			id="amount" value="${deliveryDetails.amount1}" onblur="getTotal(this);"
																			tabindex="12"
																			style="width: 100px;"  />
																		</td>
									  								</tr>
																	...
																	<tr>
																		<td>Loading</td>
																		<td><input type="text" name="loading" class="form-control"
																			id="loading" value=""
																			tabindex="12"
																			style="width: 120px;" /></td>
																			
																			<td>Unloading</td>
																		<td><input type="text" name="unloading" class="form-control"
																			id="unloading" value=""
																		...
																		<td><input type="text" name="other" class="form-control"
																			...
																			<td>Mathadi</td>
																		<td><input type="text" name="mathadi" class="form-control"
																			id="mathadi" value=""
																			tabindex="12"
																			style="width: 120px;" /></td>
																	</tr>
														...
														function addRows(e) {
															try {
																...
																var $rowTemp = [
																		...
																		'<td><input type="text" name="received_weight" class="form-control" style="width: 100px;" id="received_weight" value="" tabindex="11"   /></td>',
																				
																			
																		
																		'<td><input type="text" name="short_weight" class="form-control" style="width: 100px;" id="short_weight" value="" tabindex="11"   /></td>',
