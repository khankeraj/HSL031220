				...
				<div id="page-content">
					...
					<br>
						...
						<div class="panel-heading">
							<h3 class="panel-title">Driver Payment Report</h3>
						</div>
						<div class="panel-body" style="overflow-x:auto;">
							<form action="driver_payment_report1">
								...
								<tbody>
								 ...
								 <c:forEach items="${drivermodeldetails}" var="drivermodeldetails">
									<tr>
										...
										<td><input type="text" style="width: 70px;" name="paid_amt1" value="${drivermodeldetails.paid_amt}"/></td>
										<td></td>
