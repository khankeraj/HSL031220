...
<script src="Css/jquery-1.10.2.js" type="text/javascript"></script>
 <!-- AutoSearch -->
  ...
  <script src="jQuery_4_design/AutoSearch/AutoSearchJquerySale1.js" type="text/javascript"></script>
  <script src="js/jquery.validationEngine.js" type="text/javascript" charset="utf-8"></script>
  <!-- AutoSearch -->
	
	<script>
	$(function() {
		$("#lr_number").autocomplete("GoogleSearch/autosearchlrinv.jsp");
			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="insert_tripissue_action11" method="POST" id="form1">
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="trip_id" id="trip_id" value="${inv}"  onkeyup="this.value=this.value.toUpperCase()"   required>
												</div>
											</div>
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="lr_number" id="lr_number" value=""  onkeyup="this.value=this.value.toUpperCase()"   required>
												</div>
											</div>
