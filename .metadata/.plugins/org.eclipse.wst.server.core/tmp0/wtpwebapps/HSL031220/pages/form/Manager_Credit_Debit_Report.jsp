  ...
  <!-- AutoSearch -->
	...
	$(function() {
		...
		// $("#driver_name").autocomplete("GoogleSearch/autosearchDriver.jsp");
		 ...
		 $("#dealer_id").autocomplete("GoogleSearch/employee.jsp");
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Manager CREDIT DEBIT REPORT</h3>
						</div>
						<div class="panel-body">
						<form action="Manager_Credit_Advance_Report_Submitv">
							<div class="row">
								...
								<div class="row">
									...
									<div class="row">
											<h3>
												<%-- Manager Name:<b> ${dealerid1}</b> --%>Manager Name:<b> <s:property value="dealer_id" /></b><br> From Date: <b>${fromdate}</b><br>
												To Date: <b>${todate}</b>
										    </h3>
