									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	<div class="form-group">
                                                    ...
                                                    <input type="text" size="30" readonly value="${response}" class="form-control"  name="invoiceno"/> 
                                       		 ...
                                       		 <div class="col-md-4">
                                            	<div class="form-group">
                                                    <label for="wlastName2"><b>Despatch ID</b>
                                                    </label>
                                                    <input type="text" class="form-control"  value="${despatch_id}"  name="despatch_id" id="despatch_id" readonly/> 
                                                </div>
                                       		 </div>
