...
function getrowdetails(v){
 ...
 {
	 var name=document.getElementById("company_name1").value;
	 alert(name);
	 if(name.indexOf('-')>-1)
		 {
		 alert("if");
		 ...
		 alert(s[0]);
		 var s2=s[1];
		 document.getElementById("company_name1").value=s[0];
  ...
  //  alert("a");
   /*  $('input[type="radio"]').change(function(){
        ...
        if (this.checked){
            ...
            $('.showCta').toggle(this.value === 'Withoutdetail');
        }
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Purchase Form </h1>
				</div>
				<!--End page title-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-6"></div>
								...
								<form class="form-horizontal" action="insert_LRform" Method="post" onsubmit="return validateform();">
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Purchase CGST Form</h1>
				</div>
				<!--End page title-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<div class="col-lg-6"></div>
								...
								<form action="insert_LRform" id="frmFileUpload"
								...
								With Detail  <input type="radio" onclick="javascript:yesnoCheck();" name="prb.yesno" value="withdetail" id="yesCheck" checked > without detail <input type="radio" onclick="javascript:yesnoCheck();" name="prb.yesno" value="withoutdetail" id="noCheck" ><br>
						 		...
						 		<br><br>
								<!-- <div class="row ">
								<div id="gallery-box" style="border: 1px solid red;">The Gallery</div></div> -->
                            ...
                            <div class="col-sm-6">
                              ...
                              <div class="col-sm-6">
                                <div class="form-group floating-label">
                                   <input type="text" class="form-control floating-input" placeholder=" " name="prb.company_name" id="company_name1" value="${supplier_name}" onblur="splitname(this);"  required>
                                   <span class="highlight"></span>
			...
			<s:iterator value="po_details_products1">
				...
				<td><a id="deleteRow"><img src="Images_4_design/AddRowDataTable/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
											<!-- <td>1</td>
 -->
											<td><input style="width:190px" class="form-control" name="prb.unit_no"  maxlength="20" size="30" id="model" value="<s:property value="disc1"/>"  required onblur="checkstockqty(this);duplicate(this);getrowdetails(this);"></td>
											<td><input style="width:80px"  class="form-control" name="prb.price" id="price" onblur="sparenetamt11(this);" value="<s:property value="price1"/>"  required maxlength="6"></td>		
											<td><input  style="width:80px" class="form-control" name="prb.qty" id="qty" onblur="sparenetamt11(this);" value="<s:property value="qty2"/>"  required maxlength="6"></td>
											<td><input  style="width:80px" class="form-control" name="prb.amount" onblur="netamt();twodecimal(this);gotoadd()" value="<s:property value="amount1"/>"  readonly
												id="amount" required maxlength="6"></td>
												<% if(discount.equals("yes")) {%>
													<td><input type="text" name="prb.disc"
																			id="disc" class="form-control" value="" 
																			onblur="getnewsrno1xxx(this);twodecimal(this);gotoadd1();" 
																			style="width: 80px;" />
																		</td>
																		<td><input type="text" class="form-control" name="prb.amtwithdisc" readonly
												...
												<%  }else{%>
													<input type="hidden" name="prb.disc"
																			...
																			id="amtwithdisc" class="form-control" onblur="twodecimal(this)" value="" 
												...
												<% } %>
											<td><input style="width:80px"  class="form-control" required name="prb.hsn" value="<s:property value="tax"/>"  maxlength="20" size="30" id="hsn" readonly></td>
											<td><input style="width:60px" class="form-control" required  name="prb.tax_percent" id="tax" value="<s:property value="tax_percent1"/>"  maxlength="6" readonly></td>		
											<td><input  style="width:60px" class="form-control" required name="prb.gstrate1" id="gstrate1"  value="<s:property value="gstrate11"/>" readonly onblur="netamt();"  maxlength="6"></td>	
												
											<td><input  style="width:80px" class="form-control" required name="prb.gstamount1" maxlength="20" value="<s:property value="gstamount11"/>"  readonly size="30" id="gstamount1" ></td>
											<td><input style="width:60px" class="form-control" required  name="prb.gstrate2" id="gstrate2" value="<s:property value="gstrate11"/>"  readonly maxlength="6"></td>		
											<td><input style="width:80px" class="form-control" required  name="prb.gstamount2" id="gstamount2" value="<s:property value="gstamount11"/>"  readonly maxlength="6"></td>	
										...
										<td><input  style="width:80px" required class="form-control" name="prb.net" id="net" value="<s:property value="net1"/>" readonly maxlength="6"></td>
											
											
											<td><input type="hidden" class="form-control" name="prb.currentqty"
...
function addRows(e){
               try{
               	...
               	k++;
                         ...
                         '<td><a id="deleteRow"><img src="Images_4_design/AddRowDataTable/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>',
                        /*  '<td>'+k+'</td>', */
                       '<td><input  style="width:190px" type="text" name="prb.unit_no" class="form-control"  size="30"  id="model"  maxlegth="251"  Class="validate[required]" onblur="checkstockqty(this);duplicate(this);getrowdetails(this);"/></td>',
                       '<td><input  style="width:80px" type="text" name="prb.price" id="price" class="form-control"  maxlegth="6" onblur="twodecimal(this);sparenetamt11(this);"  Class="validate[required]" /></td>',
                        ...
                        '<td><input  style="width:80px"  type="text"  class="form-control" name="prb.amount" Class="validate[required]" id="amount" onblur="netamt();twodecimal(this);gotoadd();" readonly maxlegth="6"/></td>',
                        myflag,
                        myflag2,
                        myflag1,
						...
						'<td><input   style="width:80px" class="form-control" name="prb.gstamount1" maxlength="20" readonly size="30" id="gstamount1" ></td>',
						'<td><input   style="width:60px" class="form-control" name="prb.gstrate2" id="gstrate2" readonly  maxlength="6"></td>',		
						'<td><input   style="width:80px" class="form-control" name="prb.gstamount2" id="gstamount2" readonly  maxlength="6"></td>',	
