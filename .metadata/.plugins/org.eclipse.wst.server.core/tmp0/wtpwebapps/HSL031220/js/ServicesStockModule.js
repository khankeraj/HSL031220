$(document).ready(function(){
          ...
          function addRows(e){
                    try{
                              ...
                              '<td style="width: 70px;"><input type="text" name="modelno"  value=""  class="tInput"  id="modelno"   style="width:150px;"/> </td>',
                              '<td style="width: 70px;"><input type="text" name="unitid" class="tInput" value="" id="unitid" style="width: 150px;"  /></td>',
