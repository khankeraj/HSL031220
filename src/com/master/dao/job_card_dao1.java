...
public class job_card_dao1 {
	...
	public Job_card_bean insertjob_card(Job_card_bean jb, LoginBean bean, String multipleValues) {
		...
		try {
			...
			String	pref="JC";
			PreparedStatement preparedStatement11=connection.prepareStatement("select  max(SUBSTRING(job_card_no,-5)) as myval1 from job_card  where LENGTH(job_card_no)>5 " );
		...
		String	stringValue1="1";
			...
			if (resultSet.next()) {
				...
				*/
				...
				PreparedStatement preparedStatementy = connection
