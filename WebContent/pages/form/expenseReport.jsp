					...
					<div class="panel">
						...
						<form action="expense_Reports">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Given To:</label>
													<input type="text" class="form-control" placeholder="" name="given_to"  id="given_to" value="" class="form-control" >
												</div>
											</div>
