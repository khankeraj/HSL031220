...
<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Customer Credit Debit Note Report</h3>
						</div>
						
					
						<div class="panel-body">
							 <div class="panel-body">
							 <s:form name="CustomerCreditDebitNote"
			action="CustomerCreditDebitNote" id="patient_search">
				...
				<table cellpadding="2" cellspacing="3" class="display">
					   <div class="row"> 
							...
							id="to_date1" onblur="FixShortDate(this);return ValidateForm(this);"  placeholder=" "  >
	                         ...
	                         <div class="col-sm-3">
	                                <div class="form-group floating-label">
	                                    <input type="text" class="form-control floating-input" id="dealer_code" name="bankname"  placeholder=" "  >
							...
							<% int sr_No1=1; %>
								<s:iterator value="tripDetails">
									...
									<td><%=sr_No1 %></td>	
										...
										<td><s:property value="amount1" /></td>
