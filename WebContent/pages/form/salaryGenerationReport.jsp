				...
				<div id="page-content">
					...
					<br>
						...
						<div class="panel-heading">
							<h3 class="panel-title">Salary Generation Report</h3>
						</div>
						...
						<form action="submit_salary_report1">
								...
								<tbody>
								 ...
								 <c:forEach items="${drivermodeldetails}" var="drivermodeldetails">
									<tr>
										...
										<td><c:out value="${drivermodeldetails.days_present}" /><input type="hidden" name="days_present1" value="${drivermodeldetails.days_present}"/></td>
										<td><c:out value="${drivermodeldetails.basic_salary}" /><input type="hidden" name="basic_salary1" value="${drivermodeldetails.basic_salary}"/></td>
										<td><c:out value="${drivermodeldetails.bonus}" /><input type="hidden" name="bonus1" value="${drivermodeldetails.bonus}"/></td>
										<%-- <td><c:out value="${driverMasterDetails.date_of_birth}" /></td> --%>
										<td><c:out value="${drivermodeldetails.gross}" /><input type="hidden" name="gross1" value="${drivermodeldetails.gross}"/></td>
										<%-- <td><c:out value="${driverMasterDetails.salary_type}" /></td> --%>
										<td><c:out value="${drivermodeldetails.tax}" /><input type="hidden" name="tax1" value="${drivermodeldetails.tax}"/></td>
										<td><c:out value="${drivermodeldetails.advance}" /><input type="hidden" name="advance1" value="${drivermodeldetails.advance}"/></td>
										<td><c:out value="${drivermodeldetails.other}" /><input type="hidden" name="other1" value="${drivermodeldetails.other}"/></td>
										<td><c:out value="${drivermodeldetails.fine}" /><input type="hidden" name="fine1" value="${drivermodeldetails.fine}"/></td>
										<td><c:out value="${drivermodeldetails.overtime}" /><input type="hidden" name="overtime1" value="${drivermodeldetails.overtime}"/></td>
										<td><c:out value="${drivermodeldetails.tot_ded}" /><input type="hidden" name="tot_ded1" value="${drivermodeldetails.tot_ded}"/></td>
										<td><c:out value="${drivermodeldetails.tot_net}" /><input type="hidden" name="tot_net1" value="${drivermodeldetails.tot_net}"/></td>
										<td></td>
