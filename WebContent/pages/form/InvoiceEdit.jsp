...
<input type="text" value='<s:property value="#session.USER_PROFILE.username"/>' id="mys" />
									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	...
                                            	<div class="form-group">
                                                  ...
                                                  <input type="text" value="<s:property value="pono"/>" class="form-control" name="pono" id="pono"   />
                                                </div>
                                       		 </div>
                                               ...
                                               <input type="text" class="form-control" value="<s:property value="podate"/>" name="podate" id="podate"  onblur="FixShortDate(this);return ValidateForm(this);"  />
                                                </div>
                                       		 </div>
														...
														<td align="left"><b>Po No:</b><br><input type="text" name="pono"
															...
															<tr  id="333"><td align="left"><b>Contact Person:</b><br><input type="text" name="contactp"
																...
																<td align="left"><b>Contact No:</b><br><input type="text" name="contactpno"
																	id="contactno"  size="30" onblur="ValidateMoNo();"
																	value="<s:property value="transport1"/>" tabindex="6" 
																	maxlength="10" /></td>
                       ...
                       <div id="product" class="tab-pane table-responsive active">
																...
																<tr class="item-row">
																	...
																	<td>	<input type="text" name="ib.partdate"
																		...
																		<input type="hidden" name="ib.aa"
																			style="width: 80px;" value="<s:property value="batcht[top]"/>" id="aa" readonly="readonly"
																		...
																		<td><input type="text" name="ib.amount1" value="<s:property value="myamt[top]"/>" required readonly
												...
												<% } %>
																		...
																		<td><input type="text" value="<s:property value="hsncode[top]"/>" name="ib.ttype"   tabindex="12"
																			readonly style="width: 60px;background-color: #e2dfdf;" id="ttype"  required >
																		</td>
											...
											if(extracolumn=="0"){
												...
												//alert(myflag);
													...
													var $rowTemp = [
															...
															'<td><input style="width:60px;" type="text"  name="ib.quantity1"  onblur="calculategst(this);"  id="quantity1"   onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" required/></td>',
															puc,
