				...
				<div id="page-content">
									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	<div class="form-group">
                                                    ...
                                                    <input type="text" size="30" readonly value="${invoice}" class="form-control"  name="invoiceno" readonly/> 
                                       		 ...
                                       		 <%-- <div class="col-md-4">
                                            	<div class="form-group">
                                                    <label for="wlastName2"><b>Order ID</b>
                                                    </label>
                                   ...
                                   <div class="row">
                                      ...
                                      <div class="row">
                                               ...
                                               <div class="col-md-4">
                                                ...
                                                <input type="text" name="Date" class="form-control" id="to_date"  onblur="FixShortDate(this);return ValidateForm(this);" readonly/>
                                                </div>
                                       		 </div>
									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	...
                                            	<div class="form-group">
                                                  ...
                                                  <input type="text" value="<s:property value="pono"/>" class="form-control" name="pono" id="pono"   readonly/>
                                                </div>
                                       		 </div>
                                               ...
                                               <input type="text" value="<s:property value="pono"/>" class="form-control" name="podate" id="podate"  onblur="FixShortDate(this);return ValidateForm(this);"  readonly/>
                                                </div>
                                       		 </div>
                       ...
                       <div id="product" class="tab-pane table-responsive active">
																...
																<tr class="item-row">
																	...
																	<td>	<input type="text" name="ib.partdate"
																		...
																		<td><input type="text" name="ib.disc" 
																			...
																			style="width: 60px;" value="<s:property value="disc2[top]"/>" readonly/>
																		</td>
																		...
																		<input type="hidden" name="ib.discamt" tabindex="12"
																			id="discamt" onblur="twodecimal(this)" readonly 
												...
												<% } %>
																		...
																		<input type="hidden" name="ib.vat1" id="vat1"  style="width: 60px;" readonly>
                                       ...
                                       <div class="row">
                                               ...
                                               <div class="col-md-3">
                                                ...
                                                <input name="ib.freight" class="form-control"  value="<s:property value="freight"/>" id="freight"  readonly>
                                                </div>
                                       		 </div>
                                               ...
                                               <input name="ib.transport" id="transcharge" readonly class="form-control" value="<s:property value="transport"/>" onblur="totalnetamt();" >
                                                </div>
                                       		 </div>
                                                ...
                                                <input name="ib.tamount" class="form-control" id="tamount" readonly value="<s:property value="totamt"/>" readonly>
                                                </div>
                                       		 </div>
											...
											if(extracolumn=="0"){
												...
												//alert(myflag);
													...
													var $rowTemp = [
															...
															'<input type="hidden"  style="width:60px;" value="" name="ib.grate2" id="grate2" >',
															'<input type="hidden"  style="width:60px;" value="" name="ib.gstamount2" id="gstamount2" >',
