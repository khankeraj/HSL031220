...
<script type="text/javascript" language="javascript" class="init">
  ...
  <!-- AutoSearch -->
    ...
    <script src="js/dataTables.fixedHeader.min.js" type="text/javascript" charset="utf-8"></script>
  ...
  <script>
	$(function() {
		 ...
		 $("#dest").autocomplete("GoogleSearch/autosearchCity.jsp");
...
<script>
	...
	var currentURL = "PriceCheckReportSuccess123?source="+source+"&dest="+dest+"";
			...
			alert("Please Select From and Destination...");
			return false;
		}
	}
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Price Check Report</h3>
						</div>
								...
								<div class="col-sm-12">
									<div class="form-group">
										<label class="control-label">From:</label>
											&nbsp;<input type="text"   name="source"  id="source" size="40"  required>
												
											&nbsp;&nbsp;&nbsp;<label class="control-label">Destination:</label>
											&nbsp;<input type="text"  name="dest"  id="dest"  size="40" required>
												
											<input type="button" name="Search" value="Submit" class="btn btn-primary" onclick="priceCheck();" />
									</div>
