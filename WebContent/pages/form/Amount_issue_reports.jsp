...
<head>
	...
	<script>
		function deleteFun(product_id){
			alert(product_id);
			var link = "Deleteissueamount?product_id="+product_id;
								...
								<tbody>
								 ...
								 <c:forEach items="${tripDetails}" var="tripDetails">
									<tr>
										...
										<td><c:out value="${tripDetails.dest_contact_person}" /></td>
										<td><c:out value="${tripDetails.given_by}" /></td>
										<td><c:out value="${tripDetails.amount1}" /></td>
										
										
										<td><c:out value="${tripDetails.remark}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="Updateamountissue?product_id=<c:out value="${tripDetails.documentsno}" />">
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${tripDetails.documentsno}" />);"></a>
									   </td>
