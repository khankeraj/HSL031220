				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Invoice Tax Report</h3>
						</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<thead>
									<tr>
										...
										<th>Date</th>
										<th>PO Number</th>
										<th>Invoice Tax Form</th>
									</tr>
								</thead>
								
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${taxinvoicereport}" var="taxinvoicereport">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${taxinvoicereport.customer_code}" /></td>
										<td><c:out value="${taxinvoicereport.customer_name}" /></td>
										<td><c:out value="${taxinvoicereport.supplier_id}" /></td>
										<td><c:out value="${taxinvoicereport.supplier}" /></td>
										<td><c:out value="${taxinvoicereport.date}" /></td>
										<td><c:out value="${taxinvoicereport.pono}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Invoice tax form" href="TaxInvoiceForm?customer_no=<c:out value="${taxinvoicereport.customer_code}"/>&customer_name=<c:out value="${taxinvoicereport.customer_name}"/>&supplier_id=<c:out value="${taxinvoicereport.supplier_id}" />&supplier=<c:out value="${taxinvoicereport.supplier}"/>&pono=<c:out value="${taxinvoicereport.pono}"/>">
