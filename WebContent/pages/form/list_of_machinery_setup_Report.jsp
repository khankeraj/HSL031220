	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					<input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='List_of_machinery_setup_form'"/>
					
				</div>
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">M/C & Set Up Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-selection" class="table table-striped table-bordered" cellspacing="0" width="100%">
								<thead>
									<tr>
									<th></th>
										<th class="min-tablet">Sr.No</th>
										<th class="min-tablet">Name Of Index</th>
								...
								<tbody>
									<%int i=1; %>
								 <c:forEach items="${machinery_setup1}" var="machinery_setup1">
									<tr>
										<td><label class="form-checkbox form-normal form-primary"><input type="checkbox" onclick="getAlert()"></label></td>
										<td><%=i++ %></td>
										<td> <c:out value="${machinery_setup1.name_of_index}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" href="#?machinery_id=<c:out value="${machinery_setup1.machinery_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" href="#?machinery_id=<c:out value="${machinery_setup1.machinery_id}" />">
