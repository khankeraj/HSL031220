 ...
 <script src="js/datevalidation.js" type="text/javascript"></script>
  ...
  <!-- AutoSearch -->
	...
	$(function() {
	 ...
	 function showGrid()
	 {
		 c_name = document.getElementById("customer_name").value;
		 ...
		 else
		 {
			 ...
			 xp1.open("POST","InvoiceSearch1?customer_no="+c_code);
			 xp1.send();
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Customer Payment Form</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">Customer Payment Form</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form method="POST" id="form1" action="insertcustomerpaymentv1">
									...
									<!-- <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="radio" name="dpb.paytype" id="paytype" value="against_trip" checked> Against Trip
													<input type="radio" name="dpb.paytype" id="paytype" value="normal"> Normal
									...
									<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="date" name="dpb.payment_date" id="payment_date" style="line-height:15px;"  onblur="FixShortDate(this);return ValidateForm(this);"  class="form-control" required>
								      ...
								      <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Customer Name" name="dpb.customer_name" id="customer_name"   class="form-control" required>
									  ...
									  <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Total Amount" name="dpb.total_amount" id="total_amount"   class="form-control" onblur="getNetAmt(this)" required>
												</div>
											</div>
												...
												<tbody id="4" style="display: none;">
													<tr>
														...
														<td align="left"><input name="dpb.cheque_date" class="form-control"
															...
															onblur="FixShortDate(this);return ValidateForm(this);" type="date" style="line-height: 15px;"
															size="10">
													</tr>
												</tbody>
