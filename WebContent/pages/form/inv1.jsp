  ...
  <!-- AutoSearch -->
	...
	function getValues(v)
	  ...
	  function checkTotals()
	 {
		...
		/* else
		{ */
			document.getElementById("form1").action = "Add_invoice2";
		//}
	 } 
									  ...
									  <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="total_amount" id="total_amount" value="<%=request.getParameter("total_amount") %>"  class="form-control" required readonly>
												</div>
											</div>
