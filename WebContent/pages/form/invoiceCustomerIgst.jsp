									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	<div class="form-group">
                                                    ...
                                                    <input type="text" size="30"  value="${invoiceno}" class="form-control" readonly  name="invoiceno" required/> 
															...
															<!-- AddRowDataTable -->
																...
																<tr class="item-row">
																	...
																	<td>	<input type="text" name="ib.partdate"
																		...
																		<td><input type="text" name="ib.quantity1"  onblur="calculategst(this);"
																		...
																		<td><input type="text" name="ib.amount1" required readonly onblur="calculategst(this);"
											...
											if(extracolumn=="0"){
												...
												//alert(myflag);
													...
													var $rowTemp = [
															...
															'<input type="hidden"  style="width:60px;"  name="ib.grate2" id="grate2" readonly >',
															'<input type="hidden"  style="width:60px;"  name="ib.gstamount2" id="gstamount2"  >',
