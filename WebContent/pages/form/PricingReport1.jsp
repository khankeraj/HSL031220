...
<script>
	...
	var currentURL = "PricingEdit?pricing_id="+pricing_id+"";
...
<script>
	function cancel(pricing_id) {

	var currentURL = "PricingCancel?pricing_id="+pricing_id+"";
...
<%-- <script>
	function quotation(pricing_id,name) {

	var currentURL = "PricingQuotation?pricing_id="+pricing_id+"&name="+name+"";
	
		var okdelete = confirm("Are You Sure Want to Give Quotation!");
...
<script>
	function order(pricing_id,inquiry_id,name,address,contact_person,contact_no,transporter_name,state,gstn,vehicle_type,date) {

	var currentURL = "PricingOrder?pricing_id="+pricing_id+"&inquiry_id="+inquiry_id+"&name="+name+"&address="+address+"&contact_person="+contact_person+"&contact_no="+contact_no+"&transporter_name="+transporter_name+"&state="+state+"&gstn="+gstn+"&vehicle_type="+vehicle_type+"&datee="+date+"";
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Vehicle Confirmation</h3>
						</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <s:iterator value="inquiryReport">
									<tr>
										<td><%=i++ %></td>
										<td><s:property value="inquiry_id"/></td>
										...
										<td  align="center"><a style="text-decoration: none;color: green;" title="Order" onclick="order('<s:property value="pricing_id"/>','<s:property value="inquiry_id"/>','<s:property value="name"/>',
										'<s:property value="address"/>','<s:property value="contact_person"/>','<s:property value="contact_no"/>','<s:property value="transporter_name"/>','<s:property value="state"/>','<s:property value="gstn"/>','<s:property value="vehicle_type"/>','<s:property value="date"/>')" >
											<img alt="Vehicle" height="25px;" src="configure/img/vehicles.png"></a>
									   </td>
									
										<%-- <td  align="center"><a style="text-decoration: none;color: green;" title="Quotation" onclick="quotation('<s:property value="pricing_id"/>','<s:property value="name"/>')" >
											<img alt="Quotation" height="35px;" src="configure/img/quot.png"></a>
									   </td> --%>
									
									
										<td  align="center"><a style="text-decoration: none;color: green;" title="Edit" onclick="edit('<s:property value="pricing_id"/>')" >
											<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>
									   </td>
									
										<td  align="center"><a style="text-decoration: none;color: green;" title="Cancel" onclick="cancel('<s:property value="pricing_id"/>')" >
