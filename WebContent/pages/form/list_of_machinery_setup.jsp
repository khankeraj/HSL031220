											...
											function addRows(e) {
												try {
													...
													var $rowTemp = [
															...
															'<td><input  type="text" class="form-control" name="machinery_setup" onkeyup="this.value=this.value.toUpperCase()"/></td>',
															'</tr>' ].join('');
													var $row = $($rowTemp);
													$.currentRow = $row;
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">M/C & Setup Master</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">M/C & Setup Master</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Machinery_setup" method="POST" class="form-horizontal">
													...
													<tr>
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	<tr>
																		<th style="">Delete</th>
																		<th id="VLsparename"><label>Machinery Name & Setup </label></th>
																	</tr>
																	<tr class="item-row">

																		<td></td>
																		<td><input type="text" name="machinery_setup" onkeyup="this.value=this.value.toUpperCase()" class="form-control">
																		</td>	
																		</td>
																	</tr>
																</table>
