				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Transporter CREDIT DEBIT REPORT</h3>
						</div>
						<div class="panel-body">
						<form action="Transporter_Credit_Advance_Report_Submitv">
							<div class="row">
										   ...
										   <div class="col-sm-6">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="to_date" onblur="FixShortDate(this);return ValidateForm(this);"  id="to_date" value="" class="form-control" required>
												</div>
											</div>
								...
								<div class="row">
									...
									<div class="row">
											<h3>
												<%-- Manager Name:<b> ${dealerid1}</b> --%>Transporter Name:<b> <s:property value="dealer_id" /></b><br> From Date: <b>${fromdate}</b><br>
												To Date: <b>${todate}</b>
										    </h3>
