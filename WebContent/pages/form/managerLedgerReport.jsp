				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Manager Ledger</h3>
						</div>
						<div class="panel-body">
						
						<form action="manager_ledger_report">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="emp_name"  id="emp_name" value="" class="form-control" >
												</div>
											</div>
								...
								<tbody>
								 ...
								 <c:forEach items="${tripDetails}" var="tripDetails">
									<tr>
										...
										<td><c:out value="${tripDetails.credit_amount}" /></td>
										<td><c:out value="${tripDetails.debit_amount}" /></td>
										<td><c:out value="${tripDetails.remaining_amount}" /></td>
