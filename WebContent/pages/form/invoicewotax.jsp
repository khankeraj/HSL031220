...
$(function() {        
	...
	$(function() {
		...
		$("#autoinvoice").autocomplete("GoogleSearch/invoicenoautosearchwotax.jsp");
...
//alert(">>>>>1");
 ...
 var parts = autoinvoice.split("^");
			...
			getjobnoagain(inv);
			//alert("111111" + vehicle);
	xp1.open("POST","FetchspareGatepassAssemblyforminvoice1?autoinvoice="+inv);
 ...
 */
	...
	function totalnetamt() {
		...
		$('.item-row').each(function(i, row) {
			...
			var $totamttemp = $(row).find('#amount1');
											...
											if(extracolumn=="0"){
												...
												if(extracolumn=="3"){
												   ...
												   var disc=document.getElementById("discountval").value;
													if(disc=="yes"){
														myflag11='<td><input type="text" name="ib.disc"	  	id="disc" value="" 		onblur="getnewsrno1xxx(this);gotoadd1();twodecimal(this);" 				style="width: 60px;" />		</td>';
													...
													var $rowTemp = [
															...
															'<td><input style="width:60px;" type="text" name="ib.amount1"   id="amount1" readonly  value="" /></td>',
															  myflag11,
										                        myflag22,
										                        myflag33,
															'<input type="hidden"  style="width:60px;" value="" name="ib.ttype"   onblur="gettaxpercent(this);gotoadd1();"  id="ttype" >',
															'<input style="width:60px;" type="hidden" name="ib.vat1"    id="vat1" value="" readonly/>',
															'<input type="hidden"  style="width:60px;" value="" name="ib.grate1" id="grate1" readonly>',
															'<input type="hidden"  style="width:60px;" value="" name="ib.gstamount1" id="gstamount1" readonly>',
															...
															'<input style="width:60px;" type="text" name="ib.vatamount1"   id="vatamount1" value=""  onblur="getnewsrno44(this);" />',
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
									...
									<form action="Add_invoice_wotax" id="formID2" name="formID2"
										method="POST">
									...
									<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"   name="Customer_Id" value="${customer_no }" id="Customer_Id" onblur="getjobno1(this);"  required>
												</div>
											</div>
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${customer_name }" name="Customer_name" id="Customer_name"    required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="Job_Card_no" id="Job_Card_no" value="${name}"  required>
												</div>
											</div>
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="Model" id="Model" value="${name}"  required>
												</div>
											</div>
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="Pendingamt" id="Pendingamt"    required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="Date" id="to_date" onblur="FixShortDate(this);return ValidateForm(this);"  required>
												</div>
											</div>
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="pono" id="pono"  required>
												</div>
											</div>
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="podate" id="podate" onblur="FixShortDate(this);return ValidateForm(this);"   required>
												</div>
											</div>
									...
									<div class="row"  id="111">
									  		...
									  		<div class="col-sm-4">
												<div class="form-group">
													<label class="control-label">Payterm :</label>
													<input type="text" class="form-control"  name="termcond" id="termcond">
												</div>
											</div>
									  ...
									  <div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="vehino" id="vehino"  >
												</div>
											</div>
									  	...
									  	<div class="row"  id="222">
									  		...
									  		<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="dcnox" id="dcnox">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="dcdatex" id="dcdatex"  >
												</div>
											</div>
									  ...
									  <div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="transmode" id="transmode"  >
												</div>
											</div>
										...
										<div class="row"  id="333">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="contactpno" id="contactpno"  >
												</div>
											</div>
									  	...
									  	<div class="row"  id="444">
									  		...
									  		<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="shipparty" id="shipparty">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="shipadd" id="shipadd"  >
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													<label class="control-label">Ship GSTN No</label>
													<input type="text" class="form-control"  name="shipgstn" id="shipgstn"  >
												</div>
											</div>
							...
							<tr>	
											...
											<th id="VLsparename"><label>Tot Amt</label></th>
												...
												<% } %>
																	...
																	<input type="hidden" value="" name="ib.ttype"   tabindex="12"
																		...
																		<input type="hidden" name="ib.vat1" id="vat1" value=""
																			...
																			<input type="hidden" name="ib.grate1" id="grate1" value=""
																			style="width: 60px;" readonly>
																		
																		<input type="hidden"  name="ib.gstamount1" id="gstamount1" value=""
																			style="width: 60px;" readonly>
																		...
																		<input type="hidden" name="ib.vatamount1" id="vatamount1"
																...
																<table id="itemsTable$" class="table table-striped table-bordered" cellspacing="0" width="70%">
																	...
																	<div class="row">
																		...
																		<div class="col-sm-3">
																			<div class="form-group">
																				...
																				<input type="text" class="form-control"  name="ib.stot" id="stot"   readonly required>
																			</div>
																		</div>
																		...
																		<div class="col-sm-3">
																			<div class="form-group">
																				<label class="control-label">Frieght</label>
																					<input type="text" class="form-control"  name="ib.freight" id="freight" onblur="totalnetamt();"   required>
																			</div>
																		</div>
																		...
																		<div class="col-sm-3">
																			<div class="form-group">
																				<label class="control-label">Transport</label>
																					<input type="text" class="form-control"  name="ib.transport" id="transcharge" onblur="totalnetamt();"   required>
																			</div>
																		</div>
																		...
																		<div class="col-sm-3">
																			<div class="form-group">
																				<label class="control-label">Total Amount</label>
																					<input type="text" class="form-control"  name="ib.tamount" id="tamount"  readonly  required>
																			</div>
																		</div>
																	...
																	<input type="hidden" name="ib.t" id="t1" maxlength="8" size="37" value="CGST:" readonly="readonly">
																	
																	<input type="hidden" name="ib.A" id="A1" maxlength="8" size="15" readonly="readonly">
																	
																	<input type="hidden" name="ib.A2" id="A2" maxlength="8" size="15" readonly="readonly">
																	

																	<input type="hidden" name="ib.t" id="t2" maxlength="8" size="37" value="SGST:" readonly="readonly">
																	
																	<input type="hidden" name="ib.A" id="A3" maxlength="8" size="15" readonly="readonly">
																	

																	<input type="hidden" name="ib.A2" id="A4" maxlength="8" size="15" readonly="readonly">
																	

																	<input type="hidden" name="ib.t" id="t4" maxlength="8" size="37" value="TOTAL TAX AMOUNT:" readonly="readonly">
																	
																	<input type="hidden" name="ib.A" id="A16" maxlength="8" size="15" >
																	

																	<input type="hidden" name="ib.A2" id="A17" maxlength="8" size="15" readonly="readonly">
																	


																	<input type="hidden" name="autoinvoice" id="autoinvoice" maxlength="7" size="30">
																	<!-- <input type="button" name="Search" value="Search" class="btn btn-primary" onclick="showspares();" /> -->
																 <input type="hidden" name="invno" id="invno" maxlength="7" size="12">
