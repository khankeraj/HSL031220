				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="InvoiceheadUpdateCommon12" class="form-control" name="formid" id="formid" method="POST" ">
								...
								<br><br>
							          ...
							          <div class="form-group">
							                <label>Total </label>
							                <input type="text" class="form-control" value="<s:property value="total"/>"  name="total" id="total"  readonly required>
							              </div>
