	 ...
	 $(function() {
		...
		// $("#ff").autocomplete("GoogleSearch/autosearchCity.jsp");
		 ...
		 $('.item-row').each(function(i, row) {
			 ...
			 $($s).autocomplete("GoogleSearch/autosearchCity.jsp");
			 $($s1).autocomplete("GoogleSearch/autosearchCity.jsp");
			 $($s2).autocomplete("GoogleSearch/autosearchVehicleType.jsp");
			 $($s3).autocomplete("GoogleSearch/autosearchVehicleSize.jsp");
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Quotation Edit</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">Quotation Edit</li>
				</ol>
				<!--End breadcrumb-->
								...
								<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${datee}" onblur="FixShortDate(this);return ValidateForm(this);"  name="date" id="date"   required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="name" id="name" value="${vendor}"   required>
												</div>
											</div>
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${price_id}" name="address" id="address"   required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  value="${remark}" onblur="checkMobileLength(this);" name="contact_no" id="contact_no"   required>
												</div>
											</div>
									  </div>
										...
										<div class="col-sm-6">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control"  name="kind_attn"  value="${kind_attn}" id="kind_attn">
												</div>
											</div>
									  </div>
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" value="${payterm}" name="payterm" id="payterm" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"  required>
												</div>
											</div>
									  	...
									  	<div id="product" style="width:100%">
																...
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="70%">
																	...
																	<tr class="item-row">
																		...
																		<td style="width:1px;"><a id="deleteRow"><img src="Images_4_design/AddRowDataTable/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
																	
																		<td><input type="text" value="<s:property value="aa1"/>" name="aa" class="form-control" style="width: 120px;"  id="aa" required/></td>
																		
																		<input type="hidden" value="<s:property value="bb1"/>" name="bb" class="form-control" style="width: 120px;" id="bb"  />
																		
																		<td><input type="text" value="<s:property value="ee1"/>" name="ee" class="form-control" id="ee"   style="width: 120px;"  required/> </td>
																		
																		<td><input type="text" value="<s:property value="ff1"/>" name="ff" class="form-control" id="ff"   style="width: 120px;"  required/> </td>
																		
																		<td><input type="text" value="<s:property value="cc1"/>" name="cc" class="form-control" id="cc"  style="width: 120px;" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" required/> </td>
																		
																		<td><input type="text" value="<s:property value="dd1"/>" name="dd" class="form-control" id="dd"  onblur="getTotal(this);" style="width: 120px;" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" required/> </td>
