	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">VIEW PURCHASE ORDER</h1>
				</div>
				<!--End page title-->
						...
						<div class="col-lg-12">
							<div class="panel">
								<div class="panel-heading">
									...
									<form action="update_purchase" id="formID2" name="formID2" method="POST">
															...
															<div class="row">
																<div class="col-sm-6">
																	<div class="form-group">
																	 ...
																	 value="${po_number}"  class="form-control"
																	/> 
																	</div>
																</div>
																...
																<div class="col-sm-6">
																	...
																	name="Customer_Id" id="Customer_Id"  class="form-control" size="30"
																	onchange="checkvalue();" value="${customer_no}" tabindex="4"
														     ...
														     <div class="row">
																<div class="col-sm-6">
																	<div class="form-group">
																		...
																		<input type="text" 
																	name="Customer_name" id="Customer_name" size="30"  class="form-control"
																	onchange="checkvalue();" value="${Customer_name}" tabindex="5"
																...
																<div class="col-sm-6">
																	...
																	size="30" id="gstin_no" value="${customer_gstin_no}" tabindex="6"  class="form-control"
														      ...
														      <div class="row">
																<div class="col-sm-6">
																	<div class="form-group">
																		...
																		<input name="Vehicle_no" tabindex="6" readonly	id="pan_no"	  class="form-control" size="30" value="${pan_no}" >
																	</div>
																</div>
														     ...
														     <div class="row">
																<div class="col-sm-6">
																	...
																	id="city" readonly size="30"   class="form-control"
																	value="${city}" tabindex="6" class="validate[required] backcolor"
																	 />
																	</div>
																</div>
														     ...
														     <div class="row">
																<div class="col-sm-6">
																	...
																	id="Pendingamt"  size="30" 
																	value="${balance_amt}" tabindex="6"
																	/>
																	</div>
																</div>
																		...
																		<table align="left" id="textfocus">
												 					 	<tr>
																			...
																			<td colspan="3">
																				...
																				<table  class="table table-striped table-bordered" cellspacing="0" width="100%" id="tab">
