	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Invoice Form(IGST)</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">Invoice Form(IGST)</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_invoice_Customer_Igst" class="form-control" method="POST">
									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	<div class="form-group">
                                                    ...
                                                    <input type="text" size="30"  value="${invoice}" class="form-control"  name="invoiceno" readonly required/> 
									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	...
                                            	<div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" value="<s:property value="pono"/>" name="pono" id="pono"   />
                                                </div>
                                       		 </div>
                       ...
                       <div id="product" class="tab-pane table-responsive active">
																...
																<tr class="item-row">
																	...
																	<td>	<input type="text" name="ib.partdate"
																		...
																		<input type="hidden" name="ib.aa"
																			style="width: 80px;" value="<s:property value="batcht[top]"/>" id="aa"
																			tabindex="10" required/>


																		<td><input type="text" name="ib.description1" onblur="fetchalldetails(this);"
																			style="width: 250px;" value="<s:property value="descriptiont[top]"/>" id="description1"
																			tabindex="10" required/></td>
																			
																			
																			
																		<input type="hidden" name="ib.batch1" style="width: 80px;"  id="batch1" readonly />
																		
																		<td><input type="text" name="ib.quantity1" value="<s:property value="quantity[top]"/>"
																			...
																			<td><input type="text" name="ib.myrate" value="<s:property value="myrate[top]"/>"
																		...
																		<td><input type="text" name="ib.amount1"  readonly value="<s:property value="myamt[top]"/>"
																			id="amount1"  " onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"
																			readonly style="width: 60px;background-color: #e2dfdf;" />
																		</td>
												...
												<% } %>
																		...
																		<td><input type="text" value="<s:property value="hsncode[top]"/>" name="ib.ttype"   tabindex="12"
																			readonly style="width: 60px;background-color: #e2dfdf;" id="ttype"  >
																		</td>
																		
																		<td><input type="text" name="ib.vat1" id="vat1" tabindex="13" value="<s:property value="vat[top]"/>"
																			readonly style="width: 60px;background-color: #e2dfdf;" onblur="calculategst(this);"></td>
																		...
																		<input type="hidden" name="ib.grate2" id="grate2" value="<s:property value="rate[top]"/>"
																			style="width: 60px;" >
																		
																		
																		<input type="hidden" name="ib.gstamount2" id="gstamount2" value="<s:property value="netamt[top]"/>"
																			style="width: 60px;" >
																		...
																		<td><input name="ib.vatamount1" id="vatamount1" onblur="getnewsrno44(this);" value="<s:property value="gstamt1[top]"/>" readonly style="width: 60px;background-color: #e2dfdf;" >
                                       ...
                                       <div class="row">
                                               ...
                                               <div class="col-md-3">
                                                ...
                                                <input name="ib.freight" class="form-control" id="freight" value="<s:property value="freight"/>"  onblur="totalnetamt();" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
                                                </div>
                                       		 </div>
                                               ...
                                               <input name="ib.transport" id="transcharge" class="form-control" value="<s:property value="transport"/>" onblur="totalnetamt();" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
                                                </div>
                                       		 </div>
										...
										<table id="itemsTable$"  class="general-table$">
													...
													<tr>
														<td><table>
																...
																<input type="hidden" name="ib.t" id="t2" maxlength="8"
																		size="37" value="SGST:" readonly="readonly">
																	
																	<input type="hidden" name="ib.A" id="A3" maxlength="8" size="15"
																		readonly="readonly">
																	

																	<input type="hidden" name="ib.A2" id="A4" value="<s:property value="cgstamt"/>" maxlength="8"  >
											...
											<td colspan="2" align="center"><input type="text"
												name="ib.A2" id="A6" maxlength="8" size="15">
																...
																<tr >
																	...
																	<td colspan="2" align="center"><input type="text"
																		name="ib.A2" id="A17" value="<s:property value="cgstamt"/>"  maxlength="8" size="15"
																		>
																	</td>
											...
											if(extracolumn=="0"){
												...
												//alert(myflag);
													...
													var $rowTemp = [
															...
															'<input type="text" name="ib.aa" style="width: 80px;" value="<s:property value="Aa1[top]"/>" id="aa" tabindex="10" required/>',
															...
															'<input type="hidden"  readonly style="width: 60px;background-color: #e2dfdf;"  name="ib.grate2" id="grate2" readonly >',
															'<input type="hidden"  readonly style="width: 60px;background-color: #e2dfdf;"  name="ib.gstamount2" id="gstamount2"  >',
													...
													var $description1 = $row .find('#description1');
													
													$($description1).autocomplete("GoogleSearch/spareautosearch.jsp");
													
													var $aa = $row.find('#ttype');
											
													$($aa).autocomplete("GoogleSearch/gsttaxtypeautosearch1.jsp");
