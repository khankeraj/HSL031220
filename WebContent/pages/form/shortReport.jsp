				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Short/Loss Weight Report</h3>
						</div>
						<div class="panel-body">
						
						<form action="short_Reports1">
							<div class="row">
								...
								<tbody>
								 ...
								 <c:forEach items="${deliveryDetails}" var="deliveryDetails">
									<tr>
										...
										<td><c:out value="${deliveryDetails.description1}" /></td>
										<td><c:out value="${deliveryDetails.short_weight1}" /></td>
										<td><c:out value="${deliveryDetails.short_amount}" /></td>
									</tr>
								 </c:forEach>
								</tbody>
							</table>
