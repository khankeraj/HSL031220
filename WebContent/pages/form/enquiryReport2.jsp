		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					...
					<form name="collection_summary" action="EnquiryReportDetails" id="collection_summary">
								...
								<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
									...
									<thead width="20">
										...
										<tr>
											...
											<th><strong>Enquiry No.</strong></th>
											...
											<th><strong>Buy Rates </strong></th>
												<th><strong>Broker</strong></th>
													<th><strong>Won/Loose</strong></th>
									...
									<%int z=1; %>
										<c:forEach items="${report}" var="purchase_bean">
											<tr>
												...
												<td><c:out value="${purchase_bean.enquiryid}" /></td>
												...
												<td><c:out value="${purchase_bean.brocker}" /></td>
													<td><c:out value="${purchase_bean.status}" /></td>
												<td><c:out value="${purchase_bean.remark}" /></td>
