										   ...
										   <div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">From Date:</label>
														...
														<input type="text" class="form-control" placeholder="" name="from_date"  id="from_date" onblur="FixShortDate(this);return ValidateForm(this);"   required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="to_date"  id="to_date" onblur="FixShortDate(this);return ValidateForm(this);" class="form-control" required>
												</div>
											</div>
