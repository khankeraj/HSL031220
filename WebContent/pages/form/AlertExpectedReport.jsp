...
<script type="text/javascript" language="javascript" class="init">
  ...
  <script>
	...
	var currentURL = "AlertEdit1?id="+id+"";
	
		var okdelete = confirm("Are You Sure You Want To Edit..!");
...
<script>
	...
	var currentURL = "AlertDone1?id="+id+"";
	
		var okdelete = confirm("Are You Sure You Want To Done..!");
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Alert Expected Report</h3>
						</div>
						<div class="panel-body">
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${inquiryReport}" var="inquiryReport">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${inquiryReport.date}" /></td>
										<td><c:out value="${inquiryReport.name}" /></td>
										<td><c:out value="${inquiryReport.contactp}" /></td>
										<td><c:out value="${inquiryReport.contact_no}" /></td>
										<td><c:out value="${inquiryReport.type}" /></td>
										<td><c:out value="${inquiryReport.exp_date}" /></td>
										<td><c:out value="${inquiryReport.remark}" /></td>
											
										 
										 
										<td align="center"><a style="text-decoration: none;color: green;" title=" Edit" onclick="edit('<c:out value="${inquiryReport.id}"/>')">
											<img alt="Edit" height="35px;" src="configure/img/editmeeting.svg"></a>
									   </td> 
									   
									   
									   <td align="center"><a style="text-decoration: none;color: green;" title="Done" onclick="done('<c:out value="${inquiryReport.id}"/>')">
											<img alt="Done" height="35px;" src="configure/img/process.png"></a>
									   </td> 
