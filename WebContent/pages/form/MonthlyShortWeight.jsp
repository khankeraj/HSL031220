	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Monthly Short Weight Graph</h1>
				</div>
				<!--End page title-->
				...
				<!--Page content-->
				<div id="page-content">
				<input type="hidden" value="${graph2}" id="graph05">
						<%-- <div class="row">
						<div class="col-lg-12">
							<div class="panel">
