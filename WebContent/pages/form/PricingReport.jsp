...
<script>
	function quotation(pricing_id,name,contact_no,inquiry_id,address,source,desti,resource,date) {

	var currentURL = "PricingQuotation?pricing_id="+pricing_id+"&name="+name+"&contact_no="+contact_no+"&inquiry_id="+inquiry_id+"&address="+address+"&source="+source+"&desti="+desti+"&resource="+resource+"&datee="+date+"";
...
<script>
	function order(pricing_id,inquiry_id) {

	var currentURL = "PricingOrder?pricing_id="+pricing_id+"&inquiry_id="+inquiry_id+"";
	
		var okdelete = confirm("Are You Sure Want to Confirm the order!");
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Pricing Quotation Report</h3>
						</div>
								...
								<tbody>
								 ...
								 <s:iterator value="inquiryReport">
									<tr>
										...
										<%-- <td  align="center"><a style="text-decoration: none;color: green;" title="Order" onclick="order('<s:property value="pricing_id"/>','<s:property value="inquiry_id"/>')" >
											<img alt="Order" height="35px;" src="configure/img/order.png"></a>
									   </td> --%>
									
										<td  align="center"><a style="text-decoration: none;color: green;" title="Quotation" onclick="quotation('<s:property value="pricing_id"/>','<s:property value="name"/>','<s:property value="contact_no"/>','<s:property value="inquiry_id"/>','<s:property value="address"/>','<s:property value="source"/>','<s:property value="destination"/>','<s:property value="resource"/>','<s:property value="date"/>')" >
