				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Vehicle Alert Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${vehicleDetails}" var="vehicleDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${vehicleDetails.vehicle_no}" /></td>
										<td><c:out value="${vehicleDetails.alert}" /></td>
										<td><c:out value="${vehicleDetails.date}" /></td>
