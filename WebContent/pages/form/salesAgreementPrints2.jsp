...
<table style="width:100%;border-collapse:collapse;page-break-inside: auto;page-break-after: always;margin-top: -100px;"">
	<tr>
		<td>
			<table>
				<tr align="center"><td> <s:iterator value="sales_agreement_report"><b>AGREEMENT FOR ${agreement_subject}</b></s:iterator></td></tr>
				<tr align="center"><td>This agreement made on 7th day of April month of year 2018</td></tr>
			
				<tr align="center"><td>BETWEEN</td></tr>
			
				<tr><td><p><s:iterator value="sales_agreement_report"><b>${name}</b> having firm <b>${fim_name}</b> registration no.<b>${reg_no}</b> and having its corporate office at <b>${office_address}</</b>,<b>${city}</b>-<b>${pincode}</b>  being represented by its authorized signatory,<b>${authorized_signatory}</b></s:iterator> (hereinafter called “the firm”, which expression shall, unless excluded by or repugnant to the context or meaning thereof, include its successors-in-title and permitted assigns) of the First Part;</p></td></tr>
 			</table>
 		</td>
 	</tr>
<tr>
<td><p style="margin-left: 50px;">1. &nbsp;M/s. ULTRACARE SERVICES a company within the meaning of the Companies Act, 1956/ Companies Act, 2013 with corporate identity number U41000PN2014PTC152164 and having its registered office at B-219&220, B WINGS, JAI GANESH VISION AKURDI PUNE Pune MH 411035 (hereinafter called “the firm”, which expression shall, unless excluded by or repugnant to the context or meaning thereof, include its successors-in-title and permitted assigns) of the Second Part;</p></td>
</tr>

<tr><td><p>Whereas the party of First Part has decided to establish packaged drinking water plant at location Bhamboli and has approached to party of Second Part to provide with the offer for the supply and installation of entire packaged drinking water project machinery.</p></td></tr><br>
<tr><td><p></p>Whereas the party of Second Part possess expertise in the business of supply and installation of package drinking water machinery and is into the said business since 2006 has given quotation for completion of required project to the party at First Part vide quotation no. <s:iterator value="sales_agreement_report"><b>${quotation_no}</b> dated <b>${order_no}</b></s:iterator>. The full description of said quotation is annexed to this agreement as `Annexure I`.</td></tr><br>
<tr><td><p>Whereas the party at First Part in pursuance of quotation placed by party at Second part as mentioned above has agreed to the terms of said quotation and placed an order for the purchase and installation of said package drinking water project vide quotation no. <s:iterator value="sales_agreement_report"><b>${quotation_no}</b> dated <b>${date_of_quotation}</b> and Purchase Order no.<b>${order_no}</b></s:iterator> and party at Second Part has agreed to supply machinery and execute the installation as per said quotation at the above address of party at First Part.</p></td></tr><br>
...
<tr><td><p style="margin-left: 70px;">1.Both the parties have mutually agreed that the consideration cost to be paid by party at first part to party at second part will be Rs.<s:iterator value="sales_agreement_report"><b>${second_part_payment}</b></s:iterator>/- which will include the price of designing, engineering, supply and installation of package drinking water project machinery including consumables at the place of party at first part. Taxes & Transportation excluded from the cost.</p></td></tr>
...
<tr><td><p style="margin-left: 10px;">IN WITNESS WHEREOF the parties have put their respective hands the day and year first<br>
</b> hereinabove written</p></td></tr><br>
...
<tr><td><p style="margin-left: 10px;">M/s. <s:iterator value="sales_agreement_report">${firm_name}</s:iterator></p></td></tr>

<tr><td><p style="margin-left: 10px;"><s:iterator value="sales_agreement_report">${authorized_signatory}</s:iterator></p></td></tr>
...
<tr><td><p style="margin-left: 10px;">Witness:</p></td></tr><br>
<tr><td><table>
<tr><td><p>1.</p></td></tr>
