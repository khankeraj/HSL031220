...
<%-- <script src="Css/jquery-1.10.2.js" type="text/javascript"></script> --%>
 ...
 <script>
	  $(function() {
		 $("#transporter").autocomplete("GoogleSearch/transporterautosearch.jsp");
		 $("#customer").autocomplete("GoogleSearch/autosearchCustomer.jsp");
	});
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					...
					<form name="collection_summary" action="LRReportDetails" id="collection_summary">
						...
						<td><input type="text" width="20px" name="psb.to_date1" value="${dt}"
							...
							<br>
							<tr>
							<td align="left"><b>Customer Search</b></td>

						<td><input type="text" name="customer" id="customer"
							size="40"   /></td>
						<td align="left"><b>Transporter Search</b></td>
							
							<td><input type="text" name="transporter" id="transporter"
							size="40"   /></td>
							</tr>
							<br>
							<tr>
										...
										<tr>
											...
											<th><strong>Date</strong></th>
												<th><strong>Customer</strong></th>
													<th><strong>Booking By</strong></th>
											<th><strong>From</strong></th>
											
											
											<th><strong>To</strong></th>
												<th><strong>Type of Vehicle</strong></th>
													<th><strong>Buying Rate</strong></th>
											<th><strong>Selling Rate</strong></th>
											<th><strong>Transporter Name</strong></th>
											<th><strong>Transporter Ref/Inv/Challan</strong></th>
											<th><strong>LR PDF</strong></th>
										</tr>
									</thead>
									<tbody>
									<%int z=1; %>
										<c:forEach items="${report}" var="purchase_bean">
											<tr>
												...
												<td><c:out value="${purchase_bean.lrno}" /></td>
												<td><c:out value="${purchase_bean.date}" /></td>
												<td><c:out value="${purchase_bean.cust_name}" /></td>
												<td><c:out value="${purchase_bean.bookingby}" /></td>
												<td><c:out value="${purchase_bean.source}" /></td>
												<td><c:out value="${purchase_bean.destination}" /></td>
												<td><c:out value="${purchase_bean.type}" /></td>
												<td><c:out value="${purchase_bean.buyrate}" /></td>
												<td><c:out value="${purchase_bean.sellrate}" /></td>
												<td><c:out value="${purchase_bean.transporter}" /></td>
												<td><c:out value="${purchase_bean.transporterref}" /></td>
												<td> <a href="LR_print?lr_number=<c:out value="${purchase_bean.lrno}" />">
										
											<img alt="Print" height="35px;" src="configure/img/print.jpg"></a></td>
