...
<%-- <script type="text/javascript">
	...
	function getAddress12(v){
		...
		alert("aaaaa---"+v);
		var $traverse_row = $(v).parents('.item-row');
		$hoardinglocationgratq = $($traverse_row).find('#description1');
		var tax1=$($hoardinglocationgratq).val();
	...
	alert(tax1);
	 xp1.open("POST","invoicedetailnew?customercode="+tax1);
			
	 alert("sss--"+tax1);
	 //alert("ssssfff---"+xp1.value());
		xp1.send();
		// alert("sss11--"+tax1);
		 ...
		 if (xp1.readyState == 4 && xp1.status == 200) {
			...
			// alert("sss33-"+tax1);
			 ...
			 var grate=parseFloat(tstate)/2;
			 
			 	$hoardinglocationx1 = $($traverse_row).find('#ttype');
				$hoardinglocationx = $($traverse_row).find('#grate1');
				$hoardinglocationx2 = $($traverse_row).find('#grate2');
				
				alert("dddddd");
				alert("dddddd11--"+tadd);
				alert("dddddd22--"+grate);
				
				 $($hoardinglocationx).val(tadd);
			
				 $($hoardinglocationx1).val(grate);
				 $($hoardinglocationx2).val(grate);
 ...
 <script>
function fetchalldetails(v){
	
	 var $traverse_row = $(v).parents('.item-row');
	$hoardinglocationx = $($traverse_row).find('#description1');
	//$amtxt = $($traverse_row).find('#amtx');
	var taxtype = $($hoardinglocationx).val();
	...
	xp1.open("POST","invoicedetailnew?name="+taxtype);
   ...
   xp1.onreadystatechange=function() {
	...
	if(xp1.responseText!=""  && xp1.responseText!=null){
		...
		var rep=xp1.responseText;
		 ...
		 var grate=parseFloat(tstate)/2;
			...
			$hoardinglocationx = $($traverse_row).find('#grate1');
			$hoardinglocationx2 = $($traverse_row).find('#grate2');
			$hoardinglocationx3 = $($traverse_row).find('#vat1');
			
		 $($hoardinglocationx1).val(tadd);
		
			 $($hoardinglocationx).val(grate);
			 $($hoardinglocationx2).val(grate);
			 $($hoardinglocationx3).val(tstate);
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_invoice_Customer" class="form-control" method="POST">
									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	<div class="form-group">
                                                    ...
                                                    <input type="text" size="30"  value="${invoiceno}" class="form-control"  name="invoiceno" readonly required/> 
                                       		 ...
                                       		 <input type="hidden" name="inquiry_id" id="inquiry_id" value="<s:property value="inquiry_id"/>"  class="form-control"/>
                                   ...
                                   <div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	...
                                            	<div class="form-group">
                                                   ...
                                                   <input type="text" name="Customer_name" id="Customer_name" 
													  value="<s:property value="name"/>"  class="form-control" readonly required/>
                                                </div>
                                       		 </div>
                                      ...
                                      <div class="row">
                                               ...
                                               <div class="col-md-4">
                                                ...
                                                <input type="text" name="Date" class="form-control" id="to_date1" value="<s:property value="date"/>"  onblur="FixShortDate(this);return ValidateForm(this);" required/>
                                                </div>
                                       		 </div>
														...
														<td align="left"><b>Po No:</b><br><input type="text" name="pono"
															...
															<td align="left"><b>Shipping Address:</b><br><input type="text" name="shipadd"
																...
																<td align="left"><b>Ship GSTN No:</b><br><input type="text" name="shipgstn"
																	id="shipgstn"  size="30" onblur="checkspecial();"
                       ...
                       <div id="product" class="tab-pane table-responsive active">
														...
														<td  id="itemsTable$" class="table table-striped table-bordered" cellspacing="0" width="100%" colspan="5">
															<!-- AddRowDataTable -->
																...
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<tr id= "editdiv" ><td colspan="11"  style="height:1px">
																...
																<tr class="item-row">
																	...
																	<td>	<input type="text" name="ib.partdate"
																		...
																		<input type="hidden" name="ib.aa"
																			style="width: 80px;" value="<s:property value="dcnot[top]"/>" id="aa"
																			tabindex="10" required readonly />
																			
																			
																			<input type="hidden" name="ib.hh"
																			style="width: 80px;" value="<s:property value="dcnot[top]"/>" id="hh"
																			tabindex="10" required   required readonly />


																		<td><input type="text" name="ib.description1"
																			style="width: 250px;" value="<s:property value="descriptiont[top]"/>" id="description1" onblur="fetchalldetails(this);"
																		...
																		<td><input type="text" name="ib.quantity1"
																			style="width: 60px;" id="quantity1" required onblur="calculategst(this);"
																			...
																			style="width: 60px;" id="myrate"  onblur="getAmount(this);calculategst(this);" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"
																			tabindex="11"   required/></td>
																		
																		<td><input type="text" name="ib.amount1" required readonly style="width: 60px;background-color: #e2dfdf"
												...
												<% } %>
																		...
																		<td><input type="text" value="<s:property value="hsncode[top]"/>" readonly  name="ib.ttype"   tabindex="12" 
																			style="width: 60px;background-color: #e2dfdf;" id="ttype"   />
																		</td>
																		
																		<td><input type="text" name="ib.vat1" id="vat1" tabindex="13" required readonly 
																			style="width: 60px;background-color: #e2dfdf;" onblur="calculategst(this);"></td>

																		
																		
																		<td><input name="ib.grate1" id="grate1" value="<s:property value="rate[top]" />"readonly
																			style="width: 60px;background-color: #e2dfdf;" >
																		</td>
																		
																		<td><input name="ib.gstamount1" id="gstamount1" value="<s:property value="netamt[top]" />"readonly
																			style="width: 60px;background-color: #e2dfdf;" >
																		</td>
																		
																		<td><input name="ib.grate2" id="grate2" value="<s:property value="rate[top]" />"readonly
																			style="width: 60px;background-color: #e2dfdf;" >
																		</td>
																		
																		<td><input name="ib.gstamount2" id="gstamount2" value="<s:property value="netamt[top]"/>"readonly
																			style="width: 60px;background-color: #e2dfdf;" >
																		</td>
																		...
																		<td><input name="ib.vatamount1" id="vatamount1" onblur="getnewsrno44(this);" value="<s:property value="gstamt1[top]"/>"  
																		readonly
																		style="width: 60px;background-color: #e2dfdf;" />
                                       ...
                                       <div class="row">
                                               ...
                                               <div class="col-md-3">
                                            	<div class="form-group">
                                                    ...
                                                    <input name="ib.stot" class="form-control" id="stot"  value="<s:property value="totamt"/>" readonly >
                                               ...
                                               <input name="ib.transport" id="transcharge" class="form-control" onblur="totalnetamt();" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
                                                ...
                                                <input name="ib.tamount" class="form-control" id="tamount"  value="<s:property value="totamt"/>" readonly>
                                                </div>
                                       		 </div>
											...
											if(extracolumn=="0"){
												...
												//alert(myflag);
													...
													var $rowTemp = [
															...
															'<input type="hidden" name="ib.aa" style="width: 80px;" value="<s:property value="Aa1[top]"/>" id="aa" tabindex="10" required/>',
															'<td><input style="width:250px;" type="text" name="ib.description1"  id="description1" onblur="fetchalldetails(this);"  required/></td>',
															'<input type="hidden" name="ib.batch1" style="width: 80px;"  id="batch1"  />',
															'<td><input style="width:60px;" type="text"  name="ib.quantity1"  id="quantity1" onblur="calculategst(this);"  onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" required/></td>',
															puc,
															'<td><input style="width:60px;" type="text"  name="ib.myrate"  id="myrate" onblur="getAmount(this);calculategst(this);"  required onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"/></td>',
															'<td><input readonly style="width: 60px;background-color: #e2dfdf;" type="text" name="ib.amount1"   id="amount1" readonly   onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;"/></td>',
															  myflag11,
										                        myflag22,
										                        myflag33,
															'<td><input type="text"  readonly style="width: 60px;background-color: #e2dfdf;" value="" name="ib.ttype"   required id="ttype" ></td>',
															'<td><input readonly style="width: 60px;background-color: #e2dfdf;" type="text" name="ib.vat1"    id="vat1" onblur="calculategst(this);" required/></td>',
															'<td><input type="text"  readonly style="width: 60px;background-color: #e2dfdf;"  name="ib.grate1" id="grate1" readonly required></td>',
															'<td><input type="text"  readonly style="width: 60px;background-color: #e2dfdf;"  name="ib.gstamount1" id="gstamount1" readonly required></td>',
															'<td><input type="text"  readonly style="width: 60px;background-color: #e2dfdf;"  name="ib.grate2" id="grate2" readonly required></td>',
															'<td><input type="text"  readonly style="width: 60px;background-color: #e2dfdf;"  name="ib.gstamount2" id="gstamount2" readonly required></td>',
															
															'<td><input readonly style="width: 60px;background-color: #e2dfdf;" type="text" name="ib.vatamount1"   id="vatamount1" value=""  onblur="getnewsrno44(this);" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;" required/></td>',
