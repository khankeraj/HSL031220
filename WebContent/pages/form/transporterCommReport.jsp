				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Transporter Commission Report</h3>
						</div>
						
						<div class="panel-body">
						<form action="transporter_commission_Reports1" method="post">
							<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<label class="control-label">Transporter Name:</label>
														...
														<input type="text" class="form-control" placeholder="" name="transporter_name"  id="transporter_name" value=""  class="form-control" >
												</div>
											</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${deliveryDetails}" var="paymentDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${paymentDetails.transporter_name}" /></td>
										<td><c:out value="${paymentDetails.trip_id}" /></td>
										<td><c:out value="${paymentDetails.updown_id}" /></td>
										<td><c:out value="${paymentDetails.lr_number}" /></td>
										<td><c:out value="${paymentDetails.customer_name}" /></td>
										<td><c:out value="${paymentDetails.date}" /></td>
										<td><c:out value="${paymentDetails.source}" /></td>
										<td><c:out value="${paymentDetails.destination}" /></td>
										<td><c:out value="${paymentDetails.commision}" /></td>
