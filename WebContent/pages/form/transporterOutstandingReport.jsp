...
<script type="text/javascript" language="javascript" class="init">
	...
	<script>
		function deleteFun(route_id){
			//alert(route_id);
			var link = "DeleteRouteMaster?route_id="+route_id;
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Transporter Outstanding Report</h3>
						</div>
								...
								<tbody>
								 ...
								 <c:forEach items="${paymentDetails}" var="paymentDetails">
									<tr>
										...
										<td><c:out value="${paymentDetails.company}" /></td>
										<td><c:out value="${paymentDetails.city}" /></td>
										<td><c:out value="${paymentDetails.transporter_address}" /></td>
										<td><c:out value="${paymentDetails.transporter_mobile}" /></td>
										<td><c:out value="${paymentDetails.amt2}" /></td>
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${routeMasterDetails.route_id}" />);"></a>
									   </td> --%>
