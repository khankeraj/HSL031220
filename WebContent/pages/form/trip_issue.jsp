	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">LR Issue Form</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">LR Issue Form</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form id="form1" action="insert_tripissue_action" method="POST">
								      ...
								      <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="driver_name" id="driver_name" value="${driver_name}"   class="form-control" required>
												</div>
											</div>
									  ...
									  <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="exp_parti" id="exp_parti" onblur="checkPump(this);"   class="form-control" required>
												</div>
											</div>
