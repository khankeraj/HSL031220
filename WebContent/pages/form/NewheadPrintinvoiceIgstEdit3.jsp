				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_invoice_Customer_Igsthead" class="form-control" name="formid" id="formid" method="POST">
															...
															<!-- AddRowDataTable -->
																...
																<tr class="item-row">
																	...
																	<td>	<input type="text" name="ib.partdate"
																		...
																		<td><input type="text" name="ib.amount1" required readonly value="<s:property value="myamt[top]"/>"
                                       ...
                                       <div class="row">
                                               ...
                                               <div class="col-md-3">
                                            	<div class="form-group">
                                                    ...
                                                    <input name="ib.stot" class="form-control" id="stot"  value="<s:property value="tps"/>" >
											...
											if(extracolumn=="0"){
												...
												//alert(myflag);
													...
													var $rowTemp = [
															...
															'<td><input type="text" name="ib.aa" style="width: 80px;" value="<s:property value="Aa1[top]"/>" id="aa" tabindex="10" required/></td>',
