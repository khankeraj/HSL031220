...
<!--   <script>
	...
	var currentURL = "VendorBillView?invoice="+invoiceno+"&type="+type+"";
	
		var okdelete = confirm("Are You Sure You Want To View The Bill..!");
...
<script>
	...
	var currentURL = "VendorBillEdit?invoice="+invoiceno+"&type="+type+"";
	
		var okdelete = confirm("Are You Sure You Want To Edit The Bill..!");
 ...
 <!-- <script>
	function approve(invoiceno,order_id,name,amount,despatch_id) {

	var currentURL = "BillApproveAdmin?invoiceno="+invoiceno+"&order_id="+order_id+"&name="+name+"&amount="+amount+"&despatch_id="+despatch_id+"";
	
		var okdelete = confirm("Are You Sure You Want To Approve Bill..!");
...
<script>
	function view(order_id,total) {

	var currentURL = "OrderViewBill?order_id="+order_id+"&total="+total+"";
				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Vendor Bill  Report</h3>
						</div>
