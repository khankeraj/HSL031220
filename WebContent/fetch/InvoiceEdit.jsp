...
document.getElementById('invoiceno').value = vz;
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Add_invoice" class="form-control" method="POST">
									...
									<div class="row">
                                               ...
                                               <div class="col-md-4">
                                            	<div class="form-group">
                                                    ...
                                                    <input type="text" size="30"  value="${invoice}"  class="form-control"  name="invoiceno" id="invoiceno" readonly/> 
                                   ...
                                   <div class="row">
									...
									<div class="row">
                                               ...
                                               <input type="text" value="<s:property value="podate"/>" class="form-control" name="podate" id="podate"  onblur="FixShortDate(this);return ValidateForm(this);" />
                                                </div>
                                       		 </div>
                       ...
                       <div id="product" class="tab-pane table-responsive active">
															...
															<!-- AddRowDataTable -->
																...
																<tr class="item-row">
																	...
																	<td>	<input type="text" name="ib.partdate"
																		...
																		<input type="hidden" name="ib.batch1" style="width: 80px;" value="<s:property value="batcht[top]"/>" id="batch1"  />
                                       ...
                                       <div class="row">
                                               ...
                                               <div class="col-md-3">
                                                ...
                                                <input name="ib.freight" value="<s:property value="freight"/>" class="form-control" id="freight"   onblur="totalnetamt();" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
                                                </div>
                                       		 </div>
                                               ...
                                               <input name="ib.transport" value="<s:property value="transport"/>" id="transcharge" class="form-control" onblur="totalnetamt();" onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
                                                </div>
                                       		 </div>
                                                ...
                                                <input name="ib.tamount" class="form-control" id="tamount" readonly value="<s:property value="totamt"/>">
                                                </div>
                                       		 </div>
