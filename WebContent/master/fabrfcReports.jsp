					...
					<div class="panel">
						...
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${fabrfc1}" var="fabrfc1">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${fabrfc1.quotation_name}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdateFABRFC?fabrfc_id=<c:out value="${fabrfc1.fabrfc_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteFABRFC?fabrfc_id=<c:out value="${fabrfc1.fabrfc_id}" />">
