				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">FAB Labeling MC Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${fablabel}" var="fablabel">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${fablabel.quotation_name}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" href="updateLAbelingmcDetails?labeling_id=<c:out value="${fablabel.labeling_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" href="DeleteFABLabelingmc?labeling_id=<c:out value="${fablabel.labeling_id}" />">
