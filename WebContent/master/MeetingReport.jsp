				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Meeting Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<%int i=1; %>
									<c:forEach items="${meetingForm1}" var="meetingForm1">
									<tr>
									<td><%=i++ %></td>
									<td><c:out value="${meetingForm1.customer_name}" /></td>
									<td><c:out value="${meetingForm1.contact_no}" /></td>
									<td><c:out value="${meetingForm1.requiredDate}" /></td>
									<td><c:out value="${meetingForm1.meeting_status}" /></td>
									<td><c:out value="${meetingForm1.next_meeting_date}" /></td>
									<td><c:out value="${meetingForm1.description}" /></td>
									<td><c:out value="${meetingForm1.remark}" /></td>
									<td><c:out value="${meetingForm1.amount}" /></td>
									
									<td align="center"><a title="Quotation" style="text-decoration: none;color: green;" href="quotationReports?lead_no=<c:out value="${meetingForm1.lead_no}" />&customer_name=<c:out value="${meetingForm1.customer_name}" />"">
										<img alt="Quotation" height="25px;" src="configure/img/report.svg"></a>
								   </td>
									
									<td align="center"><a  title="Update" style="text-decoration: none;color: green;" href="editMeetingForm?lead_no=<c:out value="${meetingForm1.lead_no}" />">
										<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>
								   </td>
								   
									<td align="center"><a title="Delete" style="text-decoration: none;color: red;" href="delete_meeting_form?lead_no=<c:out value="${meetingForm1.lead_no}" />">
