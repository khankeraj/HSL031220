				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="fabrfc" method="POST">
                                    ...
                                    <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name_of_quotation"  class="form-control"> </div>
                                            </div>
                                    </div>
                                        
									<s:iterator value="fabrfc1">
									<div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Name Of Index :
                                                    </label>
                                                    <input type="text" class="form-control" name="fab_rfc_name" value="${fab_rfc_name}" class="form-control"> </div>
                                            </div>
                                             ...
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="fab_rfc_subname" value="${fab_rfc_subname}" class="form-control" required> </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" value="${select_image}" id="select_image" name="select_image" class="form-control"> </div>
                                            </div>
                                        </div>
                                        </s:iterator>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="${heading1}" name="heading1" class="form-control"> </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="${heading2}" name="heading2" class="form-control"> </div>
                                            </div>
                                        </div>
                                        </s:iterator>
                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="${heading3}" name="heading3" class="form-control"> </div>
                                            </div>
                                        </div>
                                        </s:iterator>
