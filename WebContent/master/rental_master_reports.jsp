						...
						<div class="panel-body">
							<table id="demo-dt-basic"
								...
								<tbody>
									...
									int i = 1;
									%>
									<c:forEach items="${rentalMasterDetails}"
										var="rentalMasterDetails">
										<tr>
											<td><%=i++%></td>
											<td><c:out value="${rentalMasterDetails.rental_name}" /></td>
											<td><c:out
													value="${rentalMasterDetails.rental_description}" /></td>

											<td align="center"><a
												style="text-decoration: none; color: green;" title="Update"
												href="UpdateRentalMaster?rental_id=<c:out value="${rentalMasterDetails.rental_id}" />">
													<img alt="Update" src="configure/img/pencil.png">
											</a></td>

											<td align="center"><a
												style="text-decoration: none; color: red;" title="Delete"
												href="DeleteRentalMaster?rental_id=<c:out value="${rentalMasterDetails.rental_id}" />">
													<img alt="" height="20px;"
													src="configure/img/recycle-bin.svg">
											</a> <%--    <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
