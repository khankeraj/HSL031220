...
<head>
	...
	<script>
		function deleteFun(employee_id){
			//alert(employee_id);
			var link = "DeleteEmployeeMaster?employee_id="+employee_id;
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					...
					<br>
					<a href="EmployeeMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
					
						<div class="panel-heading">
							<h3 class="panel-title">Employee Master Report</h3>
						</div>
						<div class="panel-body" style="overflow-x:auto;">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<%int i=1; %>
									<c:forEach items="${fetchEmployeeDetails}" var="fetchEmployeeDetails">
									<tr>
									<td><%=i++ %></td>
									<td><c:out value="${fetchEmployeeDetails.employee_name}" /></td>
									<td><c:out value="${fetchEmployeeDetails.address}" /></td>
									<td><c:out value="${fetchEmployeeDetails.mobile_no}" /></td>
									<td><c:out value="${fetchEmployeeDetails.date_of_joining}" /></td>
									<td><c:out value="${fetchEmployeeDetails.date_of_birth}" /></td>
									<td><c:out value="${fetchEmployeeDetails.designation}" /></td>
									<td><c:out value="${fetchEmployeeDetails.bank_name}" /></td>
									<td><c:out value="${fetchEmployeeDetails.account_no}" /></td>
									<td><c:out value="${fetchEmployeeDetails.ifsc_code}" /></td>
									<td><c:out value="${fetchEmployeeDetails.remark}" /></td>
									
									<td align="center"><a  title="Update" style="text-decoration: none;color: green;" href="UpdateemployeeMaster?employee_id=<c:out value="${fetchEmployeeDetails.employee_id}" />">
										<img alt="Edit"  src="configure/img/pencil.png"></a>
								   </td>
								   
									<%-- <td align="center"><a title="Delete" style="text-decoration: none;color: red;" href="DeleteEmployeeMaster?employee_id=<c:out value="${fetchEmployeeDetails.employee_id}" />">
										<img alt="Delete" height="20px;" src="configure/img/recycle-bin.svg"></a>
								   </td> --%>
								   
								   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${fetchEmployeeDetails.employee_id}" />);"></a>
								   </td>
