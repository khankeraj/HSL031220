...
<head>
	...
	<script>
		function deleteFun(transporter_id){
			//alert(designation_id);
			var link = "DeleteTransporterMaster?transporter_id="+transporter_id;
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					...
					<br>
					<a href="TransportMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
					
						<div class="panel-heading">
							<h3 class="panel-title">Transporter Master Report</h3>
						</div>
						<div class="panel-body" style="overflow-x:auto;">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${transporterMasterDetails}" var="transporterMasterDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${transporterMasterDetails.transporter_no}" /></td>
										<td><c:out value="${transporterMasterDetails.transporter_name}" /></td>
										<td><c:out value="${transporterMasterDetails.company_name}" /></td>
										<td><c:out value="${transporterMasterDetails.transporter_address}" /></td>
										<td><c:out value="${transporterMasterDetails.transporter_mobile}" /></td>
										<td><c:out value="${transporterMasterDetails.phone_no}" /></td>
										<td><c:out value="${transporterMasterDetails.state}" /></td>
										<td><c:out value="${transporterMasterDetails.city}" /></td>
										<td><c:out value="${transporterMasterDetails.pan_no}" /></td>
										<td><c:out value="${transporterMasterDetails.pincode_no}" /></td>
										<td><c:out value="${transporterMasterDetails.email}" /></td>
										<td><c:out value="${transporterMasterDetails.bank_name}" /></td>
										<td><c:out value="${transporterMasterDetails.account_no}" /></td>
										<td><c:out value="${transporterMasterDetails.ifsc_code}" /></td>
										<td><c:out value="${transporterMasterDetails.remark}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdatetransporterMaster?transporter_id=<c:out value="${transporterMasterDetails.transporter_id}" />">
											<img alt="Update" src="configure/img/pencil.png"></a>
									   </td>
										<%-- <td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteDesignationMaster?designation_id=<c:out value="${designationMasterDetails.designation_id}" />">
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${transporterMasterDetails.transporter_id}" />);"></a>
									   </td>
