		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					...
					<br>
					<a href="RouteMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
					
						<div class="panel-heading">
							<h3 class="panel-title">Route Master Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${routeMasterDetails}" var="routeMasterDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${routeMasterDetails.route}" /></td>
