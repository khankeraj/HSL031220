				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Shrink Machine Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${shmcreports}" var="shmcreports">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${shmcreports.quotation_name}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" href="UpdateShrinkMachine?shrink_id=<c:out value="${shmcreports.shrinkmc_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" href="DeleteShrinkMachine?shrink_id=<c:out value="${shmcreports.shrinkmc_id}" />">
