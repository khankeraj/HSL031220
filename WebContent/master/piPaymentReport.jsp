				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">PI Payment Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<%int i=1;%>
									<c:forEach items="${piPaymentReport}" var="piPaymentReport">
									<tr>
									<td><%=i++%></td>
									<td><c:out value="${piPaymentReport.customer_name}" /></td>
									<td><c:out value="${piPaymentReport.reqDate}" /></td>
									<td><c:out value="${piPaymentReport.paidAmount}" /></td>
									<td align="center"><a title="PO" style="text-decoration: none;color: red;" href="purchase_order?pi_payment_no=<c:out value="${piPaymentReport.invoice_no}" />&lead_no=<c:out value="${piPaymentReport.lead_no}" />">
										<img alt="Payment" height="25px;" src="configure/img/purchase-order.svg"></a>
								   </td>
								   <td align="center"><a title="gatePass" style="text-decoration: none;color: red;" href="gatePass?pi_payment_no=<c:out value="${piPaymentReport.invoice_no}" />&lead_no=<c:out value="${piPaymentReport.lead_no}" />">
										<img alt="Payment" height="25px;" src="configure/img/id-card.svg">
									</tr>
									</c:forEach>
								</tbody>
							</table>
