	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					<input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='taxMaster'"/>
				</div>
				<div id="page-content">
					<div class="panel">
						...
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${fetchTaxRepo}" var="fetchTaxRepo">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${fetchTaxRepo.tax_per}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdateTax?tax_id=<c:out value="${fetchTaxRepo.id}" />">
											<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="Tax_Delete?tax_id=<c:out value="${fetchTaxRepo.id}" />">
