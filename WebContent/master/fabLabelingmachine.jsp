				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="fab_labelling_machine" method="POST">
	                                ...
	                                <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"  name="quotation_name" class="form-control"> </div>
                                            </div>
                                      </div>
	                                
	                                
									
									<s:iterator value="fablabelingmc1">
									<div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Name Of Index :
                                                    </label>
                                                    <input type="text" class="form-control" value="${fab_labeling_name}" name="fab_labeling_name" class="form-control"> </div>
                                            </div>
                                             ...
                                             <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="${fab_labeling_subname}" name="fab_labeling_subname" class="form-control" required> </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" id="sscUpload" value="${select_image}" name="select_image"> </div>
                                            </div>
                                      </div>
                                      </s:iterator>
													...
													<tr>
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<s:iterator value="fablabelingmc2">
																		<tr class="item-row">
																			<td><a id="deleteRow"><img src="configure/img/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="heading" value="${heading}" class="form-control"> </div>
                                            </div>
                                        </div>
                                        </s:iterator>
													...
													<tr>
														<td colspan="5">
																<table id="itemsTable1" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<s:iterator value="fablabelingmc3">
																	<tr class="item-row">
																		<td><a id="deleteRow"><img src="configure/img/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
