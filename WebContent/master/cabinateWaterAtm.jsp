											...
											function addRows(e) {
												try {
													...
													var $rowTemp = [
															...
															'<td><input  type="text" class="form-control" name="atm_deatils"/></td>',
															'</tr>' ].join('');
													var $row = $($rowTemp);
													$.currentRow = $row;
	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Cabinet Water ATM</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">Cabinet Water ATM</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="CabinateWaterATMMaster" method="POST">
									...
									<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name_of_index"  class="form-control" required> </div>
                                            </div>
														...
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	<tr>
																		...
																		<th id="VLsparename"><label>Cabinet Water Atm Details </label></th>
																	</tr>
																	<tr class="item-row">

																		<td></td>
																		<td><input type="text" name="atm_deatils" class="form-control">
																		</td>	
																	</tr>
																</table>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="sub_name_of_index"  class="form-control" > </div>
                                            </div>
                                        </div>
														...
														<td colspan="5">
																<table id="subname" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<tr class="item-row">
																		...
																		<td></td>
																		<td><input type="text" name="specifications" class="form-control">
																		</td>	
