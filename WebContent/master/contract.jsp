		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					...
					<!-- <input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='contractForm'"/> -->
					...
					<div class="panel">
						...
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${contractor}" var="contractor">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${contractor.ref_no}" /></td>
										<td><c:out value="${contractor.contact}" /></td>
										<td><c:out value="${contractor.email}" /></td>
										<td><c:out value="${contractor.subject}" /></td>
									   <td align="center"><a style="text-decoration: none;color: green;" title="Update" href="contract_edit_Master?customer_id=<c:out value="${contractor.cust_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
									   
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="delete_contractor?customer_id=<c:out value="${contractor.cust_id}" />">
