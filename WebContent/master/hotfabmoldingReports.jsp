				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">HOT FABMolding Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${hotfabReports}" var="hotfabReports">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${hotfabReports.quotation_name}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdateHOTFABMoldingmc?hotfabmolding_id=<c:out value="${hotfabReports.htfab_moldingId}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteHotFABMoldingmc?hotfabmolding_id=<c:out value="${hotfabReports.htfab_moldingId}" />">
