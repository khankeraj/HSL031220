	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					<!-- <input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='QuotationMaster'"/> -->
				</div>
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Quotation Name Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${quotationNameModel1}" var="quotationNameModel1">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${quotationNameModel1.quotation_name}" /></td>
									   <td align="center"><a style="text-decoration: none;color: green;" title="Update" href="Quotation_name_update?quotation_name_id=<c:out value="${quotationNameModel1.quotation_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
									   
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="Delete_quotation_name?quotation_name_id=<c:out value="${quotationNameModel1.quotation_id}" />">
