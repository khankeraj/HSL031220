									...
									<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="customer_name"  id="name"   class="form-control" >
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="date"  onblur="FixShortDate(this);return ValidateForm(this);"  class="form-control" >
												</div>
											</div>
