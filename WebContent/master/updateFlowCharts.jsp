				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="updateFlowChartMaster" method="POST">
									<div class="panel-body">
									
									<s:iterator value="flowChart2">
									 <div class="row">
                                            <div class="col-md-6">
										...
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="update_flowCharts" value="${flow_chart_id}">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control"  id="sscUpload" name="image" onkeyup="this.value=this.value.toUpperCase()" class="form-control"> </div>
                                            </div>
                                  		  </div>
                                  		  </s:iterator>
