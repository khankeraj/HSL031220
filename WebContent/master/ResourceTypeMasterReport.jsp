...
<script>
	...
	var currentURL = "Delete_ResourceTypeMaster?id="+id+"";
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					 ...
					 <input type="Button" class="btn btn-primary" value="Add New" onClick="location.href='ResourceTypeMaster'"/>
				
				</div>
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Resource Type Master Report</h3>
						</div>
								...
								<tbody>
								 ...
								 <c:forEach items="${ProductReport}" var="ProductReport">
									<tr>
										...
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="Edit_ResourceTypeMaster?id=<c:out value="${ProductReport.id}" />">
