				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="update_Meeting_From_Details" method="POST">
									<div class="panel-body">
									<s:iterator value="meetingForm2">
									  <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Customer Name :</label>
													<input type="hidden"name="update_meeting_id" value="${cust_id}">
										...
										<div class="row">
										  <div class="col-sm-6">
											<div class="form-group">
												...
												<input type="date" placeholder="" name="next_meeting_date" value="${next_meeting_date}" style="line-height: 15px;" class="form-control" required>
											</div>
										  </div>
										  ...
										  <div class="col-sm-6">
										    <div class="form-group">
												...
												<input type="text" placeholder=""  autocomplete="off" value="${description}" name="description" class="form-control" required>
										    </div>
										  </div>
										 </div>
