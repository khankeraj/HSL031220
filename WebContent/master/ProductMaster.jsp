								      ...
								      <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="product_name"    class="form-control" required>
												</div>
											</div>
								      ...
								      <div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="tax_percentage"   class="form-control" required>
												</div>
											</div>
