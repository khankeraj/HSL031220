...
<head>
	...
	<script>
		function deleteFun(product_id){
			//alert(product_id);
			var link = "DeleteProductMaster?product_id="+product_id;
		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					...
					<br>
					<a href="ProductMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
					
						<div class="panel-heading">
							<h3 class="panel-title">Product Master Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${productMasterDetails}" var="productMasterDetails">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${productMasterDetails.product_name}" /></td>
										<td><c:out value="${productMasterDetails.remark}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdateproductMaster?product_id=<c:out value="${productMasterDetails.product_id}" />">
											<img alt="Update" src="configure/img/pencil.png"></a>
									   </td>
										<%-- <td align="center"><a style="text-decoration: none;color: red;" title="Delete" href="DeleteProductMaster?product_id=<c:out value="${productMasterDetails.product_id}" />">
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${productMasterDetails.product_id}" />);"></a>
									   </td>
