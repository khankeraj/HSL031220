				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="Update_VehicleTypeMaster" id="submitForm" method="POST" >
									...
									<div class="row">
							            ...
							            <div class="col-md-6">
							              <div class="form-group">
							                ...
							                <input type="text" class="form-control"  value="${model}" name="model"  id="model" required/>
							              </div>
							            </div></div>
							          ...
							          <div class="row">
							             <div class="col-md-6">
							              <div class="form-group">
							                ...
							                <input type="text" class="form-control" value="${halt_charge}" name="halt_charge"  id="halt_charge" required/>
							              </div>
							            </div>
							                ...
							                <input type="hidden" class="form-control"  value="${no_of_box}" name="no_of_box"  placeholder="No Of Box" />
							             
							                <input type="hidden" class="form-control"  value="${no_of_bag}" name="no_of_bag"  placeholder="No Of Bag" />
