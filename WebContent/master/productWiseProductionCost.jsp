				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="ProductWiseProductionCostMaster" method="POST">
										...
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="quotation_name" value="${name_of_index}" class="form-control" required> </div>
                                            </div>
                                            </div>
										
									<s:iterator value="pwpc">	
										<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Name Of Index :
                                                    </label>
                                                    <input type="text" class="form-control" name="name_of_index" value="${name_of_index}" class="form-control" required> </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="heading1" value="${heading1}" class="form-control" required> </div>
                                            </div>
                                       </div>
                                       </s:iterator>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="heading2" value="${heading2}" class="form-control" required> </div>
                                            </div>
                                  		  </div>
                                  		 </s:iterator>
