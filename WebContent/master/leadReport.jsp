...
<head>
	...
	<script>
function viewImage() {
		var viewImage=document.getElementById("viewImageID").value;
			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="panel-heading">
							<h3 class="panel-title">Lead Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-selection" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
									<%int i=1; %>
								 <c:forEach items="${leadForm1}" var="leadForm1">
								 <tr>
								 	<td><%=i++ %></td>
								 	<td><c:out value="${leadForm1.customer_name}" /></td>
								 	<td><c:out value="${leadForm1.contact_no}" /></td>
								 	<td><c:out value="${leadForm1.product}" /></td>
								 	<td><c:out value="${leadForm1.amount}" /></td>
								 	<td><c:out value="${leadForm1.city}" /></td>
								 	<td><c:out value="${leadForm1.zone}" /></td>
								 	<td><c:out value="${leadForm1.area}" /></td>
								 	<td><c:out value="${leadForm1.requiredDate}" /></td>
								 	<td>
						 				<a>
										<input type="hidden" value="${leadForm1.image}" id="viewImageID">
											<img class="media-object" height="25px;" src="configure/img/photo-button.svg" onclick="viewImage()" alt="img" title="image"  style="max-width:30%;height:20;hidden;border:none;padding:0;margin:0 auto;display:block;"   >
				  						</a>&nbsp;</td> 
								 	 <td align="center"><a style="text-decoration: none;" title="Meeting-Form" href="meetingFormLinkToLeadLead?lead_no=<c:out value="${leadForm1.lead_serial_no}" />">
											<img alt="Meeting Form" height="25px;" src="configure/img/meeting.svg"></a>
									   </td>
								 	
									<td align="center"><a style="text-decoration: none;color: green;" href="editLeadForm?lead_no=<c:out value="${leadForm1.lead_serial_no}" />">
										<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>
								   </td>
								   
									<td align="center"><a style="text-decoration: none;color: red;" href="deleteLeadForm?lead_no=<c:out value="${leadForm1.lead_serial_no}" />">
										<img alt="Delete" height="25px;" src="configure/img/delete.svg"></a>
								    </td>
