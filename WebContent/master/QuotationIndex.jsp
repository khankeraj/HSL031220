				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="InsertQuotationIndex" method="POST">
									...
									<div class="row">
												...
												<div class="col-md-6">
	                                                <div class="form-group">
	                                                    ...
	                                                    <input type="text" class="form-control" id="roWater" name="quotation_name" class="form-control" required> 
	                                                </div>
	                                            </div>
