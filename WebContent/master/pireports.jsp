				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">PI Report</h3>
						</div>
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								<%int i=1; %>
									<c:forEach items="${fetchpidetails}" var="fetchpidetails">
									<tr>
									<td><%=i++ %></td>
									<td><c:out value="${fetchpidetails.customer_name}" /></td>
									<td><c:out value="${fetchpidetails.date}" /></td>
									<td><c:out value="${fetchpidetails.total}" /></td>
									<td align="center"><a title="Payment" style="text-decoration: none;color: red;" href="cup?invoice_no=<c:out value="${fetchpidetails.invoiceno}" />&lead_no=<c:out value="${fetchpidetails.lead_no}" />&customer_name=<c:out value="${fetchpidetails.customer_name}" />&total=<c:out value="${fetchpidetails.total}" />">
										<img alt="Payment" height="25px;" src="money.svg"></a>
								   </td>
									</tr>
									</c:forEach>
								</tbody>
