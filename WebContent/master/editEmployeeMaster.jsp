			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							...
							<form action="update_employee_master_details" method="POST">
								<div class="panel-body">
								<s:iterator value="fetchEmployeeDetails">
								      <div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Employee Name:</label>
													<input type="hidden" class="form-control" placeholder="" name="employee_id" value="${employee_id}"   class="form-control" required>
													<input type="text" class="form-control" placeholder="" name="employee_name" value="${employee_name}"   class="form-control" required>
												</div>
											</div>
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="" name="address" value="${address}"  class="form-control" required>
												</div>
											</div>
									  </div>
									  ...
									  <div class="col-sm-6">
											<div class="form-group">
												...
												<input type="text" placeholder=""  name="mobile_no" value="${mobile_no}" class="form-control" pattern="[0-9]*" maxlength="10" onblur="phoneNumberCheck(this);"  required>
											</div>
										</div>
											<div class="col-sm-6">
												<div class="form-group">
													<label class="control-label">Date Of Joining :</label>
													<input type="date" placeholder=""  name="date_of_joining" value="${date_of_joining}" style="line-height: 15px;"  class="form-control" required>
												</div>
											</div>
									  </div>
									 ...
									 <div class="row">
											...
											<div class="form-group">
												...
												<input type="date" placeholder=""  style="line-height: 15px;" value="${date_of_birth}" name="date_of_birth" class="form-control" required>
											</div>
										  </div>
										   <div class="col-sm-6">
										    <div class="form-group">
												<label class="control-label">Designation :</label> 
												<input type="text" placeholder=""  autocomplete="off" name="designation" value="${designation}" id="designation"  class="form-control" required>
										    </div>
										  </div>
									</div>
