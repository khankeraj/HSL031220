				...
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">LCM Report</h3>
						</div>
							...
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 ...
								 <c:forEach items="${labList}" var="labList">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${labList.quotation_name}" /></td>
										<td align="center"><a style="text-decoration: none;color: green;" href="UpdateLCMDetails?updatelcm_id=<c:out value="${labList.lab_id}" />">
											<i class="fa fa-edit (alias)"></i></a>
									   </td>
										<td align="center"><a style="text-decoration: none;color: red;" href="DeleteLCMDetails?updatelcm_id=<c:out value="${labList.lab_id}" />">
