		...
		<div class="boxed">
			<div id="content-container">
				...
				<div id="page-content">
					<div class="panel">
					<br>
					<a href="CityMaster"><button style="margin-left: 20px; height: 30px; width: 100px;">Add New</button></a>
								...
								<tbody>
								 ...
								 <c:forEach items="${cityMasterDetails}" var="cityMasterDetails">
									<tr>
										...
										<td align="center"><a style="text-decoration: none;color: green;" title="Update" href="UpdatecityMaster?city_id=<c:out value="${cityMasterDetails.city_id}" />">
									   ...
									   <td align="center"><a style="text-decoration: none;color: red;" title="Delete" >
											<img alt="" height="20px;" src="configure/img/recycle-bin.svg" onclick="deleteFun(<c:out value="${cityMasterDetails.city_id}" />);"></a>
									   </td>
