	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">RO Technical Specifications</h1>
				</div>
				<!--End page title-->
				...
				<ol class="breadcrumb">
					...
					<li class="active">RO Technical Specifications</li>
				</ol>
				<!--End breadcrumb-->
				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="ReverseOsmosisWaterTPTechSP" method="POST">
									...
									<div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="rosp_name" class="form-control"> </div>
                                            </div>
                                           ...
                                           <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="rosp_subname" class="form-control" required> </div>
                                            </div>
														...
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	...
																	<tr class="item-row">
																		...
																		<td></td>
																		<td><input type="text" name="ro_techSPefic" class="form-control">
																		</td>	
																		<td><input name="ro_techQuanty" class="form-control">
																		</td>
																	</tr>
																</table>
