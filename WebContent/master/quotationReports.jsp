			...
			<div id="content-container">
				...
				<div id="page-content">
						...
						<div class="panel-heading">
							<h3 class="panel-title">Quotation View Report</h3>
						</div>
						...
						<div class="panel-body">
							<table id="demo-dt-selection" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<c:forEach items="${quotationList}" var="quotationList">
									<tr>
										<td><%=i++ %></td>
										<td><c:out value="${quotationList.cust_name}"/></td>
										<td><a title="View Quotation" href="ViewQuotationPrintsDetails?quotation_id=<c:out value="${quotationList.quotation_id}"/>"><img alt="" height="30px;" src="configure/img/eye (1).svg""></a></td>
										<td><a title="Edit" href="EditquotationReports?quotation_edit_id=<c:out value="${quotationList.quotation_id}"/>&lead_no=<c:out value="${quotationList.lead_no}"/>"><img alt="" height="30px;" src="configure/img/pencil.svg"></a></td>
										<td><a title="Finalization" href="FinalizationQuotation?quotation_edit_id=<c:out value="${quotationList.quotation_id}"/>&lead_no=<c:out value="${quotationList.lead_no}"/>"><img alt="" height="30px;" src="configure/img/completed-tasks.svg"></a></td>
									</tr>
								</c:forEach>
								</tbody>
							</table>
