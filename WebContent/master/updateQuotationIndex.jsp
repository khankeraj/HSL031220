				...
				<div id="page-content">
						...
						<div class="col-lg-12">
							<div class="panel">
								...
								<form action="UpdateQuoQuotationIndex" method="POST">
									<div class="panel-body">
									
									<s:iterator value="quoIndex">
									<div class="row">
									       <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Name Of Quotation :
                                                    </label>
                                                    <input type="text" name="quotation_name" value="${quotation_name}" onkeyup="this.value=this.value.toUpperCase()" class="form-control" required> </div>
                                          </div>
                                          <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Name Of Index :
                                                    </label>
                                                    <input type="hidden" name="update_quo_index" value="${index_id}">
														...
														<td colspan="5">
																<table id="itemsTable" class="table table-striped table-bordered" cellspacing="0" width="100%">
																	<tr>
																		...
																		<th id="VLsparename"><label>Sub Name Of Index </label></th>
																	</tr>
																	
																	<s:iterator value="quoIndex1">
																	<tr class="item-row">
																		<td><a id="deleteRow"><img src="configure/img/icon-minus.png" alt="Remove Item" title="Remove Item"></a></td>
																		<td><input type="text" value="${subindex}" name="sub_name_of_index" class="form-control">
																		</td>	
																	</tr>
																	</s:iterator>
