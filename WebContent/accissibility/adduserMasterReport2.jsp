...
<script>
	...
	var currentURL = "Delete_user?id="+id+"";
		...
		<div class="boxed">
			<div id="content-container">
				<div id="page-title">
					 ...
					 <input type="Button" class="btn btn-primary" value="Add User" onClick="location.href='NewUser'"/>
					...
					<div class="panel">
						...
						<div class="panel-body">
							<table id="demo-dt-basic" class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
								 <%int i=1; %>
								 <c:forEach items="${areamaster}" var="areamaster">
									<tr>
									
									<td><%=i++ %></td>
										<td><c:out value="${areamaster.user_name}" /></td>
									 	<td><c:out value="${areamaster.user_type}" /></td>
										 <td><c:out value="${areamaster.user_contact}" /></td>
										 <td><c:out value="${areamaster.user_password}" /></td>
										 
									   <td align="center"><a style="text-decoration: none;color: green;" title="Update" href="Edit_userMaster?id=<c:out value="${areamaster.uid}" />">
											<img alt="Edit" height="25px;" src="configure/img/editmeeting.svg"></a>
									   </td>
									   
										<td align="center"><a style="text-decoration: none;color: red;" title="Delete" onclick="delet('<c:out value="${areamaster.uid}" />')">
