...
<span>
<span ><font  face="caibri" size="3px;">		Original</font>
<input type="button" name="Print"
			...
			<input type="button" name="Print"
			id="Print1" value="Print Without Stamp" class="NFButton" onclick="printData1()"><img
			src="img/0.png" class="NFButtonRight">
			
</span>
<span style="float:right">
<font  face="caibri" size="3px;">		(Consignor/Consignee/Driver/Account)</font>
</span>
...
<font face="caibri" size="2px"><s:property value="owner_risk" /></font>
	...
	<c:forEach items="${tripDetails}" var="tripDetails">
						...
						<tr>
							...
							<td align="center" 	style="border-right: 1px solid #787f7a;padding-right:5px;width:5%;"><font face="caibri" size="2px"><c:out value="${tripDetails.aa1}"/></font></td>

							<td align="center" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="2px"><c:out value="${tripDetails.bb1}"/></font></td>
							<td align="center" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="2px"><c:out value="${tripDetails.cc1}"/></font></td>
							...
							<td align="center" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="2px"><c:out value="${tripModel.ff[loop.index]}"/></font></td>
							 --%>
							<td align="center" 	style="border-right: 1px solid #787f7a;"><font face="caibri" size="2px"><c:out value="${tripDetails.gg1}"/></font></td>
...
<center><img src="configure/img/sign.jpg" width="150px" id="myimg"></center>
</td>
...
<td width="20%" valign="top" align="center" style="border-right:1px solid #787f7a;">
&nbsp;
</td>
...
<td width="30%" valign="top" align="center" style="border-left:1px solid #787f7a;border-bottom:1px solid #787f7a;" >
&nbsp;
</td>
...
IT SHALL BE THE ABSOLUTE RESPONSIBILLITY OF CONSIGNOR TO INSURE THE
GOODS MEANT FOR TRANSPORTAIONS OTHERWISE CARRIER WOULD NOT BE
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
CARRIER SHALL NOT BE RESPONSIBLE IN CASE OF ANY DAMAGE/LOSS OCCURING  DUE TO FIRE STRIKE,
LOST ACCIDENT EARTHQUAKE,FLOOD OR ANY OTHRE ACT OF GOD. HOWEVER CARRIER SHALL BE DISCHARGED 
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
THAT THE CONSIONGNOR /CONSIGNEE WOULD HAVE TO GET THE SURVEY OF GOODS/CONSIGNMENTS IF THEY 
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px;">
THE CONSIGNOR HAS TO  NECESSARILY INDICATE NUMBER OF ARTICLES QUQLITY OF ARTICLES, WEATHER IS
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
THE  CARRIER CAN TRANSHIP THE GOODS FROM ANY VEHICLE TO ANOTHER , IF THERE ARE CHANCES OF DAMAGE.
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
THE CONSIGNOR WOULD HAVE TO INFORM IN WRITING IN ADVANCE,IF THE GOODS ARE NOT TO BE SENT WITH 
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
 THE CONSIGNOR WOULD HAVE TO INFORM IN WRITING ABOUT THE REQUIRED VEHICLE FOR TRANSPORTAION.
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
 THE CARRIER HOLDS RIGHTS TO EXERCISE A LINE OVER THE GOODS BAILED AND CAN WITHHOLD THE GOODS IF
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
CARRIER IS NOT LIABLE FOR THE DETERIORATION OF GOODS RESULTING FROM NETURAL CAUSES LIKE
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
THE CARRIER SHALL HAVE THE RIGHT TO DISPOSE OF THE GOODS AFTER GIVING 15 DAYS NOTICS TO
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
INTEREST @24% P. A. WOULD BE CHARGED IF THE BILL IS NOT PAID WITHIN CONTRACTING TERMS.
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
THE CARRIER SHALL NOT BE LIABLE IF THE GOODS ARE NOT DELIVERED OF GOODS UNLESS IF NOTIFIED AND STATEMENT 
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
THE CARRIER WOULD NOT BE LIABLE FOR ANY SHORTAGE IN DELIVERY OF DELIVERY OF GOODS UNLESS 
...
<td valign="top">
<font face="caibri" size="2px"><p style="line-height:1.1; word-spacing: 10px; margin: 4px; ">
ANY DISPUTE WOULD BE REACHED SUBJECT TO CARRIER'S ACT AND UNDER PUNE JURISDICTION.
...
<tr style="height: 100%; border-left:1px solid #787f7a; border-right:1px solid #787f7a;">
<td colspan="2">
