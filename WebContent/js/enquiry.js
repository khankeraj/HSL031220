$(document).ready(function(){
          ...
          function addRows(e){
                    try{
                              ...
                              '<td><input type="text" name="heb.description"  value=""  cssClass="validate[required]" id="description"  style="width: 150px;"/> </td>',
                              '<td><input type="text" name="heb.amt" cssClass="validate[required]" value="" id="amt"  style="width: 150px;"  /></td>',
                              '<td><input type="text" name="heb.fromDate" cssClass="validate[required]" onblur="FixShortDate(this); return ValidateForm(this)" value="" id="fromDate"  style="width: 150px;"  /></td>',
                              '<td><input type="text" name="heb.toDate" cssClass="validate[required]" onblur="FixShortDate(this); return ValidateForm(this)" value="" id="toDate"  style="width: 150px;"  /></td>',
